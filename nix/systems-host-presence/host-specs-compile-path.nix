...
hostSpecsCompilePath = [
    ...
    {
      # PRODUCT-WIRE-FS-WRITE-TOOL: M4 Name B Path A freestanding product-wire writer.
    ...
    {
      # PRODUCT-WIRE-FS-WRITE-TOOL main: Lake exe root for product-wire tool C emit.
