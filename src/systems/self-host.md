...
| just recipe | `just mult-subset-rebuild` |
...
| Lake host | `stillUsesLake` / `dependsOnLake` true; `multSubsetRebuildWithoutLakeFinishedClaimed` false |

**Non-claims (S3):** not without-Lake finished (later deepen / S4); not S4 Lake
