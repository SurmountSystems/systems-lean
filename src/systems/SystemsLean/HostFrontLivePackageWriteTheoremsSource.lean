/-
  ...
  Short role: HostFrontLivePackageWriteTheoremsSource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-PACKAGEWRITE-THEOREMS,
  livePackageWriteTheoremsSource, HOST-FRONT-LIVE-PACKAGEWRITE-THEOREMS,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLivePackageWriteTheoremsSource
...
/-- Dual-pinned live HostPackageWriteTheorems.lean bytes (must match on-disk file).
    Greppable: livePackageWriteTheoremsSource, PARSE-LIVE-PACKAGEWRITE-THEOREMS. -/
def livePackageWriteTheoremsSource : String := r#"/-
