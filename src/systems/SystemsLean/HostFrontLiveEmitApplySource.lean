/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live EmitApply.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveEmitApplySource. Not occupancy name 50. Not mill 70.
  This wrap is EmitApply.lean. It is not EmitApplyScaffold.lean.
  It is not EmitPlan.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveEmitApplySource,
  HOST-FRONT-LIVE-EMIT-APPLY, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveEmitApplySource
...
/-- Dual-pinned live EmitApply.lean bytes (must match on-disk file).
    Greppable: liveEmitApplySource, HOST-FRONT-LIVE-EMIT-APPLY. -/
def liveEmitApplySource : String := r#"/-
