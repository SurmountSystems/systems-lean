/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckLlvmComposeTextTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckLlvmComposeTextTermSource.
  Not occupancy name 50. Not mill 70.
  This wrap is HostModuleCheckLlvmComposeTextTerm.lean.
  It is not HostModuleCheck and not HostFront.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveHostModuleCheckLlvmComposeTextTermSource,
  HOST-FRONT-LIVE-HOSTMODULECHECKLLVMCOMPOSETEXTTERM, liveRel,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckLlvmComposeTextTermSource
...
/-- Dual-pinned live HostModuleCheckLlvmComposeTextTerm.lean bytes
    (must match the on-disk file).
    Greppable: liveHostModuleCheckLlvmComposeTextTermSource,
    HOST-FRONT-LIVE-HOSTMODULECHECKLLVMCOMPOSETEXTTERM. -/
def liveHostModuleCheckLlvmComposeTextTermSource : String := r#"/-
