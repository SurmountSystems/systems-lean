/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live LlvmGraphSsa.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveLlvmGraphSsaSource. Not occupancy name 50.
  Not a mill remill. Mill stays 69 of 69.
  ...
  LLVM-GRAPH-SSA
  Greppable: SYSTEMS_LEAN_HOST, liveLlvmGraphSsaSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveLlvmGraphSsaSource
...
/-- Dual-pinned live LlvmGraphSsa.lean bytes (must match on-disk file).
    Greppable: liveLlvmGraphSsaSource, PARSE-LIVE-LLVM-GRAPH-SSA. -/
def liveLlvmGraphSsaSource : String := r#"/-
