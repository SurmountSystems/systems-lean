/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live LinearForeignLink.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveLinearForeignLinkSource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-LINEAR-FOREIGN-LINK, liveLinearForeignLinkSource,
  HOST-FRONT-LIVE-LINEAR-FOREIGN-LINK, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveLinearForeignLinkSource
...
/-- Dual-pinned live LinearForeignLink.lean bytes (must match on-disk file).
    Greppable: liveLinearForeignLinkSource, PARSE-LIVE-LINEAR-FOREIGN-LINK. -/
def liveLinearForeignLinkSource : String := r#"/-
