/-
  ...
  Short role: HostFrontLiveHostModuleCheckFixturesSource. Not occupancy name 50.
  Not mill remill. Mill stays 69 of 69.
  This wrap dual-pins HostModuleCheckFixtures.lean only. One part.
  Do not steal a neighbor checker. Do not retarget HostModuleCheckFixtures.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-HOSTMODULECHECKFIXTURES,
  liveHostModuleCheckFixturesSource,
  HOST-FRONT-LIVE-HOSTMODULECHECKFIXTURES,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckFixturesSource
...
/-- Dual-pinned live HostModuleCheckFixtures.lean bytes.
    One part. Not split. 677 product lines plus this header stay under about 780.
    Greppable: liveHostModuleCheckFixturesSource,
    PARSE-LIVE-HOSTMODULECHECKFIXTURES. -/
def liveHostModuleCheckFixturesSource : String := r#"/-
