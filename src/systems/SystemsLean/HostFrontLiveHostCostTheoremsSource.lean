/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostCostTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostCostTheoremsSource. Not occupancy name 50. Not mill 70.
  Unique needles (trailing newline so HostFrontLiveHostCost is not a prefix):
  HostFrontLiveHostCostTheoremsSource
  PARSE-LIVE-HOST-COST-THEOREMS
  HOST-FRONT-LIVE-HOST-COST-THEOREMS
  HOST-COST-THEOREMS
  Greppable: SYSTEMS_LEAN_HOST, liveHostCostTheoremsSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostCostTheoremsSource
...
/-- Dual-pinned live HostCostTheorems.lean bytes (must match on-disk file).
    Greppable: liveHostCostTheoremsSource, PARSE-LIVE-HOST-COST-THEOREMS. -/
def liveHostCostTheoremsSource : String := r#"/-
