/-
  ...
  HostModuleCheckProductPathTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckProductPathTermSource.
  ...
  HOST-FRONT-LIVE-HOSTMODULECHECKPRODUCTPATHTERM, liveRel,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckProductPathTermSource
...
/-- Dual-pinned live HostModuleCheckProductPathTerm.lean bytes
    (must match the on-disk file).
    Greppable: liveHostModuleCheckProductPathTermSource,
    HOST-FRONT-LIVE-HOSTMODULECHECKPRODUCTPATHTERM. -/
def liveHostModuleCheckProductPathTermSource : String := r#"/-
