/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live ProductPathTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveProductPathTheoremsSource. Not occupancy name 50.
  Not mill 70.
  Source needles (do not rename): PRODUCT-PATH-THEOREM, PRODUCT-PATH-SMOKE.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-PRODUCTPATHTHEOREMS,
  liveProductPathTheoremsSource, HOST-FRONT-LIVE-PRODUCTPATHTHEOREMS,
  PRODUCT-PATH-THEOREM, PRODUCT-PATH-SMOKE, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveProductPathTheoremsSource
...
/-- Dual-pinned live ProductPathTheorems.lean bytes (must match on-disk file).
    Greppable: liveProductPathTheoremsSource, PARSE-LIVE-PRODUCTPATHTHEOREMS,
    PRODUCT-PATH-THEOREM, PRODUCT-PATH-SMOKE. -/
def liveProductPathTheoremsSource : String := r#"/-
