/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckEmitApplyTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckEmitApplyTermSource. Not occupancy name 50.
  Not mill remill. Mill stays 69 of 69.
  This wrap dual-pins HostModuleCheckEmitApplyTerm.lean only. One part.
  Do not steal a neighbor checker. Do not retarget HostModuleCheckEmitApplyTerm.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-HOSTMODULECHECKEMITAPPLYTERM,
  liveHostModuleCheckEmitApplyTermSource,
  HOST-FRONT-LIVE-HOSTMODULECHECKEMITAPPLYTERM,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckEmitApplyTermSource
...
/-- Dual-pinned live HostModuleCheckEmitApplyTerm.lean bytes.
    One part. Not split. 451 lines plus this header stay under about 780.
    Greppable: liveHostModuleCheckEmitApplyTermSource,
    PARSE-LIVE-HOSTMODULECHECKEMITAPPLYTERM. -/
def liveHostModuleCheckEmitApplyTermSource : String := r#"/-
