/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live LlvmCfgHonesty.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveLlvmCfgHonestySource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, LLVM-CFG-HONESTY, liveLlvmCfgHonestySource,
  HOST-FRONT-LIVE-LLVM-CFG-HONESTY, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveLlvmCfgHonestySource
...
/-- Dual-pinned live LlvmCfgHonesty.lean bytes (must match on-disk file).
    Greppable: liveLlvmCfgHonestySource, LLVM-CFG-HONESTY. -/
def liveLlvmCfgHonestySource : String := r#"/-
