/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live CapableReadTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveCapableReadTheoremsSource.
  Not occupancy name 50. Not mill 70.
  This wrap is CapableReadTheorems.lean. It is not CapableRead.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveCapableReadTheoremsSource,
  HOST-FRONT-LIVE-CAPABLE-READ-THEOREMS, liveRel, READ-THEOREM.
  Module: SystemsLean.HostFrontLiveCapableReadTheoremsSource
...
/-- Dual-pinned live CapableReadTheorems.lean bytes (must match on-disk file).
    Greppable: liveCapableReadTheoremsSource, READ-THEOREM. -/
def liveCapableReadTheoremsSource : String := r#"/-
