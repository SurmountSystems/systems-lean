/-
  ...
  Short role: HostFrontLiveHostModuleCheckCompilePathProgramTerm.
  ...
  Spec (readable):
  - parseLiveHostModuleCheckCompilePathProgramTermSource turns live
    HostModuleCheckCompilePathProgramTerm.lean text into HostTerm.Module.
  - Module name is SystemsLean.HostModuleCheckCompilePathProgramTerm
    even without a module line.
  - liveRel is the exact basename HostModuleCheckCompilePathProgramTerm.lean.
    Disk reads use src/systems/SystemsLean/ plus that basename.
  - kernelCheckLiveHostModuleCheckCompilePathProgramTermSource is
    HostKernel.kernelCheck of that parse. The reject arm returns false.
  - The embedded bytes are one part,
    liveHostModuleCheckCompilePathProgramTermSource. Not split.
  - Five dotted imports, namespace SystemsLean.HostModuleCheck,
    ...
    is skip-folded. Kept command count is 11. Skipped command count is 26.
    Kept plus skipped is 37. kernelFuel is 64.
    37 does not pass 64.
  ...
  - Skip-head still sees def checkCompilePathProgramTermDialect and
    def hostModuleCheckCompilePathProgramTermSurfaceOk in the live text.
  ...
  HostFrontLiveHostModuleCheckCompilePathProgramTerm
  PARSE-LIVE-HOSTMODULECHECKCOMPILEPATHPROGRAMTERM
  HOST-FRONT-LIVE-HOSTMODULECHECKCOMPILEPATHPROGRAMTERM
  SLAKE_HOST_FRONT_LIVE_HOSTMODULECHECKCOMPILEPATHPROGRAMTERM_V0

  Greppable: SYSTEMS_LEAN_HOST,
  parseLiveHostModuleCheckCompilePathProgramTermSource,
  kernelCheckLiveHostModuleCheckCompilePathProgramTermSource,
  hostFrontLiveHostModuleCheckCompilePathProgramTermReady,
  liveHostModuleCheckCompilePathProgramTermSource,
  liveRel, liveHostModuleCheckCompilePathProgramTermRel, stripCommentsHc,
  UNIT_SURFACE host surface, MULT-0.
  Module: SystemsLean.HostFrontLiveHostModuleCheckCompilePathProgramTerm
  Not package typecheck GREEN. Not FullHost. Not Lake-gone.
  Module must stay ASCII.
-/

import SystemsLean.HostFrontLiveHostTerm
import SystemsLean.HostFrontLiveHostModuleCheckCompilePathProgramTermSource
import SystemsLean.HostKernel

set_option maxRecDepth 32768
set_option maxHeartbeats 100000000

namespace SystemsLean.HostFrontLiveHostModuleCheckCompilePathProgramTerm
...
def hostId : String := "HOST-FRONT-LIVE-HOSTMODULECHECKCOMPILEPATHPROGRAMTERM"

/-- Greppable parse id. -/
def parseId : String := "PARSE-LIVE-HOSTMODULECHECKCOMPILEPATHPROGRAMTERM"

/-- Live file basename. -/
def liveRel : String := "HostModuleCheckCompilePathProgramTerm.lean"

/-- Live file relative to repo root. Dual-pin path.
    liveHostModuleCheckCompilePathProgramTermSource is the one embedded copy
    from HostFrontLiveHostModuleCheckCompilePathProgramTermSource. Not split. -/
...
def hostFrontLiveHostModuleCheckCompilePathProgramTermFullHost : Bool := false

/-- Honesty: not product residual free. -/
def hostFrontLiveHostModuleCheckCompilePathProgramTermResidualFreeClaimed : Bool :=
  false

/-- Honesty: not PROVABLY. -/
def hostFrontLiveHostModuleCheckCompilePathProgramTermProvablyUnlocked : Bool :=
  false
...
/-- Kept-command count: five imports, namespace, two String literals,
    ...
    Other defs are skip-folded. Skipped count is 26. Kept plus skipped
    is 37. kernelFuel is 64. 37 does not pass 64. -/
...
/-- String-safe comment fold from HostFrontLiveHostCheck.stripCommentsHc.
    ...
    HostModuleCheckCompilePathProgramTerm has dash-dash in the header block
...
/-- String-safe comment strip for live HostModuleCheckCompilePathProgramTerm.lean
...
/-- Dotted ident `SystemsLean . HostModuleCheckCompilePathProgramTerm`. -/
...
/-- Parse live HostModuleCheckCompilePathProgramTerm.lean text.
    Greppable: parseLiveHostModuleCheckCompilePathProgramTermSource,
    PARSE-LIVE-HOSTMODULECHECKCOMPILEPATHPROGRAMTERM. -/
def parseLiveHostModuleCheckCompilePathProgramTermSource (src : String) :
    FrontResult :=
  ...
  if toks.isEmpty then FrontResult.reject reasonEmptyModule
    ...
    | some cmds =>
      if cmds.isEmpty then FrontResult.reject reasonEmptyModule
        ...
        let m : Module :=
          { name := HostTerm.n "SystemsLean.HostModuleCheckCompilePathProgramTerm"
            commands := cmds }
...
/-- Kernel-check the live parse. Not a fixture. Not a constant true.
    ...
    Greppable: kernelCheckLiveHostModuleCheckCompilePathProgramTermSource,
    PARSE-LIVE-HOSTMODULECHECKCOMPILEPATHPROGRAMTERM. -/
def kernelCheckLiveHostModuleCheckCompilePathProgramTermSource (src : String) :
    Bool :=
  match parseLiveHostModuleCheckCompilePathProgramTermSource src with
  | FrontResult.accept m => HostKernel.kernelCheck m
  | FrontResult.reject _ => false

/-- Accepted live module when parse succeeds. -/
def liveParsed? : Option Module :=
  match parseLiveHostModuleCheckCompilePathProgramTermSource
      liveHostModuleCheckCompilePathProgramTermSource with
...
/-- Wrap module lastSeg is HostModuleCheckCompilePathProgramTerm
    (no module line in the live file). -/
def liveParseHasModule : Bool :=
  match liveParsed? with
  | none => false
  | some m =>
    m.name.raw == "SystemsLean.HostModuleCheckCompilePathProgramTerm"
      && lastSeg m.name.raw == "HostModuleCheckCompilePathProgramTerm"
...
def liveParseHasCoreDefs : Bool :=
  ...
  | some _ =>
    let toks := tokenizeHostTerm
      (stripCommentsHc liveHostModuleCheckCompilePathProgramTermSource)
    toksHaveDefNamed liveSkipFuel toks "checkCompilePathProgramTermDialect"
...
def liveNeedlesOk : Bool :=
  let src := liveHostModuleCheckCompilePathProgramTermSource
...
/-- End-to-end ready: live text parse kernel-checks.
    Greppable: hostFrontLiveHostModuleCheckCompilePathProgramTermReady,
    PARSE-LIVE-HOSTMODULECHECKCOMPILEPATHPROGRAMTERM,
    HOST-FRONT-LIVE-HOSTMODULECHECKCOMPILEPATHPROGRAMTERM.
    Real conjunction: parse plus kernelCheck plus this file's commands.
    Not a hardcoded true. -/
def hostFrontLiveHostModuleCheckCompilePathProgramTermReady : Bool :=
  (stageId ==
      "SLAKE_HOST_FRONT_LIVE_HOSTMODULECHECKCOMPILEPATHPROGRAMTERM_V0")
    && (hostId == "HOST-FRONT-LIVE-HOSTMODULECHECKCOMPILEPATHPROGRAMTERM")
    && (parseId == "PARSE-LIVE-HOSTMODULECHECKCOMPILEPATHPROGRAMTERM")
    && (liveRel == "HostModuleCheckCompilePathProgramTerm.lean")
    && (liveHostModuleCheckCompilePathProgramTermRel ==
        "src/systems/SystemsLean/HostModuleCheckCompilePathProgramTerm.lean")
    && liveParseDoesNotUseMultFixture
    && !hostFrontLiveHostModuleCheckCompilePathProgramTermFullHost
    && !hostFrontLiveHostModuleCheckCompilePathProgramTermResidualFreeClaimed
    && !hostFrontLiveHostModuleCheckCompilePathProgramTermProvablyUnlocked
    && kernelCheckLiveHostModuleCheckCompilePathProgramTermSource
        liveHostModuleCheckCompilePathProgramTermSource
...
def liveParseRejectsEmpty : Bool :=
  match parseLiveHostModuleCheckCompilePathProgramTermSource "" with
...
def runLive (root : System.FilePath) : IO Unit := do
  IO.println s!"== {stageId}: PARSE-LIVE-HOSTMODULECHECKCOMPILEPATHPROGRAMTERM =="
  IO.println s!"  host={hostId} file={liveHostModuleCheckCompilePathProgramTermRel}"
  IO.println s!"liveRel={liveRel}"
  let path := root / liveHostModuleCheckCompilePathProgramTermRel
  unless (<- path.pathExists) do
    IO.eprintln s!"error: missing {liveHostModuleCheckCompilePathProgramTermRel}"
    throw (IO.userError s!"missing {liveHostModuleCheckCompilePathProgramTermRel}")
  let disk <- IO.FS.readFile path
  if disk != liveHostModuleCheckCompilePathProgramTermSource then
    IO.eprintln "error: dual-pin mismatch: on-disk HostModuleCheckCompilePathProgramTerm.lean != liveHostModuleCheckCompilePathProgramTermSource"
    throw (IO.userError "dual-pin mismatch live HostModuleCheckCompilePathProgramTerm.lean")
  let r := parseLiveHostModuleCheckCompilePathProgramTermSource disk
  match r with
  | FrontResult.reject reason =>
    IO.eprintln s!"error: PARSE-LIVE-HOSTMODULECHECKCOMPILEPATHPROGRAMTERM reject {reason}"
    throw (IO.userError
      s!"PARSE-LIVE-HOSTMODULECHECKCOMPILEPATHPROGRAMTERM reject {reason}")
  | FrontResult.accept m =>
    let k := HostKernel.kernelCheck m
    IO.println s!"PASS PARSE-LIVE-HOSTMODULECHECKCOMPILEPATHPROGRAMTERM ACCEPT liveRel={liveRel} cmds={m.commands.length} kernelCheck={k}"
    ...
    unless k do
      IO.eprintln "error: kernelCheck live HostModuleCheckCompilePathProgramTerm parse false"
      throw (IO.userError
        "kernelCheck live HostModuleCheckCompilePathProgramTerm parse false")
    unless hostFrontLiveHostModuleCheckCompilePathProgramTermReady do
      IO.eprintln "error: hostFrontLiveHostModuleCheckCompilePathProgramTermReady false"
      throw (IO.userError
        "hostFrontLiveHostModuleCheckCompilePathProgramTermReady false")
    unless liveParseRejectsEmpty do
      IO.eprintln "error: empty HostModuleCheckCompilePathProgramTerm source was accepted"
      throw (IO.userError
        "empty HostModuleCheckCompilePathProgramTerm source was accepted")
    IO.println s!"GREEN {stageId}: live HostModuleCheckCompilePathProgramTerm.lean parse kernelCheck; not mill remill; mill stays 69 of 69"
...
end SystemsLean.HostFrontLiveHostModuleCheckCompilePathProgramTerm
