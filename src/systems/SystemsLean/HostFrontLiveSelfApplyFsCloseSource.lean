/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live SelfApplyFsClose.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveSelfApplyFsCloseSource. Not occupancy name 50.
  Not mill 70. This wrap dual-pins SelfApplyFsClose.lean only.
  Do not edit SelfApplyFsClose.lean. Do not wrap another SelfApplyFs file.
  Unique needles (trailing newline; taken from SelfApplyFsClose.lean only):
  ...
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-SELF-APPLY-FS-CLOSE,
  liveSelfApplyFsCloseSource, liveRel, SELF-APPLY-FS-CLOSE,
  HOST-FRONT-LIVE-SELF-APPLY-FS-CLOSE, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveSelfApplyFsCloseSource
...
/-- Dual-pinned live SelfApplyFsClose.lean bytes (must match on-disk file).
    Greppable: liveSelfApplyFsCloseSource, PARSE-LIVE-SELF-APPLY-FS-CLOSE. -/
def liveSelfApplyFsCloseSource : String := r#"/-
