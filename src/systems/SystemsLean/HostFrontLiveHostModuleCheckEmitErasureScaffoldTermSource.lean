/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckEmitErasureScaffoldTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckEmitErasureScaffoldTermSource. Not occupancy name 50.
  Not mill remill. Mill stays 69 of 69.
  This wrap dual-pins HostModuleCheckEmitErasureScaffoldTerm.lean only. One part.
  Do not steal a neighbor checker. Do not retarget HostModuleCheckEmitErasureScaffoldTerm.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-HOSTMODULECHECKEMITERASURESCAFFOLDTERM,
  liveHostModuleCheckEmitErasureScaffoldTermSource,
  HOST-FRONT-LIVE-HOSTMODULECHECKEMITERASURESCAFFOLDTERM,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckEmitErasureScaffoldTermSource
...
/-- Dual-pinned live HostModuleCheckEmitErasureScaffoldTerm.lean bytes.
    One part. Not split. 340 lines plus this header stay under about 780.
    Greppable: liveHostModuleCheckEmitErasureScaffoldTermSource,
    PARSE-LIVE-HOSTMODULECHECKEMITERASURESCAFFOLDTERM. -/
def liveHostModuleCheckEmitErasureScaffoldTermSource : String := r#"/-
