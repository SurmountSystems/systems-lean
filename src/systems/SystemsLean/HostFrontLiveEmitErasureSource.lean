/-
  SYSTEMS_LEAN_HOST partial -- dual-pin of EmitErasure.lean bytes.
  liveEmitErasureSource is the exact bytes of
  src/systems/SystemsLean/EmitErasure.lean.
  Module: SystemsLean.HostFrontLiveEmitErasureSource
  Not FullHost. Not Lake-gone. Occupancy stays 49. Mill stays 69 of 69.
  slakeOwnsPackageTypecheck stays false.
  Greppable: SYSTEMS_LEAN_HOST, liveEmitErasureSource.
  Module must stay ASCII.
-/

namespace SystemsLean.HostFrontLiveEmitErasure

def liveEmitErasureSource : String := r#"/-
