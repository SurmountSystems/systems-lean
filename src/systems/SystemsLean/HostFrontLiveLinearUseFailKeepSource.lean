/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live LinearUseFail/Keep.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveLinearUseFailKeepSource. Not occupancy name 50. Not mill 70.
  Unique needles (trailing newline so LinearUseFail wrap is not a prefix):
  HostFrontLiveLinearUseFailKeepSource
  PARSE-LIVE-LINEAR-USE-FAIL-KEEP
  HOST-FRONT-LIVE-LINEAR-USE-FAIL-KEEP
  Greppable: SYSTEMS_LEAN_HOST, liveLinearUseFailKeepSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveLinearUseFailKeepSource
...
/-- Dual-pinned live LinearUseFail/Keep.lean bytes (must match on-disk file).
    Greppable: liveLinearUseFailKeepSource, PARSE-LIVE-LINEAR-USE-FAIL-KEEP. -/
def liveLinearUseFailKeepSource : String := r#"/-
