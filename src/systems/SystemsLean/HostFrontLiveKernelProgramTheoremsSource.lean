/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live KernelProgramTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveKernelProgramTheoremsSource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-KERNEL-PROGRAM-THEOREMS, liveKernelProgramTheoremsSource,
  HOST-FRONT-LIVE-KERNEL-PROGRAM-THEOREMS, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveKernelProgramTheoremsSource
...
/-- Dual-pinned live KernelProgramTheorems.lean bytes (must match on-disk file).
    Greppable: liveKernelProgramTheoremsSource, PARSE-LIVE-KERNEL-PROGRAM-THEOREMS. -/
def liveKernelProgramTheoremsSource : String := r#"/-
