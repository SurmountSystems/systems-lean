/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live CapableWriteHc.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveCapableWriteHcSource. Not occupancy name 50.
  ...
  prefix hit on HostFrontLiveCapableWriteHcSource, mill wrap
  HostFrontLiveCapableWriteHcMain, or a Theorems peel.
  Occupancy leftover is not this wrap.
  Unique needles (trailing newline so HostFrontLiveCapableWriteHc is not a prefix):
  HostFrontLiveCapableWriteHcSource
  PARSE-LIVE-CAPABLE-WRITE-HC
  HOST-FRONT-LIVE-CAPABLE-WRITE-HC
  Greppable: SYSTEMS_LEAN_HOST, liveCapableWriteHcSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveCapableWriteHcSource
...
/-- Dual-pinned live CapableWriteHc.lean bytes (must match on-disk file).
    Greppable: liveCapableWriteHcSource, PARSE-LIVE-CAPABLE-WRITE-HC. -/
def liveCapableWriteHcSource : String := r#"/-
