/-
  ...
  HostModuleCheckProgramSubsetRebuildTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckProgramSubsetRebuildTermSource.
  ...
  HOST-FRONT-LIVE-HOSTMODULECHECKPROGRAMSUBSETREBUILDTERM, liveRel,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckProgramSubsetRebuildTermSource
...
/-- Dual-pinned live HostModuleCheckProgramSubsetRebuildTerm.lean bytes
    (must match the on-disk file).
    Greppable: liveHostModuleCheckProgramSubsetRebuildTermSource,
    HOST-FRONT-LIVE-HOSTMODULECHECKPROGRAMSUBSETREBUILDTERM. -/
def liveHostModuleCheckProgramSubsetRebuildTermSource : String := r#"/-
