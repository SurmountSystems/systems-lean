/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live SpecProof.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveSpecProofSource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-SPEC-PROOF, liveSpecProofSource,
  HOST-FRONT-LIVE-SPEC-PROOF, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveSpecProofSource
...
/-- Dual-pinned live SpecProof.lean bytes (must match on-disk file).
    Greppable: liveSpecProofSource, PARSE-LIVE-SPEC-PROOF. -/
def liveSpecProofSource : String := r#"/-
