/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostImportGraphLoadOk.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostImportGraphLoadOkSource. Not occupancy name 50.
  Not mill remill. Mill stays 69 of 69.
  This wrap dual-pins HostImportGraphLoadOk.lean only.
  ...
  HostFrontLiveHostImportGraphLoadOkSource
  ...
  Greppable: SYSTEMS_LEAN_HOST, liveHostImportGraphLoadOkSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostImportGraphLoadOkSource
...
/-- Dual-pinned live HostImportGraphLoadOk.lean bytes (must match on-disk file).
    Greppable: liveHostImportGraphLoadOkSource, PARSE-LIVE-HOST-IMPORT-GRAPH-LOADOK. -/
def liveHostImportGraphLoadOkSource : String := r#"/-
