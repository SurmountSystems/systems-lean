/-
  ...
  HOST-FRONT-LIVE-HOST-MODULE-CHECK-IR-PROGRAM-THEOREMS-KERNEL,
  SLAKE_HOST_FRONT_LIVE_HOST_MODULE_CHECK_IR_PROGRAM_THEOREMS_KERNEL_V0,
  PARSE-LIVE-HOST-MODULE-CHECK-IR-PROGRAM-THEOREMS-KERNEL, liveRel,
  kernelCheckLiveHostModuleCheckIrProgramTheoremsKernelSource,
  hostFrontLiveHostModuleCheckIrProgramTheoremsKernelReady.
  Module: SystemsLean.HostFrontLiveHostModuleCheckIrProgramTheoremsKernelSource
...
namespace SystemsLean.HostFrontLiveHostModuleCheckIrProgramTheoremsKernelSource
...
def liveRel : String := "HostModuleCheckIrProgramTheoremsKernel.lean"
...
def hostFrontLiveHostModuleCheckIrProgramTheoremsKernelFullHost : Bool := false

/-- Honesty: this wrap is not an LLVM backend. FullBackend stays false. -/
def hostFrontLiveHostModuleCheckIrProgramTheoremsKernelFullBackend : Bool := false

/-- Honesty: not product residual free. -/
def hostFrontLiveHostModuleCheckIrProgramTheoremsKernelResidualFreeClaimed : Bool :=
  false

/-- Honesty: this wrap is not PROVABLY. -/
def hostFrontLiveHostModuleCheckIrProgramTheoremsKernelProvablyUnlocked : Bool :=
  false
...
/-- On-disk HostModuleCheckIrProgramTheoremsKernel.lean bytes.
    Greppable: liveHostModuleCheckIrProgramTheoremsKernelSource. -/


def liveHostModuleCheckIrProgramTheoremsKernelSource : String := r#"/-
...
/-- Parse live HostModuleCheckIrProgramTheoremsKernel.lean text.
    Greppable: parseLiveHostModuleCheckIrProgramTheoremsKernelSource. -/
def parseLiveHostModuleCheckIrProgramTheoremsKernelSource (src : String) :
    FrontResult :=
  ...
  if toks.isEmpty then FrontResult.reject reasonEmptyModule
    ...
    | some cmds =>
      if cmds.isEmpty then FrontResult.reject reasonEmptyModule
        ...
        let m : Module :=
          { name := HostTerm.n "SystemsLean.HostModuleCheckIrProgramTheoremsKernel"
            commands := cmds }
        if isWellFormed m then FrontResult.accept m
        else FrontResult.reject reasonNotWellFormed

/-- Kernel-check the live parse. Not a fixture.
    Greppable: kernelCheckLiveHostModuleCheckIrProgramTheoremsKernelSource. -/
def kernelCheckLiveHostModuleCheckIrProgramTheoremsKernelSource (src : String) :
    Bool :=
  match parseLiveHostModuleCheckIrProgramTheoremsKernelSource src with
  | FrontResult.accept m => HostKernel.kernelCheck m
  | FrontResult.reject _ => false

/-- Accepted live module when parse succeeds. -/
def liveParsed? : Option Module :=
  match parseLiveHostModuleCheckIrProgramTheoremsKernelSource
      liveHostModuleCheckIrProgramTheoremsKernelSource with
  ...
  | some m =>
    let has (nm : String) : Bool :=
      m.commands.any fun c =>
        ...
        | _ => false
    has "checkDepthIrProgramTheoremsKernelBar"
      && has "checkDepthIrProgramTheoremsKernelScope"
      && has "hostModuleCheckIrProgramTheoremsKernelDualOk"
...
def liveParseHasModuleName : Bool :=
  ...
  | none => false
  | some m =>
    m.name.raw == "SystemsLean.HostModuleCheckIrProgramTheoremsKernel"
...
def liveParseKwCountsOk : Bool :=
  ...
  | some _ =>
    let toks := tokenizeHostTerm
      (stripComments liveHostModuleCheckIrProgramTheoremsKernelSource)
...
def liveNeedlesOk : Bool :=
  let src := liveHostModuleCheckIrProgramTheoremsKernelSource
...
/-- End-to-end ready: live text parse kernel-checks.
    Greppable: hostFrontLiveHostModuleCheckIrProgramTheoremsKernelReady.
    Real conjunction: parse plus kernelCheck plus this file's commands.
    Not a hardcoded true. -/
def hostFrontLiveHostModuleCheckIrProgramTheoremsKernelReady : Bool :=
  (stageId ==
    "SLAKE_HOST_FRONT_LIVE_HOST_MODULE_CHECK_IR_PROGRAM_THEOREMS_KERNEL_V0")
    && (hostId ==
      "HOST-FRONT-LIVE-HOST-MODULE-CHECK-IR-PROGRAM-THEOREMS-KERNEL")
    && (parseId ==
      "PARSE-LIVE-HOST-MODULE-CHECK-IR-PROGRAM-THEOREMS-KERNEL")
    && (liveRel == "HostModuleCheckIrProgramTheoremsKernel.lean")
    && (liveHostModuleCheckIrProgramTheoremsKernelRel ==
      "src/systems/SystemsLean/HostModuleCheckIrProgramTheoremsKernel.lean")
    && liveParseDoesNotUseMultFixture
    && !hostFrontLiveHostModuleCheckIrProgramTheoremsKernelFullHost
    && !hostFrontLiveHostModuleCheckIrProgramTheoremsKernelFullBackend
    && !hostFrontLiveHostModuleCheckIrProgramTheoremsKernelResidualFreeClaimed
    && !hostFrontLiveHostModuleCheckIrProgramTheoremsKernelProvablyUnlocked
    && kernelCheckLiveHostModuleCheckIrProgramTheoremsKernelSource
      liveHostModuleCheckIrProgramTheoremsKernelSource
...
def liveParseRejectsEmpty : Bool :=
  match parseLiveHostModuleCheckIrProgramTheoremsKernelSource "" with
...
def readyFailures : List String :=
  ...
  bad "stageId" (stageId ==
    ...
    ++ bad "parseId" (parseId ==
      "PARSE-LIVE-HOST-MODULE-CHECK-IR-PROGRAM-THEOREMS-KERNEL")
    ++ bad "liveRel" (liveRel == "HostModuleCheckIrProgramTheoremsKernel.lean")
    ++ bad "rel" (liveHostModuleCheckIrProgramTheoremsKernelRel ==
      "src/systems/SystemsLean/HostModuleCheckIrProgramTheoremsKernel.lean")
    ++ bad "notMult" liveParseDoesNotUseMultFixture
    ++ bad "fullHost" (!hostFrontLiveHostModuleCheckIrProgramTheoremsKernelFullHost)
    ++ bad "fullBackend"
      (!hostFrontLiveHostModuleCheckIrProgramTheoremsKernelFullBackend)
    ++ bad "residual"
      (!hostFrontLiveHostModuleCheckIrProgramTheoremsKernelResidualFreeClaimed)
    ++ bad "provably"
      (!hostFrontLiveHostModuleCheckIrProgramTheoremsKernelProvablyUnlocked)
    ++ bad "kernel" (kernelCheckLiveHostModuleCheckIrProgramTheoremsKernelSource
      liveHostModuleCheckIrProgramTheoremsKernelSource)
...
def runLive (root : System.FilePath) : IO Unit := do
  ...
  let path := root / liveHostModuleCheckIrProgramTheoremsKernelRel
  unless (<- path.pathExists) do
    IO.eprintln s!"error: missing {liveHostModuleCheckIrProgramTheoremsKernelRel}"
    throw (IO.userError s!"missing {liveHostModuleCheckIrProgramTheoremsKernelRel}")
  let disk <- IO.FS.readFile path
  if disk != liveHostModuleCheckIrProgramTheoremsKernelSource then
    IO.eprintln "error: dual-pin mismatch: on-disk HostModuleCheckIrProgramTheoremsKernel.lean != liveHostModuleCheckIrProgramTheoremsKernelSource"
    throw (IO.userError "dual-pin mismatch live HostModuleCheckIrProgramTheoremsKernel.lean")
  let r := parseLiveHostModuleCheckIrProgramTheoremsKernelSource disk
  match r with
  ...
  | FrontResult.accept m =>
    ...
    unless k do
      IO.eprintln "error: kernelCheck live HostModuleCheckIrProgramTheoremsKernel parse false"
      throw (IO.userError "kernelCheck live HostModuleCheckIrProgramTheoremsKernel parse false")
    unless hostFrontLiveHostModuleCheckIrProgramTheoremsKernelReady do
      ...
      throw (IO.userError "hostFrontLiveHostModuleCheckIrProgramTheoremsKernelReady false")
    unless liveParseRejectsEmpty do
      IO.eprintln "error: empty HostModuleCheckIrProgramTheoremsKernel source was accepted"
      throw (IO.userError "empty HostModuleCheckIrProgramTheoremsKernel source was accepted")
...
end SystemsLean.HostFrontLiveHostModuleCheckIrProgramTheoremsKernelSource
