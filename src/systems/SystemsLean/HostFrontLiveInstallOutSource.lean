/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live InstallOut.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveInstallOutSource. Not occupancy name 50. Not mill 70.
  This wrap is InstallOut.lean. It is not InstallOutTheorems.lean.
  It is not InstallOutMain.lean. Do not overwrite HostFrontLiveInstallOutMain.
  Greppable: SYSTEMS_LEAN_HOST, liveInstallOutSource,
  HOST-FRONT-LIVE-INSTALL-OUT, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveInstallOutSource
...
def liveRel : String := "InstallOut.lean"

/-- Dual-pinned live InstallOut.lean bytes (must match on-disk file).
    Greppable: liveInstallOutSource, HOST-FRONT-LIVE-INSTALL-OUT. -/
def liveInstallOutSource : String := r#"
/-
