/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live EmitBannerScaffold.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveEmitBannerScaffoldSource. Not occupancy name 50. Occupancy stays 49.
  Not mill 70. Mill stays 69 of 69. Not Lake-gone. slakeOwnsPackageTypecheck stays false.
  Unique needles (trailing newline so EmitBanner wrap is not a prefix):
  HostFrontLiveEmitBannerScaffoldSource
  PARSE-LIVE-EMIT-BANNER-SCAFFOLD
  HOST-FRONT-LIVE-EMIT-BANNER-SCAFFOLD
  src/systems/SystemsLean/EmitBannerScaffold.lean
  Greppable: SYSTEMS_LEAN_HOST, liveEmitBannerScaffoldSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveEmitBannerScaffoldSource
...
/-- Dual-pinned live EmitBannerScaffold.lean bytes (must match on-disk file).
    Greppable: liveEmitBannerScaffoldSource, PARSE-LIVE-EMIT-BANNER-SCAFFOLD. -/
def liveEmitBannerScaffoldSource : String := r#"/-
