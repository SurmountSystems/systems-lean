/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live EmitGraphScaffold.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveEmitGraphScaffoldSource. Not occupancy name 50. Not mill 70.
  Unique needles (trailing newline so HostFrontLiveEmit is not a prefix):
  HostFrontLiveEmitGraphScaffoldSource
...
/-- Dual-pinned live EmitGraphScaffold.lean bytes (must match on-disk file).
    Greppable: liveEmitGraphScaffoldSource, PARSE-LIVE-EMIT-GRAPH-SCAFFOLD. -/
def liveEmitGraphScaffoldSource : String := r##"/-
