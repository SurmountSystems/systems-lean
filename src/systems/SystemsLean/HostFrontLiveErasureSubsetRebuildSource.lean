/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live ErasureSubsetRebuild.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveErasureSubsetRebuildSource.
  This wrap is ErasureSubsetRebuild.lean.
  It is not ErasureSubsetRebuildMain.lean.
  It is not Linear.lean.
  It is not IrGraph.lean.
  Unique needles use a trailing newline so ErasureSubsetRebuild is not a
  prefix hit on ErasureSubsetRebuildMain.
  Greppable: SYSTEMS_LEAN_HOST, liveErasureSubsetRebuildSource,
  HOST-FRONT-LIVE-ERASURE-SUBSET-REBUILD, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveErasureSubsetRebuildSource
  Not FullHost. Not freestanding residual free. Not PROVABLY.
  Not Lake-gone. FullBackend stays false in the wrap.
...
/-- Dual-pinned live ErasureSubsetRebuild.lean bytes (must match on-disk file).
    Greppable: liveErasureSubsetRebuildSource,
    HOST-FRONT-LIVE-ERASURE-SUBSET-REBUILD. -/
def liveErasureSubsetRebuildSource : String := r###"/-
