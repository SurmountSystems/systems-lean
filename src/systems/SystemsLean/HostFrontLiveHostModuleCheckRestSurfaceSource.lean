/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckRestSurface.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckRestSurfaceSource. Not occupancy name 50.
  Not mill remill. Mill stays 69 of 69.
  This wrap dual-pins HostModuleCheckRestSurface.lean only. One part.
  Do not steal HostFrontLiveHostModuleCheckCheckers (liveRel is
  HostModuleCheckCheckers.lean).
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-HOSTMODULECHECKRESTSURFACE,
  liveHostModuleCheckRestSurfaceSource, HOST-FRONT-LIVE-HOSTMODULECHECKRESTSURFACE,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckRestSurfaceSource
...
/-- Dual-pinned live HostModuleCheckRestSurface.lean bytes.
    Greppable: liveHostModuleCheckRestSurfaceSource,
    PARSE-LIVE-HOSTMODULECHECKRESTSURFACE. -/
def liveHostModuleCheckRestSurfaceSource : String := r#"import SystemsLean.HostModuleCheckFixtures
