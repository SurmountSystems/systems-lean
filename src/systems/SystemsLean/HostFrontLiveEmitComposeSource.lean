/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live EmitCompose.lean bytes.
  Module: SystemsLean.HostFrontLiveEmitComposeSource
  Greppable: SYSTEMS_LEAN_HOST, liveEmitComposeSource,
...
/-- Dual-pinned live EmitCompose.lean bytes.
    Greppable: liveEmitComposeSource. -/
def liveEmitComposeSource : String := r#"/-
