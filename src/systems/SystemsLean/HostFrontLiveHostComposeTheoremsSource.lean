/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostComposeTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostComposeTheoremsSource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, HOST-COMPOSE-THEOREM, liveHostComposeTheoremsSource,
  HOST-FRONT-LIVE-HOST-COMPOSE-THEOREMS, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostComposeTheoremsSource
  Not FullHost. Not freestanding residual free. Not PROVABLY.
  Not LlvmHold. Not an LLVM backend.
  Module must stay ASCII.
-/

namespace SystemsLean.HostFrontLiveHostComposeTheorems

/-- Dual-pinned live HostComposeTheorems.lean bytes (must match on-disk file).
    Greppable: liveHostComposeTheoremsSource, HOST-COMPOSE-THEOREM. -/
def liveHostComposeTheoremsSource : String := r#"/-
