/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live SlakeHostToolElfMeasure.lean bytes.
  Module: SystemsLean.HostFrontLiveSlakeHostToolElfMeasureSource
  Greppable: SYSTEMS_LEAN_HOST, liveSlakeHostToolElfMeasureSource,
...
/-- Dual-pinned live SlakeHostToolElfMeasure.lean bytes.
    Greppable: liveSlakeHostToolElfMeasureSource. -/
def liveSlakeHostToolElfMeasureSource : String := r#"/-
