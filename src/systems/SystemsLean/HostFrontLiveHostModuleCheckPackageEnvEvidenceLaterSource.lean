/-
  ...
  HostModuleCheckPackageEnvEvidenceLater.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckPackageEnvEvidenceLaterSource.
  ...
  HOST-FRONT-LIVE-HOSTMODULECHECKPACKAGEENVEVIDENCELATER, liveRel,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckPackageEnvEvidenceLaterSource
...
/-- Dual-pinned live HostModuleCheckPackageEnvEvidenceLater.lean bytes
    (must match the on-disk file).
    Greppable: liveHostModuleCheckPackageEnvEvidenceLaterSource,
    HOST-FRONT-LIVE-HOSTMODULECHECKPACKAGEENVEVIDENCELATER. -/
def liveHostModuleCheckPackageEnvEvidenceLaterSource : String := r#"/-
