/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live OfficialRetireTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveOfficialRetireTheoremsSource. Not occupancy name 50. Not mill 70.
  ...
  HostFrontLiveOfficialRetireTheoremsSource
  ...
  Greppable: SYSTEMS_LEAN_HOST, liveOfficialRetireTheoremsSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveOfficialRetireTheoremsSource
...
/-- Dual-pinned live OfficialRetireTheorems.lean bytes (must match on-disk file).
    Greppable: liveOfficialRetireTheoremsSource, PARSE-LIVE-OFFICIAL-RETIRE-THEOREMS. -/
def liveOfficialRetireTheoremsSource : String := r#"/-
