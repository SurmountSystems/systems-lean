/-
  ...
  Short role: HostFrontLiveImportSeedsSource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-IMPORT-SEEDS, liveImportSeedsSource,
  HOST-FRONT-LIVE-IMPORT-SEEDS, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveImportSeedsSource
...
/-- Dual-pinned live HostImportGraphSeeds.lean bytes (must match on-disk file).
    Greppable: liveImportSeedsSource, PARSE-LIVE-IMPORT-SEEDS. -/
def liveImportSeedsSource : String := r#"/-
