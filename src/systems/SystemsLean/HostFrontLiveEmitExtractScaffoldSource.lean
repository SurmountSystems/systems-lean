/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live EmitExtractScaffold.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveEmitExtractScaffoldSource. Not occupancy name 50. Not mill 70.
  This wrap is EmitExtractScaffold.lean. It is not EmitExtract.lean.
  liveRel is EmitExtractScaffold.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveEmitExtractScaffoldSource,
  HOST-FRONT-LIVE-EMIT-EXTRACT-SCAFFOLD, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveEmitExtractScaffoldSource
...
/-- Live file basename. Exactly EmitExtractScaffold.lean. -/
def liveRel : String := "EmitExtractScaffold.lean"

/-- Dual-pinned live EmitExtractScaffold.lean bytes (must match on-disk file).
    Greppable: liveEmitExtractScaffoldSource, HOST-FRONT-LIVE-EMIT-EXTRACT-SCAFFOLD. -/
def liveEmitExtractScaffoldSource : String := r#"/-
