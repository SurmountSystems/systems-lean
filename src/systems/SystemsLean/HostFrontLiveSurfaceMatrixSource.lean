/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live SurfaceMatrix.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveSurfaceMatrixSource. Not occupancy name 50. Not mill 70.
  ...
  HostFrontLiveSurfaceMatrixSource
  PARSE-LIVE-SURFACE-MATRIX
  HOST-FRONT-LIVE-SURFACE-MATRIX
  Greppable: SYSTEMS_LEAN_HOST, liveSurfaceMatrixSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveSurfaceMatrixSource
...
/-- Dual-pinned live SurfaceMatrix.lean bytes (must match on-disk file).
    Greppable: liveSurfaceMatrixSource, PARSE-LIVE-SURFACE-MATRIX. -/
def liveSurfaceMatrixSource : String := r#"/-
