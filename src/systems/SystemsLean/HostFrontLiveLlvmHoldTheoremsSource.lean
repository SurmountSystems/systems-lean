/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live LlvmHoldTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveLlvmHoldTheoremsSource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, LLVM-HOLD-THEOREM, liveLlvmHoldTheoremsSource,
  HOST-FRONT-LIVE-LLVM-HOLD-THEOREMS, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveLlvmHoldTheoremsSource
...
/-- Dual-pinned live LlvmHoldTheorems.lean bytes (must match on-disk file).
    Greppable: liveLlvmHoldTheoremsSource, LLVM-HOLD-THEOREM. -/
def liveLlvmHoldTheoremsSource : String := r#"/-
