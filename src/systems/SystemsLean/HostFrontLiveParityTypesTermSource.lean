/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckParityTypesTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveParityTypesTermSource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-PARITY-TYPES-TERM, liveParityTypesTermSource,
  HOST-FRONT-LIVE-PARITY-TYPES-TERM, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveParityTypesTermSource
...
/-- Dual-pinned live HostModuleCheckParityTypesTerm.lean bytes (must match on-disk file).
    Greppable: liveParityTypesTermSource, PARSE-LIVE-PARITY-TYPES-TERM. -/
def liveParityTypesTermSource : String := r#"/-
