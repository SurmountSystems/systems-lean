/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live ParityProgramTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveParityProgramTheoremsSource. Not occupancy name 50. Not mill 70.
  This wrap is ParityProgramTheorems.lean. It is not ParityProgram.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveParityProgramTheoremsSource,
  HOST-FRONT-LIVE-PARITY-PROGRAM-THEOREMS, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveParityProgramTheoremsSource
...
/-- Dual-pinned live ParityProgramTheorems.lean bytes (must match on-disk file).
    Greppable: liveParityProgramTheoremsSource, HOST-FRONT-LIVE-PARITY-PROGRAM-THEOREMS. -/
def liveParityProgramTheoremsSource : String := r#"/-
...
def liveRel : String := "ParityProgramTheorems.lean"
