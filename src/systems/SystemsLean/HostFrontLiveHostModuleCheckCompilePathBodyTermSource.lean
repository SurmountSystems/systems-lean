/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckCompilePathBodyTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckCompilePathBodyTermSource. Not occupancy name 50.
  Not mill remill. Mill stays 69 of 69.
  This wrap dual-pins HostModuleCheckCompilePathBodyTerm.lean only. One part.
  Do not steal a neighbor checker. Do not retarget HostFrontLiveHostModuleCheckCheckersLater.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-HOSTMODULECHECKCOMPILEPATHBODYTERM,
  liveHostModuleCheckCompilePathBodyTermSource,
  HOST-FRONT-LIVE-HOSTMODULECHECKCOMPILEPATHBODYTERM,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckCompilePathBodyTermSource
...
/-- Dual-pinned live HostModuleCheckCompilePathBodyTerm.lean bytes.
    One part. Not split. 217 lines plus this header stay under about 780.
    Greppable: liveHostModuleCheckCompilePathBodyTermSource,
    PARSE-LIVE-HOSTMODULECHECKCOMPILEPATHBODYTERM. -/
def liveHostModuleCheckCompilePathBodyTermSource : String := r#"/-
