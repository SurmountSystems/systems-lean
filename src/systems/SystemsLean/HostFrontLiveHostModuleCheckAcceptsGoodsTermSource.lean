/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckAcceptsGoodsTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckAcceptsGoodsTermSource. Not occupancy name 50. Not mill remill. Mill stays 69 of 69.
  Unique needles (trailing newline so a shorter HostModuleCheck prefix is not a hit):
  HostFrontLiveHostModuleCheckAcceptsGoodsTermSource
  PARSE-LIVE-HOSTMODULECHECKACCEPTSGOODSTERM
  HOST-FRONT-LIVE-HOSTMODULECHECKACCEPTSGOODSTERM
  Greppable: SYSTEMS_LEAN_HOST, liveHostModuleCheckAcceptsGoodsTermSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckAcceptsGoodsTermSource
...
/-- Dual-pinned live HostModuleCheckAcceptsGoodsTerm.lean bytes (must match on-disk file).
    Greppable: liveHostModuleCheckAcceptsGoodsTermSource, PARSE-LIVE-HOSTMODULECHECKACCEPTSGOODSTERM. -/
def liveHostModuleCheckAcceptsGoodsTermSource : String := r#"/-
