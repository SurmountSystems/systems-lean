/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live ParityMult.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveParityMultSource. Not occupancy name 50. Not mill 70.
  This wrap is ParityMult.lean. It is not ParityMultTheorems.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveParityMultSource,
  HOST-FRONT-LIVE-PARITY-MULT, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveParityMultSource
...
/-- Dual-pinned live ParityMult.lean bytes (must match on-disk file).
    Greppable: liveParityMultSource, HOST-FRONT-LIVE-PARITY-MULT. -/
def liveParityMultSource : String := r#"/-
  ...
  - Live in SystemsLean.ParityMultTheorems (same namespace; long-file peel).
  ...
  - PARITY-MULT-SMOKE behavioral examples live with theorems
  ...
  productNameApi_eq, isValidParityOk_true, enumTagParityOk_true, ParityMultTheorems
  UNIT_SURFACE host surface. Module: SystemsLean.ParityMult
  Long-file peel: PARITY-MULT-THEOREM + PARITY-MULT-SMOKE in
  SystemsLean.ParityMultTheorems (same namespace).
