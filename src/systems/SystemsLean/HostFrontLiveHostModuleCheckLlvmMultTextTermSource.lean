/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckLlvmMultTextTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckLlvmMultTextTermSource.
  Not occupancy name 50. Host tools stay 69 of 69. Not FullHost.
  Not an LLVM backend. Not Lake-gone. Not PROVABLY.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-LLVMMULTTEXTTERM,
  liveHostModuleCheckLlvmMultTextTermSource, liveRel,
  HOST-FRONT-LIVE-LLVMMULTTEXTTERM, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckLlvmMultTextTermSource
...
def liveRel : String := "HostModuleCheckLlvmMultTextTerm.lean"

/-- Repo-relative path for the disk read. Not liveRel. -/
def liveHostModuleCheckLlvmMultTextTermRel : String :=
  "src/systems/SystemsLean/" ++ liveRel

/-- Dual-pinned live HostModuleCheckLlvmMultTextTerm.lean bytes (must match on-disk file).
    Greppable: liveHostModuleCheckLlvmMultTextTermSource, PARSE-LIVE-LLVMMULTTEXTTERM. -/
def liveHostModuleCheckLlvmMultTextTermSource : String := r#"/-
