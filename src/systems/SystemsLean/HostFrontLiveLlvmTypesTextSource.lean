/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live LlvmTypesText.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveLlvmTypesTextSource. Not occupancy name 50. Not mill 70.
  This wrap is LlvmTypesText.lean. It is not LlvmHold.lean.
  It is not LlvmLinearText.lean. It is not LlvmMultText.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveLlvmTypesTextSource,
  HOST-FRONT-LIVE-LLVM-TYPES-TEXT, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveLlvmTypesTextSource
...
/-- Dual-pinned live LlvmTypesText.lean bytes (must match on-disk file).
    Greppable: liveLlvmTypesTextSource, HOST-FRONT-LIVE-LLVM-TYPES-TEXT. -/
def liveLlvmTypesTextSource : String := r###"/-
