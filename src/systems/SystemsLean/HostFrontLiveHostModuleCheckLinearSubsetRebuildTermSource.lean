/-
  SYSTEMS_LEAN_HOST partial -- live HostModuleCheckLinearSubsetRebuildTerm.lean.
  ...
  liveRel is HostModuleCheckLinearSubsetRebuildTerm.lean. Not a path.
  Greppable: liveRel, kernelCheckLiveHostModuleCheckLinearSubsetRebuildTermSource,
  PARSE-LIVE-HOST-MODULE-CHECK-LINEAR-SUBSET-REBUILD-TERM.
  Module: SystemsLean.HostFrontLiveHostModuleCheckLinearSubsetRebuildTermSource
...
namespace SystemsLean.HostFrontLiveHostModuleCheckLinearSubsetRebuildTermSource
...
def liveRel : String := "HostModuleCheckLinearSubsetRebuildTerm.lean"

/-- Pinned live HostModuleCheckLinearSubsetRebuildTerm.lean bytes. -/
def liveHostModuleCheckLinearSubsetRebuildTermSource : String := r#"/-
...
def kernelCheckLiveHostModuleCheckLinearSubsetRebuildTermSource (src : String) : Bool :=
  match parseLiveLlvmComposeTextMainSource src with
  | FrontResult.accept m => HostKernel.kernelCheck m
  | FrontResult.reject _ => false

/-- Ready is parse plus kernelCheck of the pinned text. -/
def hostFrontLiveHostModuleCheckLinearSubsetRebuildTermSourceReady : Bool :=
  liveRel == "HostModuleCheckLinearSubsetRebuildTerm.lean"
    && kernelCheckLiveHostModuleCheckLinearSubsetRebuildTermSource liveHostModuleCheckLinearSubsetRebuildTermSource
...
def runLive (root : System.FilePath) : IO Unit := do
  ...
  if disk != liveHostModuleCheckLinearSubsetRebuildTermSource then
    throw (IO.userError "dual-pin mismatch HostModuleCheckLinearSubsetRebuildTerm.lean")
  let k := kernelCheckLiveHostModuleCheckLinearSubsetRebuildTermSource disk
  IO.println s!"kernelCheck={k}"
  unless k do
    throw (IO.userError "kernelCheck live HostModuleCheckLinearSubsetRebuildTerm parse false")
  unless hostFrontLiveHostModuleCheckLinearSubsetRebuildTermSourceReady do
...
end SystemsLean.HostFrontLiveHostModuleCheckLinearSubsetRebuildTermSource
