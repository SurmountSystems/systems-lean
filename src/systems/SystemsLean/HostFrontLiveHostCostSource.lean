/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostCost.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostCostSource. Not occupancy name 50. Not mill 70.
  ...
  HostFrontLiveHostCostSource
  PARSE-LIVE-HOST-COST
  HOST-FRONT-LIVE-HOST-COST
  Greppable: SYSTEMS_LEAN_HOST, liveHostCostSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostCostSource
...
/-- Dual-pinned live HostCost.lean bytes (must match on-disk file).
    Greppable: liveHostCostSource, PARSE-LIVE-HOST-COST. -/
def liveHostCostSource : String := r#"/-
