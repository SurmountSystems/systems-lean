/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live LinearUseFail.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveLinearUseFailSource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-LINEAR-USE-FAIL, liveLinearUseFailSource,
  HOST-FRONT-LIVE-LINEAR-USE-FAIL, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveLinearUseFailSource
...
/-- Dual-pinned live LinearUseFail.lean bytes (must match on-disk file).
    Greppable: liveLinearUseFailSource, PARSE-LIVE-LINEAR-USE-FAIL. -/
def liveLinearUseFailSource : String := r#"/-
