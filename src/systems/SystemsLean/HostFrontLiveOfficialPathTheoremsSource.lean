/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live OfficialPathTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveOfficialPathTheoremsSource. Not occupancy name 50. Not mill 70.
  ...
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-OFFICIAL-PATH-THEOREMS, liveOfficialPathTheoremsSource,
  HOST-FRONT-LIVE-OFFICIAL-PATH-THEOREMS, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveOfficialPathTheoremsSource
...
/-- Dual-pinned live OfficialPathTheorems.lean bytes (must match on-disk file).
    Greppable: liveOfficialPathTheoremsSource, PARSE-LIVE-OFFICIAL-PATH-THEOREMS. -/
def liveOfficialPathTheoremsSource : String := r#"/-
