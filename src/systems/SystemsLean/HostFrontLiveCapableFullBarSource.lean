/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live CapableFullBar.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveCapableFullBarSource. Not occupancy name 50. Not mill 70.
  This wrap is CapableFullBar.lean. It is not CapableFullBarTheorems.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveCapableFullBarSource,
  HOST-FRONT-LIVE-CAPABLE-FULL-BAR, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveCapableFullBarSource
...
/-- Dual-pinned live CapableFullBar.lean bytes (must match on-disk file).
    Greppable: liveCapableFullBarSource, HOST-FRONT-LIVE-CAPABLE-FULL-BAR. -/
def liveCapableFullBarSource : String := r#"/-
