/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckHostGraphTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckHostGraphTermSource.
  Not occupancy name 50. Not mill 70.
  This wrap is HostModuleCheckHostGraphTerm.lean.
  It is not HostModuleCheck and not HostFront.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveHostModuleCheckHostGraphTermSource,
  HOST-FRONT-LIVE-HOSTMODULECHECKHOSTGRAPHTERM, liveRel,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckHostGraphTermSource
...
/-- Dual-pinned live HostModuleCheckHostGraphTerm.lean bytes
    (must match the on-disk file).
    Greppable: liveHostModuleCheckHostGraphTermSource,
    HOST-FRONT-LIVE-HOSTMODULECHECKHOSTGRAPHTERM. -/
def liveHostModuleCheckHostGraphTermSource : String := r#"/-
