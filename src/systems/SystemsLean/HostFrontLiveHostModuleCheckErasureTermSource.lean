/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckErasureTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckErasureTermSource. Not occupancy name 50.
  Not mill remill. Mill stays 69 of 69.
  This wrap dual-pins HostModuleCheckErasureTerm.lean only. One part.
  Do not steal a neighbor checker. Do not retarget HostModuleCheckErasureTerm.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-HOSTMODULECHECKERASURETERM,
  liveHostModuleCheckErasureTermSource,
  HOST-FRONT-LIVE-HOSTMODULECHECKERASURETERM,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckErasureTermSource
...
/-- Dual-pinned live HostModuleCheckErasureTerm.lean bytes.
    One part. Not split. 452 lines plus this header stay under about 780.
    Greppable: liveHostModuleCheckErasureTermSource,
    PARSE-LIVE-HOSTMODULECHECKERASURETERM. -/
def liveHostModuleCheckErasureTermSource : String := r#"/-
