/-
  SYSTEMS_LEAN_HOST partial -- live HostModuleCheckMultSubsetRebuildTerm.lean.
  ...
  liveRel is HostModuleCheckMultSubsetRebuildTerm.lean. Not a path.
  Greppable: liveRel, kernelCheckLiveHostModuleCheckMultSubsetRebuildTermSource,
  PARSE-LIVE-HOST-MODULE-CHECK-MULT-SUBSET-REBUILD-TERM.
  Module: SystemsLean.HostFrontLiveHostModuleCheckMultSubsetRebuildTermSource
...
namespace SystemsLean.HostFrontLiveHostModuleCheckMultSubsetRebuildTermSource
...
def liveRel : String := "HostModuleCheckMultSubsetRebuildTerm.lean"

/-- Pinned live HostModuleCheckMultSubsetRebuildTerm.lean bytes. -/
def liveHostModuleCheckMultSubsetRebuildTermSource : String := r#"/-
...
def kernelCheckLiveHostModuleCheckMultSubsetRebuildTermSource (src : String) : Bool :=
  match parseLiveLlvmComposeTextMainSource src with
  | FrontResult.accept m => HostKernel.kernelCheck m
  | FrontResult.reject _ => false

/-- Ready is parse plus kernelCheck of the pinned text. -/
def hostFrontLiveHostModuleCheckMultSubsetRebuildTermSourceReady : Bool :=
  liveRel == "HostModuleCheckMultSubsetRebuildTerm.lean"
    && kernelCheckLiveHostModuleCheckMultSubsetRebuildTermSource liveHostModuleCheckMultSubsetRebuildTermSource
...
def runLive (root : System.FilePath) : IO Unit := do
  ...
  if disk != liveHostModuleCheckMultSubsetRebuildTermSource then
    throw (IO.userError "dual-pin mismatch HostModuleCheckMultSubsetRebuildTerm.lean")
  let k := kernelCheckLiveHostModuleCheckMultSubsetRebuildTermSource disk
  IO.println s!"kernelCheck={k}"
  unless k do
    throw (IO.userError "kernelCheck live HostModuleCheckMultSubsetRebuildTerm parse false")
  unless hostFrontLiveHostModuleCheckMultSubsetRebuildTermSourceReady do
...
end SystemsLean.HostFrontLiveHostModuleCheckMultSubsetRebuildTermSource
