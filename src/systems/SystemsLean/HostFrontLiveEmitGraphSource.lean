/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live EmitGraph.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveEmitGraphSource. Not occupancy name 50.
  Occupancy stays 49. Not mill 70. Mill stays 69 of 69. Not Lake-gone.
  slakeOwnsPackageTypecheck stays false.
  Unique needles (trailing newline so a longer name is not a prefix hit):
  HostFrontLiveEmitGraph
  HostFrontLiveEmitGraphSource
  PARSE-LIVE-EMIT-GRAPH
  HOST-FRONT-LIVE-EMIT-GRAPH
  EmitGraph.lean
  Greppable: SYSTEMS_LEAN_HOST, liveEmitGraphSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveEmitGraphSource
  Not FullHost. Not freestanding residual free. Not PROVABLY.
  Module must stay ASCII.
  liveRel for this wrap is EmitGraph.lean.
-/

namespace SystemsLean.HostFrontLiveEmitGraph

/-- Dual-pinned live EmitGraph.lean bytes (must match on-disk file).
    Greppable: liveEmitGraphSource, PARSE-LIVE-EMIT-GRAPH.
    liveRel for this wrap is EmitGraph.lean. -/
def liveEmitGraphSource : String := r#"/-
