/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live EmitProgram.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveEmitProgramSource. Not occupancy name 50.
  ...
  HostFrontLiveEmitProgramSource
  PARSE-LIVE-EMIT-PROGRAM
  HOST-FRONT-LIVE-EMIT-PROGRAM
  src/systems/SystemsLean/EmitProgram.lean
  Greppable: SYSTEMS_LEAN_HOST, liveEmitProgramSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveEmitProgramSource
...
/-- Dual-pinned live EmitProgram.lean bytes (must match on-disk file).
    Greppable: liveEmitProgramSource, PARSE-LIVE-EMIT-PROGRAM. -/
def liveEmitProgramSource : String := r#"/-
