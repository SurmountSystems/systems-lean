/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live LlvmLinearText.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveLlvmLinearTextSource. Not occupancy name 50. Not mill 70.
  This wrap is LlvmLinearText.lean. It is not a theorems peel.
  Greppable: SYSTEMS_LEAN_HOST, liveLlvmLinearTextSource,
  HOST-FRONT-LIVE-LLVM-LINEAR-TEXT, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveLlvmLinearTextSource
  Not FullHost. Not freestanding residual free. Not PROVABLY.
  Not a backend. Not an LLVM backend. FullBackend stays false in the wrap.
  Module must stay ASCII.
-/

namespace SystemsLean.HostFrontLiveLlvmLinearText

/-- Dual-pinned live LlvmLinearText.lean bytes (must match on-disk file).
    Greppable: liveLlvmLinearTextSource, HOST-FRONT-LIVE-LLVM-LINEAR-TEXT. -/
def liveLlvmLinearTextSource : String := r#"/-
