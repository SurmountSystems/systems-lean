/-
  ...
  HostModuleCheckSubsetPackageJoinTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckSubsetPackageJoinTermSource.
  ...
  liveHostModuleCheckSubsetPackageJoinTermSource,
  HOST-FRONT-LIVE-HOSTMODULECHECKSUBSETPACKAGEJOINTERM, liveRel,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckSubsetPackageJoinTermSource
...
/-- Dual-pinned live HostModuleCheckSubsetPackageJoinTerm.lean bytes.
    One raw string. The product is 331 lines, so this file stays under 780.
    Greppable: liveHostModuleCheckSubsetPackageJoinTermSource,
    HOST-FRONT-LIVE-HOSTMODULECHECKSUBSETPACKAGEJOINTERM. -/
def liveHostModuleCheckSubsetPackageJoinTermSource : String := r#"/-
