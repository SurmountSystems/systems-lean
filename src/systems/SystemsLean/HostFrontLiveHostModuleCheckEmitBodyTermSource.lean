/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckEmitBodyTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckEmitBodyTermSource. Not occupancy name 50.
  Not mill remill. Mill stays 69 of 69.
  This wrap dual-pins HostModuleCheckEmitBodyTerm.lean only. One part.
  Do not steal a neighbor checker. Do not retarget HostModuleCheckEmitBodyTerm.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-HOSTMODULECHECKEMITBODYTERM,
  liveHostModuleCheckEmitBodyTermSource,
  HOST-FRONT-LIVE-HOSTMODULECHECKEMITBODYTERM,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckEmitBodyTermSource
...
/-- Dual-pinned live HostModuleCheckEmitBodyTerm.lean bytes.
    One part. Not split. 496 lines plus this header stay under about 780.
    Greppable: liveHostModuleCheckEmitBodyTermSource,
    PARSE-LIVE-HOSTMODULECHECKEMITBODYTERM. -/
def liveHostModuleCheckEmitBodyTermSource : String := r#"/-
