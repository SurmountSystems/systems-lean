/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live LlvmGraphText.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveLlvmGraphTextSource. Not occupancy name 50. Not mill 70.
  This wrap is LlvmGraphText.lean. It is not LlvmHold.lean.
  It is not LlvmTypesText.lean. It is not LlvmProgramText.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveLlvmGraphTextSource,
  HOST-FRONT-LIVE-LLVM-GRAPH-TEXT, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveLlvmGraphTextSource
...
/-- Dual-pinned live LlvmGraphText.lean bytes (must match on-disk file).
    Greppable: liveLlvmGraphTextSource, HOST-FRONT-LIVE-LLVM-GRAPH-TEXT. -/
def liveLlvmGraphTextSource : String := r#"/-
