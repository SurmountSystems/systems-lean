/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live GraphSubsetRebuild.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveGraphSubsetRebuildSource.
  This wrap is GraphSubsetRebuild.lean.
  It is not GraphSubsetRebuildMain.lean.
  It is not Linear.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveGraphSubsetRebuildSource,
  HOST-FRONT-LIVE-GRAPH-SUBSET-REBUILD, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveGraphSubsetRebuildSource
...
/-- Dual-pinned live GraphSubsetRebuild.lean bytes (must match on-disk file).
    Greppable: liveGraphSubsetRebuildSource,
    HOST-FRONT-LIVE-GRAPH-SUBSET-REBUILD. -/
def liveGraphSubsetRebuildSource : String := r###"/-
