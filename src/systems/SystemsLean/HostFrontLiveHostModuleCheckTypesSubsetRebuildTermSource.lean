/-
  ...
  HostModuleCheckTypesSubsetRebuildTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckTypesSubsetRebuildTermSource.
  ...
  liveHostModuleCheckTypesSubsetRebuildTermSource,
  HOST-FRONT-LIVE-HOSTMODULECHECKTYPESSUBSETREBUILDTERM, liveRel,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckTypesSubsetRebuildTermSource
...
/-- Dual-pinned live HostModuleCheckTypesSubsetRebuildTerm.lean bytes.
    One raw string. The product is 304 lines, so this file stays under 780.
    Greppable: liveHostModuleCheckTypesSubsetRebuildTermSource,
    HOST-FRONT-LIVE-HOSTMODULECHECKTYPESSUBSETREBUILDTERM. -/
def liveHostModuleCheckTypesSubsetRebuildTermSource : String := r#"/-
