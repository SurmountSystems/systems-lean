/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live CompilePathCompose.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveCompilePathComposeSource. Not occupancy name 50. Not mill 70.
...
/-- Dual-pinned live CompilePathCompose.lean bytes (must match on-disk file).
    Greppable: liveCompilePathComposeSource, PARSE-LIVE-COMPILE-PATH-COMPOSE. -/
def liveCompilePathComposeSource : String := r#"/-
