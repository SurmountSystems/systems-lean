/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckEmitBannerScaffoldTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckEmitBannerScaffoldTermSource. Not occupancy name 50.
  Not mill remill. Mill stays 69 of 69.
  This wrap dual-pins HostModuleCheckEmitBannerScaffoldTerm.lean only. One part.
  Do not steal a neighbor checker. Do not retarget HostModuleCheckEmitBannerScaffoldTerm.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-HOSTMODULECHECKEMITBANNERSCAFFOLDTERM,
  liveHostModuleCheckEmitBannerScaffoldTermSource,
  HOST-FRONT-LIVE-HOSTMODULECHECKEMITBANNERSCAFFOLDTERM,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckEmitBannerScaffoldTermSource
...
/-- Dual-pinned live HostModuleCheckEmitBannerScaffoldTerm.lean bytes.
    One part. Not split. 345 lines plus this header stay under about 780.
    Greppable: liveHostModuleCheckEmitBannerScaffoldTermSource,
    PARSE-LIVE-HOSTMODULECHECKEMITBANNERSCAFFOLDTERM. -/
def liveHostModuleCheckEmitBannerScaffoldTermSource : String := r#"/-
