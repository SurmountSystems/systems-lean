/-
  ...
  Short role: HostFrontLiveKernelProgramTermSource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-KERNELPROGRAMTERM, liveKernelProgramTermSource,
  HOST-FRONT-LIVE-KERNELPROGRAMTERM, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveKernelProgramTermSource
...
/-- Dual-pinned live HostModuleCheckKernelProgramTerm.lean bytes (must match on-disk file).
    Greppable: liveKernelProgramTermSource, PARSE-LIVE-KERNELPROGRAMTERM. -/
def liveKernelProgramTermSource : String := r#"/-
