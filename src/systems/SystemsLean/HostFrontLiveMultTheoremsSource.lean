/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live MultTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveMultTheoremsSource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-MULT-THEOREMS, liveMultTheoremsSource,
  HOST-FRONT-LIVE-MULT-THEOREMS, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveMultTheoremsSource
...
/-- Dual-pinned live MultTheorems.lean bytes (must match on-disk file).
    Greppable: liveMultTheoremsSource, PARSE-LIVE-MULT-THEOREMS. -/
def liveMultTheoremsSource : String := r#"/-
