/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckExtractSubsetEmitTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckExtractSubsetEmitTermSource. Not occupancy name 50.
  Not mill remill. Mill stays 69 of 69.
  This wrap dual-pins HostModuleCheckExtractSubsetEmitTerm.lean only. One part.
  Do not steal a neighbor checker. Do not retarget HostModuleCheckExtractSubsetEmitTerm.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-HOSTMODULECHECKEXTRACTSUBSETEMITTERM,
  liveHostModuleCheckExtractSubsetEmitTermSource,
  HOST-FRONT-LIVE-HOSTMODULECHECKEXTRACTSUBSETEMITTERM,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckExtractSubsetEmitTermSource
...
/-- Dual-pinned live HostModuleCheckExtractSubsetEmitTerm.lean bytes.
    One part. Not split. 273 product lines plus this header stay under about 780.
    Greppable: liveHostModuleCheckExtractSubsetEmitTermSource,
    PARSE-LIVE-HOSTMODULECHECKEXTRACTSUBSETEMITTERM. -/
def liveHostModuleCheckExtractSubsetEmitTermSource : String := r#"/-
