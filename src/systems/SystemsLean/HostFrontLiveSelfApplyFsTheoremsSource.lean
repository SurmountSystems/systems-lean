/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live SelfApplyFsTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveSelfApplyFsTheoremsSource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-SELFAPPLYFSTHEOREMS,
  liveSelfApplyFsTheoremsSource, HOST-FRONT-LIVE-SELFAPPLYFSTHEOREMS,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveSelfApplyFsTheoremsSource
...
/-- Dual-pinned live SelfApplyFsTheorems.lean bytes (must match on-disk file).
    Greppable: liveSelfApplyFsTheoremsSource, PARSE-LIVE-SELFAPPLYFSTHEOREMS. -/
def liveSelfApplyFsTheoremsSource : String := r#"/-
