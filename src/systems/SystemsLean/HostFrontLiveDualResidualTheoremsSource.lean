/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live DualResidualTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveDualResidualTheoremsSource. Not occupancy name 50.
  Greppable: SYSTEMS_LEAN_HOST, liveDualResidualTheoremsSource,
  HOST-FRONT-LIVE-DUAL-RESIDUAL-THEOREMS, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveDualResidualTheoremsSource
...
/-- Dual-pinned live DualResidualTheorems.lean bytes (must match on-disk file).
    Greppable: liveDualResidualTheoremsSource, PARSE-LIVE-DUAL-RESIDUAL-THEOREMS. -/
def liveDualResidualTheoremsSource : String := r#"/-
