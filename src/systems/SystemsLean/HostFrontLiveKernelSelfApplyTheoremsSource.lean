/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live KernelSelfApplyTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveKernelSelfApplyTheoremsSource. Not occupancy name 50. Not mill 70.
  Not HostFrontLiveKernelSelfApplySource (that wrap dual-pins KernelSelfApply.lean).
  Unique needles (trailing newline so HostFrontLiveKernelSelfApplyTheoremsSource is
  not a prefix hit on KernelSelfApply wrap HostFrontLiveKernelSelfApplySource):
  HostFrontLiveKernelSelfApplyTheoremsSource
  PARSE-LIVE-KERNEL-SELF-APPLY-THEOREMS
  HOST-FRONT-LIVE-KERNEL-SELF-APPLY-THEOREMS
  liveKernelSelfApplyTheoremsSource
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-KERNEL-SELF-APPLY-THEOREMS,
  liveKernelSelfApplyTheoremsSource, liveRel,
  HOST-FRONT-LIVE-KERNEL-SELF-APPLY-THEOREMS, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveKernelSelfApplyTheoremsSource
...
/-- Dual-pinned live KernelSelfApplyTheorems.lean bytes (must match on-disk file).
    Greppable: liveKernelSelfApplyTheoremsSource, PARSE-LIVE-KERNEL-SELF-APPLY-THEOREMS. -/
def liveKernelSelfApplyTheoremsSource : String := r#"/-
