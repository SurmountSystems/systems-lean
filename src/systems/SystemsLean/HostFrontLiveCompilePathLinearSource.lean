/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live CompilePathLinear.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveCompilePathLinearSource. Not occupancy name 50. Not mill 70.
...
/-- Dual-pinned live CompilePathLinear.lean bytes (must match on-disk file).
    Greppable: liveCompilePathLinearSource, PARSE-LIVE-COMPILE-PATH-LINEAR. -/
def liveCompilePathLinearSource : String := r#"/-
