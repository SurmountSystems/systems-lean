/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckParityLinearTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveParityLinearTermSource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-PARITY-LINEAR-TERM, liveParityLinearTermSource,
  HOST-FRONT-LIVE-PARITY-LINEAR-TERM, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveParityLinearTermSource
...
/-- Dual-pinned live HostModuleCheckParityLinearTerm.lean bytes (must match on-disk file).
    Greppable: liveParityLinearTermSource, PARSE-LIVE-PARITY-LINEAR-TERM. -/
def liveParityLinearTermSource : String := r#"/-
