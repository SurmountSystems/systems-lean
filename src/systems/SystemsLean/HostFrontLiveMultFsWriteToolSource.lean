/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live MultFsWriteTool.lean bytes.
  Module: SystemsLean.HostFrontLiveMultFsWriteToolSource
  liveRel is MultFsWriteTool.lean. Not FullHost. Not a Main parser.
  Module must stay ASCII.
-/

namespace SystemsLean.HostFrontLiveMultFsWriteTool

/-- Dual-pinned live MultFsWriteTool.lean bytes. -/
def liveMultFsWriteToolSource : String := r##"/-
