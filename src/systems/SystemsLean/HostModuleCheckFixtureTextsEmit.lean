/-
  SYSTEMS_LEAN_HOST partial -- HostModuleCheck good fixture texts (Emit scaffolds..ProductPathOwnershipInputs).
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Long-file peel from SystemsLean.HostModuleCheckFixtureTexts: dual-pinned good
  structural fixture text strings EmitMultScaffold through ProductPathOwnershipInputsTheorems.
  ...
  Greppable: SYSTEMS_LEAN_HOST, HOST-MODULE-CHECK, HostModuleCheckFixtureTextsEmit,
  PARTIAL-STRUCTURAL, FOUNDATION-KIND-SURFACE, Host library seed expand continue,
  UNIT_SURFACE host surface, RUNTIME-FS, MULT-0.
  Module: SystemsLean.HostModuleCheckFixtureTextsEmit
  Red/green: just systems-host; lake build SystemsLean.HostModuleCheckFixtureTextsEmit;
...
/-- Minimal good ProductPathOwnershipInputs text (SelfApplyFs ProductPath pure leaf).
    Greppable: hostModuleCheckGoodProductPathOwnershipInputsText, Host library seed expand continue. -/
def hostModuleCheckGoodProductPathOwnershipInputsText : String :=
  ...
  "def productPathOwnershipInputsOk : Bool := true\n" ++
  "def productPathOwnershipInputsPartialReady : Bool := true\n" ++
  "end SystemsLean.ProductPathOwnershipInputs\n"

/-- Minimal good ProductPathOwnershipInputsTheorems text.
    Greppable: hostModuleCheckGoodProductPathOwnershipInputsTheoremsText, Host library seed expand continue. -/
def hostModuleCheckGoodProductPathOwnershipInputsTheoremsText : String :=
  ...
  "    productPathOwnershipInputsPartialReady = true := by native_decide\n" ++
  "end SystemsLean.ProductPathOwnershipInputs\n"
