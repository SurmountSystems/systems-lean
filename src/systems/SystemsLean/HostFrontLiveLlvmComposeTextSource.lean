/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live LlvmComposeText.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveLlvmComposeTextSource. Not occupancy name 50. Not mill 70.
  This wrap is LlvmComposeText.lean. It is not LlvmComposeTextTheorems.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveLlvmComposeTextSource,
  HOST-FRONT-LIVE-LLVM-COMPOSE-TEXT, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveLlvmComposeTextSource
...
/-- Dual-pinned live LlvmComposeText.lean bytes (must match on-disk file).
    Greppable: liveLlvmComposeTextSource, HOST-FRONT-LIVE-LLVM-COMPOSE-TEXT. -/
def liveLlvmComposeTextSource : String := r#"/-
