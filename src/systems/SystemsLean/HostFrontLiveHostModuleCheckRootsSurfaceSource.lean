/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckRootsSurface.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckRootsSurfaceSource. Not occupancy name 50.
  Not mill remill. Mill stays 69 of 69.
  This wrap dual-pins HostModuleCheckRootsSurface.lean only. One part.
  Do not steal HostFrontLiveHostModuleCheckCheckers (liveRel is
  HostModuleCheckCheckers.lean).
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-HOSTMODULECHECKROOTSSURFACE,
  liveHostModuleCheckRootsSurfaceSource, HOST-FRONT-LIVE-HOSTMODULECHECKROOTSSURFACE,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckRootsSurfaceSource
...
/-- Dual-pinned live HostModuleCheckRootsSurface.lean bytes.
    Greppable: liveHostModuleCheckRootsSurfaceSource,
    PARSE-LIVE-HOSTMODULECHECKROOTSSURFACE. -/
def liveHostModuleCheckRootsSurfaceSource : String := r#"import SystemsLean.HostModuleCheckFixtures
