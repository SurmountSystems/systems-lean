/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live CompilePathApply.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveCompilePathApplySource. Not occupancy name 50. Not mill 70.
  This wrap parses CompilePathApply.lean only.
  Unique needles use trailing newline so HostFrontLiveCompilePathApply is not a
  prefix hit on HostFrontLiveCompilePathApplySource.
  ...
  HostFrontLiveCompilePathApplySource
  PARSE-LIVE-COMPILE-PATH-APPLY
  HOST-FRONT-LIVE-COMPILE-PATH-APPLY
  COMPILE-PATH-APPLY
  Greppable: SYSTEMS_LEAN_HOST, liveCompilePathApplySource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveCompilePathApplySource
...
/-- Dual-pinned live CompilePathApply.lean bytes (must match on-disk file).
    Greppable: liveCompilePathApplySource, PARSE-LIVE-COMPILE-PATH-APPLY. -/
def liveCompilePathApplySource : String := r#"/-
