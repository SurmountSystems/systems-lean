/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live ParityLinear.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveParityLinearSource. Not occupancy name 50. Not mill 70.
  This wrap is ParityLinear.lean. It is not ParityLinearTheorems.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveParityLinearSource,
  HOST-FRONT-LIVE-PARITY-LINEAR, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveParityLinearSource
...
/-- Dual-pinned live ParityLinear.lean bytes (must match on-disk file).
    Greppable: liveParityLinearSource, HOST-FRONT-LIVE-PARITY-LINEAR. -/
def liveParityLinearSource : String := r#"/-
  ...
  ParityLinear):
  - Live in SystemsLean.ParityLinearTheorems (same namespace; long-file split).
  ...
  - PARITY-LINEAR-SMOKE behavioral examples live with theorems
  ...
  productApiSurfaceOk_true, ParityLinearTheorems
  UNIT_SURFACE host surface. Module: SystemsLean.ParityLinear
  Long-file split: PARITY-LINEAR-THEOREM + PARITY-LINEAR-SMOKE in
  SystemsLean.ParityLinearTheorems (same namespace).
