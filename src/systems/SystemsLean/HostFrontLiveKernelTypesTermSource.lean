/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckKernelTypesTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveKernelTypesTermSource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-KERNELTYPESTERM, liveKernelTypesTermSource,
  HOST-FRONT-LIVE-KERNELTYPESTERM, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveKernelTypesTermSource
...
/-- Dual-pinned live HostModuleCheckKernelTypesTerm.lean bytes (must match on-disk file).
    Greppable: liveKernelTypesTermSource, PARSE-LIVE-KERNELTYPESTERM. -/
def liveKernelTypesTermSource : String := r#"/-
