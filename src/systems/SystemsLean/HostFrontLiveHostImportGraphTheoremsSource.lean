/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostImportGraphTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostImportGraphTheoremsSource. Not occupancy name 50.
  Not mill remill. Mill stays 69 of 69.
  This wrap dual-pins HostImportGraphTheorems.lean only.
  ...
  HostFrontLiveHostImportGraphTheoremsSource
  ...
  Greppable: SYSTEMS_LEAN_HOST, liveHostImportGraphTheoremsSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostImportGraphTheoremsSource
...
/-- Dual-pinned live HostImportGraphTheorems.lean bytes (must match on-disk file).
    Greppable: liveHostImportGraphTheoremsSource, PARSE-LIVE-HOST-IMPORT-GRAPH-THEOREMS. -/
def liveHostImportGraphTheoremsSource : String := r#"/-
