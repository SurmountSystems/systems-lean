/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live CapableFullBarTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveCapableFullBarTheoremsSource. Not occupancy name 50.
  Not mill 70.
  This wrap is CapableFullBarTheorems.lean. It is not CapableFullBar.lean.
  Greppable: SYSTEMS_LEAN_HOST, FULL-BAR-THEOREM,
  liveCapableFullBarTheoremsSource,
  HOST-FRONT-LIVE-CAPABLE-FULL-BAR-THEOREMS, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveCapableFullBarTheoremsSource
...
/-- Dual-pinned live CapableFullBarTheorems.lean bytes (must match on-disk file).
    Greppable: liveCapableFullBarTheoremsSource, FULL-BAR-THEOREM. -/
def liveCapableFullBarTheoremsSource : String := r#"/-
