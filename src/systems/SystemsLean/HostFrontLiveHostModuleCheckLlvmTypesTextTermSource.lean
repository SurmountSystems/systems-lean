/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckLlvmTypesTextTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckLlvmTypesTextTermSource.
  Not occupancy name 50. Host tools stay 69 of 69. Not FullHost.
  Not an LLVM backend. Not Lake-gone. Not PROVABLY.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-LLVMTYPESTEXTTERM,
  liveHostModuleCheckLlvmTypesTextTermSource, liveRel,
  HOST-FRONT-LIVE-LLVMTYPESTEXTTERM, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckLlvmTypesTextTermSource
...
def liveRel : String := "HostModuleCheckLlvmTypesTextTerm.lean"

/-- Repo-relative path for the disk read. Not liveRel. -/
def liveHostModuleCheckLlvmTypesTextTermRel : String :=
  "src/systems/SystemsLean/" ++ liveRel

/-- Dual-pinned live HostModuleCheckLlvmTypesTextTerm.lean bytes (must match on-disk file).
    Greppable: liveHostModuleCheckLlvmTypesTextTermSource, PARSE-LIVE-LLVMTYPESTEXTTERM. -/
def liveHostModuleCheckLlvmTypesTextTermSource : String := r#"/-
