/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live SlakeHostToolElfLink.lean bytes.
  Module: SystemsLean.HostFrontLiveSlakeHostToolElfLinkSource
  Greppable: SYSTEMS_LEAN_HOST, liveSlakeHostToolElfLinkSource,
...
/-- Dual-pinned live SlakeHostToolElfLink.lean bytes.
    Greppable: liveSlakeHostToolElfLinkSource. -/
def liveSlakeHostToolElfLinkSource : String := r#"/-
