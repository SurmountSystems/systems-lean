/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live DualEqWriteCapableGapTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveDualEqWriteCapableGapTheoremsSource.
  Not occupancy name 50. Not mill 70.
  This wrap is DualEqWriteCapableGapTheorems.lean.
  It is not DualEqWriteCapableGap.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveDualEqWriteCapableGapTheoremsSource,
  HOST-FRONT-LIVE-DUAL-EQ-WRITE-CAPABLE-GAP-THEOREMS, liveRel,
  CAPABLE-GAP-THEOREM, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveDualEqWriteCapableGapTheoremsSource
...
/-- Dual-pinned live DualEqWriteCapableGapTheorems.lean bytes (must match on-disk file).
    Greppable: liveDualEqWriteCapableGapTheoremsSource,
    HOST-FRONT-LIVE-DUAL-EQ-WRITE-CAPABLE-GAP-THEOREMS. -/
def liveDualEqWriteCapableGapTheoremsSource : String := r#"/-
