/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live SpecProofTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveSpecProofTheoremsSource. Not occupancy name 50. Not mill 70.
  This wrap is SpecProofTheorems.lean. It is not SpecProof.lean.
  Greppable: SYSTEMS_LEAN_HOST, SPEC-PROOF-THEOREM, liveSpecProofTheoremsSource,
  HOST-FRONT-LIVE-SPEC-PROOF-THEOREMS, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveSpecProofTheoremsSource
...
/-- Dual-pinned live SpecProofTheorems.lean bytes (must match on-disk file).
    Greppable: liveSpecProofTheoremsSource, SPEC-PROOF-THEOREM. -/
def liveSpecProofTheoremsSource : String := r#"/-
