/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live ProductPathComposePlanTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveProductPathComposePlanTheoremsSource. Not occupancy name 50. Not mill 70.
  ...
  HostFrontLiveProductPathComposePlanTheoremsSource
  ...
  Greppable: SYSTEMS_LEAN_HOST, liveProductPathComposePlanTheoremsSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveProductPathComposePlanTheoremsSource
...
/-- Dual-pinned live ProductPathComposePlanTheorems.lean bytes (must match on-disk file).
    Greppable: liveProductPathComposePlanTheoremsSource, PARSE-LIVE-PRODUCT-PATH-COMPOSE-PLAN-THEOREMS. -/
def liveProductPathComposePlanTheoremsSource : String := r#"/-
