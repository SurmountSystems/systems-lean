/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live ProbeWireTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveProbeWireTheoremsSource. Not occupancy name 50.
  Not mill 70.
  Source needles (do not rename; each unique needle in the parser includes
  its trailing newline): PROBE-WIRE-THEOREM, PROBE-WIRE-SMOKE,
  SystemsLean.ProbeWireTheorems.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-PROBEWIRETHEOREMS,
  liveProbeWireTheoremsSource, HOST-FRONT-LIVE-PROBEWIRETHEOREMS,
  PROBE-WIRE-THEOREM, PROBE-WIRE-SMOKE, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveProbeWireTheoremsSource
...
/-- Dual-pinned live ProbeWireTheorems.lean bytes (must match on-disk file).
    Greppable: liveProbeWireTheoremsSource, PARSE-LIVE-PROBEWIRETHEOREMS,
    PROBE-WIRE-THEOREM, PROBE-WIRE-SMOKE. -/
def liveProbeWireTheoremsSource : String := r#"/-
