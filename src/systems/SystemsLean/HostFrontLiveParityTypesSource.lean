/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live ParityTypes.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveParityTypesSource. Not occupancy name 50. Not mill 70.
  This wrap is ParityTypes.lean. It is not ParityTypesTheorems.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveParityTypesSource,
  HOST-FRONT-LIVE-PARITY-TYPES, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveParityTypesSource
...
/-- Dual-pinned live ParityTypes.lean bytes (must match on-disk file).
    Greppable: liveParityTypesSource, HOST-FRONT-LIVE-PARITY-TYPES. -/
def liveParityTypesSource : String := r#"/-
