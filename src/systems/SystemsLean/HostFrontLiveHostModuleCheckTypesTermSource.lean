/-
  ...
  HostModuleCheckTypesTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckTypesTermSource.
  ...
  liveHostModuleCheckTypesTermSource,
  HOST-FRONT-LIVE-HOSTMODULECHECKTYPESTERM, liveRel,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckTypesTermSource
...
/-- Dual-pinned live HostModuleCheckTypesTerm.lean bytes.
    One raw string. The product is 441 lines, so this file stays under 780.
    Greppable: liveHostModuleCheckTypesTermSource,
    HOST-FRONT-LIVE-HOSTMODULECHECKTYPESTERM. -/
def liveHostModuleCheckTypesTermSource : String := r#"/-
