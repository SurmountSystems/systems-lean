/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live OfficialPath.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveOfficialPathSource. Not occupancy name 50. Not mill 70.
  ...
  HostFrontLiveOfficialPathSource
  PARSE-LIVE-OFFICIAL-PATH
  HOST-FRONT-LIVE-OFFICIAL-PATH
  OFFICIAL-PATH
  Greppable: SYSTEMS_LEAN_HOST, liveOfficialPathSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveOfficialPathSource
...
/-- Dual-pinned live OfficialPath.lean bytes (must match on-disk file).
    Greppable: liveOfficialPathSource, PARSE-LIVE-OFFICIAL-PATH. -/
def liveOfficialPathSource : String := r#"/-
