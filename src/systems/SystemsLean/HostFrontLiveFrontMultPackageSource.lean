/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live FrontMultPackage.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveFrontMultPackageSource. Not occupancy name 50. Not mill 70.
  This wrap is FrontMultPackage.lean. It is not FrontMultPackageMain.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveFrontMultPackageSource,
  HOST-FRONT-LIVE-FRONT-MULT-PACKAGE, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveFrontMultPackageSource
...
/-- Dual-pinned live FrontMultPackage.lean bytes (must match on-disk file).
    Greppable: liveFrontMultPackageSource, HOST-FRONT-LIVE-FRONT-MULT-PACKAGE. -/
def liveFrontMultPackageSource : String := r#"/-
