/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live SelfHostTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveSelfHostTheoremsSource. Not occupancy name 50. Not mill 70.
  Unique needles (trailing newline so SelfHost wrap is not a prefix):
  HostFrontLiveSelfHostTheoremsSource
  PARSE-LIVE-SELF-HOST-THEOREMS
  HOST-FRONT-LIVE-SELF-HOST-THEOREMS
  Greppable: SYSTEMS_LEAN_HOST, liveSelfHostTheoremsSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveSelfHostTheoremsSource
...
/-- Dual-pinned live SelfHostTheorems.lean bytes (must match on-disk file).
    Greppable: liveSelfHostTheoremsSource, PARSE-LIVE-SELF-HOST-THEOREMS. -/
def liveSelfHostTheoremsSource : String := r#"/-
