/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live SelfHostCompleteTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveSelfHostCompleteTheoremsSource.
  ...
  liveSelfHostCompleteTheoremsSource,
  HOST-FRONT-LIVE-SELF-HOST-COMPLETE-THEOREMS, liveRel,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveSelfHostCompleteTheoremsSource
...
/-- Dual-pinned live SelfHostCompleteTheorems.lean bytes (must match on-disk file).
    Greppable: liveSelfHostCompleteTheoremsSource, COMPLETE-THEOREM. -/
def liveSelfHostCompleteTheoremsSource : String := r#"/-
...
def liveRel : String := "SelfHostCompleteTheorems.lean"
