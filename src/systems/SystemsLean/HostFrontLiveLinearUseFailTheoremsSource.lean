/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live LinearUseFailTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveLinearUseFailTheoremsSource. Not occupancy name 50. Not mill 70.
  Unique needles (trailing newline so LinearUseFail wrap is not a prefix):
  HostFrontLiveLinearUseFailTheoremsSource
  PARSE-LIVE-LINEAR-USE-FAIL-THEOREMS
  HOST-FRONT-LIVE-LINEAR-USE-FAIL-THEOREMS
  Greppable: SYSTEMS_LEAN_HOST, liveLinearUseFailTheoremsSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveLinearUseFailTheoremsSource
...
/-- Dual-pinned live LinearUseFailTheorems.lean bytes (must match on-disk file).
    Greppable: liveLinearUseFailTheoremsSource, PARSE-LIVE-LINEAR-USE-FAIL-THEOREMS. -/
def liveLinearUseFailTheoremsSource : String := r#"/-
