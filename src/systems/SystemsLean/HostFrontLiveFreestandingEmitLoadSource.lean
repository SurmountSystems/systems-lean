/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live FreestandingEmitLoad.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveFreestandingEmitLoadSource. Not occupancy name 50. Not mill 70.
  This wrap is FreestandingEmitLoad.lean. It is not FreestandingEmitLoadScaffold.lean.
  Unique needles end with a newline.
  Greppable: SYSTEMS_LEAN_HOST, liveFreestandingEmitLoadSource,
  HOST-FRONT-LIVE-FREESTANDING-EMIT-LOAD, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveFreestandingEmitLoadSource
...
/-- Dual-pinned live FreestandingEmitLoad.lean bytes (must match on-disk file).
    Greppable: liveFreestandingEmitLoadSource, HOST-FRONT-LIVE-FREESTANDING-EMIT-LOAD. -/
def liveFreestandingEmitLoadSource : String := r##"/-
