/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live StepContractFullTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveStepContractFullTheoremsSource.
  ...
  liveStepContractFullTheoremsSource,
  HOST-FRONT-LIVE-STEP-CONTRACT-FULL-THEOREMS, liveRel,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveStepContractFullTheoremsSource
...
/-- Dual-pinned live StepContractFullTheorems.lean bytes (must match on-disk file).
    Greppable: liveStepContractFullTheoremsSource, STEP-CONTRACT-FULL-THEOREM. -/
def liveStepContractFullTheoremsSource : String := r#"/-
