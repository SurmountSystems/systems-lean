/-
  ...
  HostModuleCheckProgramSubsetEmitTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckProgramSubsetEmitTermSource.
  ...
  HOST-FRONT-LIVE-HOSTMODULECHECKPROGRAMSUBSETEMITTERM, liveRel,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckProgramSubsetEmitTermSource
...
/-- Dual-pinned live HostModuleCheckProgramSubsetEmitTerm.lean bytes
    (must match the on-disk file).
    Greppable: liveHostModuleCheckProgramSubsetEmitTermSource,
    HOST-FRONT-LIVE-HOSTMODULECHECKPROGRAMSUBSETEMITTERM. -/
def liveHostModuleCheckProgramSubsetEmitTermSource : String := r#"/-
