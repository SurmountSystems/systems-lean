/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckCompilePathTypesTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckCompilePathTypesTermSource. Not occupancy name 50.
  Not mill remill. Mill stays 69 of 69.
  This wrap dual-pins HostModuleCheckCompilePathTypesTerm.lean only. One part.
  Do not steal a neighbor checker. Do not retarget HostFrontLiveHostModuleCheckCheckersLater.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-HOSTMODULECHECKCOMPILEPATHTYPESTERM,
  liveHostModuleCheckCompilePathTypesTermSource,
  HOST-FRONT-LIVE-HOSTMODULECHECKCOMPILEPATHTYPESTERM,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckCompilePathTypesTermSource
...
/-- Dual-pinned live HostModuleCheckCompilePathTypesTerm.lean bytes.
    One part. Not split. 217 lines plus this header stay under about 780.
    Greppable: liveHostModuleCheckCompilePathTypesTermSource,
    PARSE-LIVE-HOSTMODULECHECKCOMPILEPATHTYPESTERM. -/
def liveHostModuleCheckCompilePathTypesTermSource : String := r#"/-
