/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live LlvmMultSsa.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveLlvmMultSsaSource. Not occupancy name 50.
  Not mill 61 remill. Mill stays 69 of 69.
  This wrap parses LlvmMultSsa.lean (the library). Not the mill Main file
  LlvmMultSsaMain.lean. Not HostFrontLiveLlvmMultSsaMain.
  ...
  Unique needles are full lines of LlvmMultSsa.lean (trailing newline):
  ...
  LLVM-MULT-SSA
  Greppable: SYSTEMS_LEAN_HOST, liveLlvmMultSsaSource,
  PARSE-LIVE-LLVM-MULT-SSA, HOST-FRONT-LIVE-LLVM-MULT-SSA.
  Module: SystemsLean.HostFrontLiveLlvmMultSsaSource
...
/-- Dual-pinned live LlvmMultSsa.lean bytes (must match on-disk file).
    Greppable: liveLlvmMultSsaSource, PARSE-LIVE-LLVM-MULT-SSA. -/
def liveLlvmMultSsaSource : String := r#"/-
