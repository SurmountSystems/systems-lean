/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live MultSubsetEmit.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveMultSubsetEmitSource. Not occupancy name 50. Not mill 70.
  This wrap is MultSubsetEmit.lean. It is not MultSubsetEmitMain.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveMultSubsetEmitSource,
  HOST-FRONT-LIVE-MULT-SUBSET-EMIT, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveMultSubsetEmitSource
  Not FullHost. Not freestanding residual free. Not PROVABLY.
  Not a backend. The live def multSubsetEmitLlvmUnlocked stays false.
  Module must stay ASCII.
-/

namespace SystemsLean.HostFrontLiveMultSubsetEmit

/-- Dual-pinned live MultSubsetEmit.lean bytes (must match on-disk file).
    Greppable: liveMultSubsetEmitSource, HOST-FRONT-LIVE-MULT-SUBSET-EMIT. -/
def liveMultSubsetEmitSource : String := r##"/-
