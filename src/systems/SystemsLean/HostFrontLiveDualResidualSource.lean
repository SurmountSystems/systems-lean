/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live DualResidual.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveDualResidualSource. Not occupancy name 50. Not mill 70.
  Unique needles (trailing newline so DualResidualTheorems wrap is not a prefix):
  HostFrontLiveDualResidualSource
  PARSE-LIVE-DUAL-RESIDUAL
  HOST-FRONT-LIVE-DUAL-RESIDUAL
  Greppable: SYSTEMS_LEAN_HOST, liveDualResidualSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveDualResidualSource
...
/-- Dual-pinned live DualResidual.lean bytes (must match on-disk file).
    Greppable: liveDualResidualSource, PARSE-LIVE-DUAL-RESIDUAL. -/
def liveDualResidualSource : String := r#"/-
