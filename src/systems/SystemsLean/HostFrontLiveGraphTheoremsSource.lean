/-
  ...
  Short role: HostFrontLiveGraphTheoremsSource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-GRAPH-THEOREMS, liveGraphTheoremsSource,
  HOST-FRONT-LIVE-GRAPH-THEOREMS, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveGraphTheoremsSource
...
/-- Dual-pinned live HostGraphTheorems.lean bytes (must match on-disk file).
    Greppable: liveGraphTheoremsSource, PARSE-LIVE-GRAPH-THEOREMS. -/
def liveGraphTheoremsSource : String := r#"/-
