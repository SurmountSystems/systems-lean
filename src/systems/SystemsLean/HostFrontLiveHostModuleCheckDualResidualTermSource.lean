/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckDualResidualTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckDualResidualTermSource. Not occupancy name 50.
  Not mill remill. Mill stays 69 of 69.
  This wrap dual-pins HostModuleCheckDualResidualTerm.lean only. One part.
  Do not steal a neighbor checker.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-HOSTMODULECHECKDUALRESIDUALTERM,
  liveHostModuleCheckDualResidualTermSource,
  HOST-FRONT-LIVE-HOSTMODULECHECKDUALRESIDUALTERM,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckDualResidualTermSource
...
/-- Dual-pinned live HostModuleCheckDualResidualTerm.lean bytes.
    One part. Not split. 233 lines plus this header stay under about 780.
    Greppable: liveHostModuleCheckDualResidualTermSource,
    PARSE-LIVE-HOSTMODULECHECKDUALRESIDUALTERM. -/
def liveHostModuleCheckDualResidualTermSource : String := r#"/-
