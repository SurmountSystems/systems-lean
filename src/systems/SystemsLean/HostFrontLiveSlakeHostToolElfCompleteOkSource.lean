/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live SlakeHostToolElfCompleteOk.lean bytes.
  Module: SystemsLean.HostFrontLiveSlakeHostToolElfCompleteOkSource
  Greppable: SYSTEMS_LEAN_HOST, liveSlakeHostToolElfCompleteOkSource,
  ...
  The live file imports SystemsLean.CompleteOk.
  Module must stay ASCII.
-/

namespace SystemsLean.HostFrontLiveSlakeHostToolElfCompleteOk

/-- Dual-pinned live SlakeHostToolElfCompleteOk.lean bytes.
    Greppable: liveSlakeHostToolElfCompleteOkSource. -/
def liveSlakeHostToolElfCompleteOkSource : String := r#"/-
