/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live LinearSubsetRebuild.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveLinearSubsetRebuildSource.
  This wrap is LinearSubsetRebuild.lean.
  It is not LinearSubsetRebuildMain.lean.
  It is not Linear.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveLinearSubsetRebuildSource,
  HOST-FRONT-LIVE-LINEAR-SUBSET-REBUILD, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveLinearSubsetRebuildSource
...
/-- Dual-pinned live LinearSubsetRebuild.lean bytes (must match on-disk file).
    Greppable: liveLinearSubsetRebuildSource,
    HOST-FRONT-LIVE-LINEAR-SUBSET-REBUILD. -/
def liveLinearSubsetRebuildSource : String := r###"/-
