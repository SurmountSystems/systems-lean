/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live LlvmCfgMultDf.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveLlvmCfgMultDfSource. Not occupancy name 50. Not mill 70.
  ...
  Greppable: SYSTEMS_LEAN_HOST, liveLlvmCfgMultDfSource,
  HOST-FRONT-LIVE-LLVM-CFG-MULT-DF, LLVM-CFG-MULT-DF, liveRel,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveLlvmCfgMultDfSource
...
/-- Dual-pinned live LlvmCfgMultDf.lean bytes (must match on-disk file).
    Greppable: liveLlvmCfgMultDfSource, HOST-FRONT-LIVE-LLVM-CFG-MULT-DF. -/
def liveLlvmCfgMultDfSource : String := r#"/-
