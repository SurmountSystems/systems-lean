/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live OwnershipClaimedTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveOwnershipClaimedTheoremsSource. Not occupancy name 50. Not mill 70.
  ...
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-OWNERSHIP-CLAIMED-THEOREMS, liveOwnershipClaimedTheoremsSource,
  HOST-FRONT-LIVE-OWNERSHIP-CLAIMED-THEOREMS, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveOwnershipClaimedTheoremsSource
...
/-- Dual-pinned live OwnershipClaimedTheorems.lean bytes (must match on-disk file).
    Greppable: liveOwnershipClaimedTheoremsSource, PARSE-LIVE-OWNERSHIP-CLAIMED-THEOREMS. -/
def liveOwnershipClaimedTheoremsSource : String := r#"/-
