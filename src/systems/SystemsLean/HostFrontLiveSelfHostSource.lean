/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live SelfHost.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveSelfHostSource. Not occupancy name 50. Not mill 70.
  Unique needles (trailing newline so SelfHostTheorems wrap is not a prefix):
  HostFrontLiveSelfHostSource
  PARSE-LIVE-SELF-HOST
  HOST-FRONT-LIVE-SELF-HOST
  Greppable: SYSTEMS_LEAN_HOST, liveSelfHostSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveSelfHostSource
...
/-- Dual-pinned live SelfHost.lean bytes (must match on-disk file).
    Greppable: liveSelfHostSource, PARSE-LIVE-SELF-HOST. -/
def liveSelfHostSource : String := r#"/-
