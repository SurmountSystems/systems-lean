/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckErasureSubsetRebuildTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckErasureSubsetRebuildTermSource. Not occupancy name 50.
  Not mill remill. Mill stays 69 of 69.
  This wrap dual-pins HostModuleCheckErasureSubsetRebuildTerm.lean only. One part.
  Do not steal a neighbor checker. Do not retarget HostModuleCheckErasureSubsetRebuildTerm.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-HOSTMODULECHECKERASURESUBSETREBUILDTERM,
  liveHostModuleCheckErasureSubsetRebuildTermSource,
  HOST-FRONT-LIVE-HOSTMODULECHECKERASURESUBSETREBUILDTERM,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckErasureSubsetRebuildTermSource
...
/-- Dual-pinned live HostModuleCheckErasureSubsetRebuildTerm.lean bytes.
    One part. Not split. 308 lines plus this header stay under about 780.
    Greppable: liveHostModuleCheckErasureSubsetRebuildTermSource,
    PARSE-LIVE-HOSTMODULECHECKERASURESUBSETREBUILDTERM. -/
def liveHostModuleCheckErasureSubsetRebuildTermSource : String := r#"/-
