/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live KernelEmit.lean bytes.
...
/-- Dual-pinned live KernelEmit.lean bytes (must match on-disk file).
    Greppable: liveKernelEmitSource, PARSE-LIVE-KERNEL-EMIT. -/
def liveKernelEmitSource : String := r#"/-
