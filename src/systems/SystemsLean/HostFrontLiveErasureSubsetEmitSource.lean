/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live ErasureSubsetEmit.lean bytes.
  Module: SystemsLean.HostFrontLiveErasureSubsetEmitSource
  liveRel is ErasureSubsetEmit.lean. Not FullHost. Not ErasureSubsetEmitMain.
  Module must stay ASCII.
-/

namespace SystemsLean.HostFrontLiveErasureSubsetEmit

/-- Dual-pinned live ErasureSubsetEmit.lean bytes. -/
def liveErasureSubsetEmitSource : String := r##"/-
