/-
  ...
  Short role: HostFrontLiveCheckersLaterSource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-CHECKERS-LATER, liveCheckersLaterSource,
  HOST-FRONT-LIVE-CHECKERS-LATER, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveCheckersLaterSource
...
/-- Dual-pinned live HostModuleCheckCheckersLater.lean bytes (must match on-disk file).
    Greppable: liveCheckersLaterSource, PARSE-LIVE-CHECKERS-LATER. -/
def liveCheckersLaterSource : String := r#"/-
