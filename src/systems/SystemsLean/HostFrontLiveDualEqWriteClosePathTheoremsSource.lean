/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live DualEqWriteClosePathTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveDualEqWriteClosePathTheoremsSource.
  Not occupancy name 50. Not mill 70.
  This wrap is DualEqWriteClosePathTheorems.lean. It is not DualEqWriteClosePath.lean.
  Greppable: SYSTEMS_LEAN_HOST, CLOSE-PATH-THEOREM,
  liveDualEqWriteClosePathTheoremsSource,
  HOST-FRONT-LIVE-DUAL-EQ-WRITE-CLOSE-PATH-THEOREMS, liveRel,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveDualEqWriteClosePathTheoremsSource
...
/-- Dual-pinned live DualEqWriteClosePathTheorems.lean bytes (must match on-disk file).
    Greppable: liveDualEqWriteClosePathTheoremsSource, CLOSE-PATH-THEOREM. -/
def liveDualEqWriteClosePathTheoremsSource : String := r#"/-
