/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live EmitBody.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveEmitBodySource. Not occupancy name 50. Not mill 70.
  This wrap is EmitBody.lean. It is not EmitBodyScaffold.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveEmitBodySource,
  HOST-FRONT-LIVE-EMIT-BODY, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveEmitBodySource
  Not FullHost. Not freestanding residual free. Not PROVABLY.
  Not a backend. FullBackend stays false in the wrap.
  Occupancy stays 49. Not mill. Mill stays 69 of 69.
  Module must stay ASCII.
-/

namespace SystemsLean.HostFrontLiveEmitBody

/-- Dual-pinned live EmitBody.lean bytes (must match on-disk file).
    Greppable: liveEmitBodySource, HOST-FRONT-LIVE-EMIT-BODY. -/
def liveEmitBodySource : String := r#"/-
