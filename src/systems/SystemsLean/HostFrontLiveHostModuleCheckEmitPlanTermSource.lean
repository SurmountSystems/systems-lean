/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckEmitPlanTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckEmitPlanTermSource. Not occupancy name 50.
  Not mill remill. Mill stays 69 of 69.
  This wrap dual-pins HostModuleCheckEmitPlanTerm.lean only. One part.
  Do not steal a neighbor checker. Do not retarget HostModuleCheckEmitPlanTerm.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-HOSTMODULECHECKEMITPLANTERM,
  liveHostModuleCheckEmitPlanTermSource,
  HOST-FRONT-LIVE-HOSTMODULECHECKEMITPLANTERM,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckEmitPlanTermSource
...
/-- Dual-pinned live HostModuleCheckEmitPlanTerm.lean bytes.
    One part. Not split. 538 lines plus this header stay under about 780.
    Greppable: liveHostModuleCheckEmitPlanTermSource,
    PARSE-LIVE-HOSTMODULECHECKEMITPLANTERM. -/
def liveHostModuleCheckEmitPlanTermSource : String := r#"/-
