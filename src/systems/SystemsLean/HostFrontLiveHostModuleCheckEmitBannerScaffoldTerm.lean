/-
  ...
  Short role: HostFrontLiveHostModuleCheckEmitBannerScaffoldTerm.
  ...
  Spec (readable):
  - parseLiveHostModuleCheckEmitBannerScaffoldTermSource turns live
    HostModuleCheckEmitBannerScaffoldTerm.lean text into HostTerm.Module.
  - Module name is SystemsLean.HostModuleCheckEmitBannerScaffoldTerm
    even without a module line.
  - liveRel is the exact basename HostModuleCheckEmitBannerScaffoldTerm.lean.
    Disk reads use src/systems/SystemsLean/ plus that basename.
  - kernelCheckLiveHostModuleCheckEmitBannerScaffoldTermSource is
    HostKernel.kernelCheck of that parse. The reject arm returns false.
  - The embedded bytes are one part,
    liveHostModuleCheckEmitBannerScaffoldTermSource. Not split.
  ...
  - Kept: two imports, the namespace, five literal defs, and end.
    Kept count is 9.
    The five literal defs are checkDepthEmitBannerScaffoldTermSurfaceBar,
    checkDepthEmitBannerScaffoldTermSurfaceScope,
    hostModuleCheckEmitBannerScaffoldTermSurfaceDualOk,
    hostModuleCheckEmitBannerScaffoldTermSkeletonPrefix, and
  ...
  HostFrontLiveHostModuleCheckEmitBannerScaffoldTerm
  PARSE-LIVE-HOSTMODULECHECKEMITBANNERSCAFFOLDTERM
  HOST-FRONT-LIVE-HOSTMODULECHECKEMITBANNERSCAFFOLDTERM
  SLAKE_HOST_FRONT_LIVE_HOSTMODULECHECKEMITBANNERSCAFFOLDTERM_V0

  Greppable: SYSTEMS_LEAN_HOST,
  parseLiveHostModuleCheckEmitBannerScaffoldTermSource,
  kernelCheckLiveHostModuleCheckEmitBannerScaffoldTermSource,
  hostFrontLiveHostModuleCheckEmitBannerScaffoldTermReady,
  liveHostModuleCheckEmitBannerScaffoldTermSource,
  liveRel, liveHostModuleCheckEmitBannerScaffoldTermRel, stripCommentsHc,
  UNIT_SURFACE host surface, MULT-0.
  Module: SystemsLean.HostFrontLiveHostModuleCheckEmitBannerScaffoldTerm
  Not package typecheck GREEN. Not FullHost. Not Lake-gone.
  Module must stay ASCII.
-/

import SystemsLean.HostFrontLiveHostTerm
import SystemsLean.HostFrontLiveHostModuleCheckEmitBannerScaffoldTermSource
import SystemsLean.HostKernel

set_option maxRecDepth 32768
set_option maxHeartbeats 100000000

namespace SystemsLean.HostFrontLiveHostModuleCheckEmitBannerScaffoldTerm
...
def hostId : String := "HOST-FRONT-LIVE-HOSTMODULECHECKEMITBANNERSCAFFOLDTERM"

/-- Greppable parse id. -/
def parseId : String := "PARSE-LIVE-HOSTMODULECHECKEMITBANNERSCAFFOLDTERM"

/-- Live file basename. -/
def liveRel : String := "HostModuleCheckEmitBannerScaffoldTerm.lean"

/-- Live file relative to repo root. Dual-pin path.
    liveHostModuleCheckEmitBannerScaffoldTermSource is the one embedded copy
    from HostFrontLiveHostModuleCheckEmitBannerScaffoldTermSource. Not split. -/
...
def hostFrontLiveHostModuleCheckEmitBannerScaffoldTermFullHost : Bool := false

/-- Honesty: not product residual free. -/
def hostFrontLiveHostModuleCheckEmitBannerScaffoldTermResidualFreeClaimed : Bool :=
  false

/-- Honesty: not PROVABLY. -/
def hostFrontLiveHostModuleCheckEmitBannerScaffoldTermProvablyUnlocked : Bool :=
  false
...
/-- String-safe comment fold from HostFrontLiveHostCheck.stripCommentsHc.
    ...
    HostModuleCheckEmitBannerScaffoldTerm has dash-dash in the header block comment. -/
...
/-- String-safe comment strip for live HostModuleCheckEmitBannerScaffoldTerm.lean
...
/-- Parse live HostModuleCheckEmitBannerScaffoldTerm.lean text.
    Greppable: parseLiveHostModuleCheckEmitBannerScaffoldTermSource,
    PARSE-LIVE-HOSTMODULECHECKEMITBANNERSCAFFOLDTERM. -/
def parseLiveHostModuleCheckEmitBannerScaffoldTermSource (src : String) : FrontResult :=
  ...
  if toks.isEmpty then FrontResult.reject reasonEmptyModule
    ...
    | some cmds =>
      if cmds.isEmpty then FrontResult.reject reasonEmptyModule
        ...
        let m : Module :=
          { name := HostTerm.n "SystemsLean.HostModuleCheckEmitBannerScaffoldTerm"
            commands := cmds }
...
/-- Kernel-check the live parse. Not a fixture. Not a constant true.
    ...
    Greppable: kernelCheckLiveHostModuleCheckEmitBannerScaffoldTermSource,
    PARSE-LIVE-HOSTMODULECHECKEMITBANNERSCAFFOLDTERM. -/
def kernelCheckLiveHostModuleCheckEmitBannerScaffoldTermSource (src : String) : Bool :=
  match parseLiveHostModuleCheckEmitBannerScaffoldTermSource src with
  | FrontResult.accept m => HostKernel.kernelCheck m
  | FrontResult.reject _ => false

/-- Accepted live module when parse succeeds. -/
def liveParsed? : Option Module :=
  match parseLiveHostModuleCheckEmitBannerScaffoldTermSource
      liveHostModuleCheckEmitBannerScaffoldTermSource with
...
def liveParseDefsOk : Bool :=
  ...
  | some m =>
    cmdDefNames m.commands == [
      "checkDepthEmitBannerScaffoldTermSurfaceBar",
      "checkDepthEmitBannerScaffoldTermSurfaceScope",
      "hostModuleCheckEmitBannerScaffoldTermSurfaceDualOk",
...
def liveCmdKwCount : Nat :=
  countCmdKw liveSkipFuel
    (tokenizeLive (stripCommentsHc liveHostModuleCheckEmitBannerScaffoldTermSource)) 0
...
/-- Wrap module lastSeg is HostModuleCheckEmitBannerScaffoldTerm
    (no module line in the live file). -/
def liveParseHasModule : Bool :=
  match liveParsed? with
  | none => false
  | some m =>
    m.name.raw == "SystemsLean.HostModuleCheckEmitBannerScaffoldTerm"
      && lastSeg m.name.raw == "HostModuleCheckEmitBannerScaffoldTerm"
...
def liveParseHasCoreDefs : Bool :=
  ...
  | some _ =>
    let toks := tokenizeLive
      (stripCommentsHc liveHostModuleCheckEmitBannerScaffoldTermSource)
    toksHaveDefNamed liveSkipFuel toks "checkDepthEmitBannerScaffoldTermSurfaceBar"
      && toksHaveDefNamed liveSkipFuel toks "checkDepthEmitBannerScaffoldTermSurfaceScope"
      && toksHaveDefNamed liveSkipFuel toks "hostModuleCheckEmitBannerScaffoldTermSurfaceDualOk"
      && toksHaveDefNamed liveSkipFuel toks "emitBannerScaffoldStageIdBodyOk"
      && toksHaveDefNamed liveSkipFuel toks "emitBannerScaffoldHostIdBodyOk"
      && toksHaveDefNamed liveSkipFuel toks "emitBannerScaffoldSelfHostIdBodyOk"
      && toksHaveDefNamed liveSkipFuel toks "emitBannerScaffoldReadyBodyOk"
      && toksHaveDefNamed liveSkipFuel toks "emitBannerScaffoldOkBodyOk"
      && toksHaveDefNamed liveSkipFuel toks "checkEmitBannerScaffoldTermDialect"
      && toksHaveDefNamed liveSkipFuel toks "refineEmitBannerScaffoldWithTermSurface"
      && toksHaveDefNamed liveSkipFuel toks "hostModuleCheckEmitBannerScaffoldTermSkeletonPrefix"
      && toksHaveDefNamed liveSkipFuel toks "hostModuleCheckEmitBannerScaffoldTermSkeletonSuffix"
      && toksHaveDefNamed liveSkipFuel toks "hostModuleCheckEmitBannerScaffoldTermGoodMid"
      && toksHaveDefNamed liveSkipFuel toks "hostModuleCheckGoodEmitBannerScaffoldTermText"
      && toksHaveDefNamed liveSkipFuel toks "hostModuleCheckBadEmitBannerScaffoldStageIdText"
      && toksHaveDefNamed liveSkipFuel toks "hostModuleCheckBadEmitBannerScaffoldReadyText"
      && toksHaveDefNamed liveSkipFuel toks "hostModuleCheckBadEmitBannerScaffoldOkText"
      && toksHaveDefNamed liveSkipFuel toks "hostModuleCheckBadEmitBannerScaffoldContractText"
      && toksHaveDefNamed liveSkipFuel toks "emitBannerScaffoldTermSurfaceFrom"
      && toksHaveDefNamed liveSkipFuel toks "hostModuleCheckBadEmitBannerScaffoldStageIdL0Accept"
      && toksHaveDefNamed liveSkipFuel toks "hostModuleCheckBadEmitBannerScaffoldReadyL0Accept"
      && toksHaveDefNamed liveSkipFuel toks "hostModuleCheckBadEmitBannerScaffoldOkL0Accept"
      && toksHaveDefNamed liveSkipFuel toks "hostModuleCheckBadEmitBannerScaffoldContractL0Accept"
      && toksHaveDefNamed liveSkipFuel toks "hostModuleCheckEmitBannerScaffoldTermDialectOk"
      && toksHaveDefNamed liveSkipFuel toks "hostModuleCheckBadEmitBannerScaffoldStageIdDialectReject"
      && toksHaveDefNamed liveSkipFuel toks "hostModuleCheckBadEmitBannerScaffoldReadyDialectReject"
      && toksHaveDefNamed liveSkipFuel toks "hostModuleCheckBadEmitBannerScaffoldOkDialectReject"
      && toksHaveDefNamed liveSkipFuel toks "hostModuleCheckBadEmitBannerScaffoldContractDialectReject"
      && toksHaveDefNamed liveSkipFuel toks "hostModuleCheckEmitBannerScaffoldTermSurfaceOk"
      && toksHaveTheoremNamed liveSkipFuel toks
        "hostModuleCheckEmitBannerScaffoldTermSurfaceOk_true"
      && toksHaveTheoremNamed liveSkipFuel toks
        "hostModuleCheck_emit_banner_scaffold_term_surface_ids_eq"
...
def liveNeedlesOk : Bool :=
  let src := liveHostModuleCheckEmitBannerScaffoldTermSource
...
/-- End-to-end ready: live text parse kernel-checks.
    Greppable: hostFrontLiveHostModuleCheckEmitBannerScaffoldTermReady,
    PARSE-LIVE-HOSTMODULECHECKEMITBANNERSCAFFOLDTERM,
    HOST-FRONT-LIVE-HOSTMODULECHECKEMITBANNERSCAFFOLDTERM.
    Real conjunction: parse plus kernelCheck plus this file's commands.
    Not a hardcoded true. -/
def hostFrontLiveHostModuleCheckEmitBannerScaffoldTermReady : Bool :=
  (stageId == "SLAKE_HOST_FRONT_LIVE_HOSTMODULECHECKEMITBANNERSCAFFOLDTERM_V0")
    && (hostId == "HOST-FRONT-LIVE-HOSTMODULECHECKEMITBANNERSCAFFOLDTERM")
    && (parseId == "PARSE-LIVE-HOSTMODULECHECKEMITBANNERSCAFFOLDTERM")
    && (liveRel == "HostModuleCheckEmitBannerScaffoldTerm.lean")
    && (liveHostModuleCheckEmitBannerScaffoldTermRel ==
        "src/systems/SystemsLean/HostModuleCheckEmitBannerScaffoldTerm.lean")
    && liveParseDoesNotUseMultFixture
    && !hostFrontLiveHostModuleCheckEmitBannerScaffoldTermFullHost
    && !hostFrontLiveHostModuleCheckEmitBannerScaffoldTermResidualFreeClaimed
    && !hostFrontLiveHostModuleCheckEmitBannerScaffoldTermProvablyUnlocked
    && kernelCheckLiveHostModuleCheckEmitBannerScaffoldTermSource
        liveHostModuleCheckEmitBannerScaffoldTermSource
...
def liveParseRejectsEmpty : Bool :=
  match parseLiveHostModuleCheckEmitBannerScaffoldTermSource "" with
...
def runLive (root : System.FilePath) : IO Unit := do
  IO.println s!"== {stageId}: PARSE-LIVE-HOSTMODULECHECKEMITBANNERSCAFFOLDTERM =="
  IO.println s!"  host={hostId} file={liveHostModuleCheckEmitBannerScaffoldTermRel}"
  IO.println s!"liveRel={liveRel}"
  let path := root / liveHostModuleCheckEmitBannerScaffoldTermRel
  unless (<- path.pathExists) do
    IO.eprintln s!"error: missing {liveHostModuleCheckEmitBannerScaffoldTermRel}"
    throw (IO.userError s!"missing {liveHostModuleCheckEmitBannerScaffoldTermRel}")
  let disk <- IO.FS.readFile path
  if disk != liveHostModuleCheckEmitBannerScaffoldTermSource then
    IO.eprintln "error: dual-pin mismatch: on-disk HostModuleCheckEmitBannerScaffoldTerm.lean != liveHostModuleCheckEmitBannerScaffoldTermSource"
    throw (IO.userError "dual-pin mismatch live HostModuleCheckEmitBannerScaffoldTerm.lean")
  let r := parseLiveHostModuleCheckEmitBannerScaffoldTermSource disk
  match r with
  | FrontResult.reject reason =>
    IO.eprintln s!"error: PARSE-LIVE-HOSTMODULECHECKEMITBANNERSCAFFOLDTERM reject {reason}"
    throw (IO.userError
      s!"PARSE-LIVE-HOSTMODULECHECKEMITBANNERSCAFFOLDTERM reject {reason}")
  | FrontResult.accept m =>
    let k := HostKernel.kernelCheck m
    IO.println s!"PASS PARSE-LIVE-HOSTMODULECHECKEMITBANNERSCAFFOLDTERM ACCEPT liveRel={liveRel} cmds={m.commands.length} kernelCheck={k} real={liveCmdKwCount} kept={liveKeptCmds} skipped={liveSkippedCmds}"
    ...
    unless k do
      IO.eprintln "error: kernelCheck live HostModuleCheckEmitBannerScaffoldTerm parse false"
      throw (IO.userError
        "kernelCheck live HostModuleCheckEmitBannerScaffoldTerm parse false")
    unless hostFrontLiveHostModuleCheckEmitBannerScaffoldTermReady do
      IO.eprintln "error: hostFrontLiveHostModuleCheckEmitBannerScaffoldTermReady false"
      throw (IO.userError
        "hostFrontLiveHostModuleCheckEmitBannerScaffoldTermReady false")
    unless liveParseRejectsEmpty do
      IO.eprintln "error: empty HostModuleCheckEmitBannerScaffoldTerm source was accepted"
      throw (IO.userError
        "empty HostModuleCheckEmitBannerScaffoldTerm source was accepted")
    IO.println s!"GREEN {stageId}: live HostModuleCheckEmitBannerScaffoldTerm.lean parse kernelCheck; not mill remill; mill stays 69 of 69"
...
end SystemsLean.HostFrontLiveHostModuleCheckEmitBannerScaffoldTerm
