/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live ParityLinearTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveParityLinearTheoremsSource. Not occupancy name 50. Not mill 70.
  This wrap is ParityLinearTheorems.lean. It is not ParityLinear.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveParityLinearTheoremsSource,
  HOST-FRONT-LIVE-PARITY-LINEAR-THEOREMS, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveParityLinearTheoremsSource
...
/-- Dual-pinned live ParityLinearTheorems.lean bytes (must match on-disk file).
    Greppable: liveParityLinearTheoremsSource, HOST-FRONT-LIVE-PARITY-LINEAR-THEOREMS. -/
def liveParityLinearTheoremsSource : String := r#"/-
