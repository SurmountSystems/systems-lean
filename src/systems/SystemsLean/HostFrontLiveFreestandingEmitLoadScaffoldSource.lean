/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live FreestandingEmitLoadScaffold.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveFreestandingEmitLoadScaffoldSource.
  Not occupancy name 50. Not mill 70.
  This wrap is FreestandingEmitLoadScaffold.lean.
  It is not FreestandingEmitLoad.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveFreestandingEmitLoadScaffoldSource,
  HOST-FRONT-LIVE-FREESTANDING-EMIT-LOAD-SCAFFOLD, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveFreestandingEmitLoadScaffoldSource
...
/-- Dual-pinned live FreestandingEmitLoadScaffold.lean bytes (must match on-disk file).
    Greppable: liveFreestandingEmitLoadScaffoldSource,
    HOST-FRONT-LIVE-FREESTANDING-EMIT-LOAD-SCAFFOLD. -/
def liveFreestandingEmitLoadScaffoldSource : String := r#"/-
