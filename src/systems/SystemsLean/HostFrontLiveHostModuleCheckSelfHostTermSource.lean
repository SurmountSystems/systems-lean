/-
  ...
  HostModuleCheckSelfHostTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckSelfHostTermSource.
  ...
  liveHostModuleCheckSelfHostTermSource,
  HOST-FRONT-LIVE-HOSTMODULECHECKSELFHOSTTERM, liveRel,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckSelfHostTermSource
...
/-- Dual-pinned live HostModuleCheckSelfHostTerm.lean bytes.
    One raw string. The product is 236 lines, so this file stays under 780.
    Greppable: liveHostModuleCheckSelfHostTermSource,
    HOST-FRONT-LIVE-HOSTMODULECHECKSELFHOSTTERM. -/
def liveHostModuleCheckSelfHostTermSource : String := r#"/-
