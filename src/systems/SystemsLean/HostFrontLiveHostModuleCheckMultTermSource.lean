/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckMultTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckMultTermSource.
  Not occupancy name 50. Not mill 70.
  This wrap is HostModuleCheckMultTerm.lean.
  It is not HostModuleCheck and not HostFront.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveHostModuleCheckMultTermSource,
  HOST-FRONT-LIVE-HOSTMODULECHECKMULTTERM, liveRel,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckMultTermSource
...
/-- Dual-pinned live HostModuleCheckMultTerm.lean bytes
    (must match the on-disk file).
    Greppable: liveHostModuleCheckMultTermSource,
    HOST-FRONT-LIVE-HOSTMODULECHECKMULTTERM. -/
def liveHostModuleCheckMultTermSource : String := r#"/-
