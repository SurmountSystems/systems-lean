/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live CompilePathMult.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveCompilePathMultSource. Not occupancy name 50.
  Not mill 70. This wrap is CompilePathMult.lean. It is not CompilePath.lean.
  The live namespace is SystemsLean.CompilePath.
  Greppable: SYSTEMS_LEAN_HOST, liveCompilePathMultSource,
  HOST-FRONT-LIVE-COMPILE-PATH-MULT, COMPILE-PATH-MULT, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveCompilePathMultSource
...
/-- Dual-pinned live CompilePathMult.lean bytes (must match on-disk file).
    Greppable: liveCompilePathMultSource, HOST-FRONT-LIVE-COMPILE-PATH-MULT. -/
def liveCompilePathMultSource : String := r#"/-
