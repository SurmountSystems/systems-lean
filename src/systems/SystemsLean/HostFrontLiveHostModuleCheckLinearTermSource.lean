/-
  SYSTEMS_LEAN_HOST partial -- live HostModuleCheckLinearTerm.lean.
  ...
  liveRel is HostModuleCheckLinearTerm.lean. Not a path.
  Greppable: liveRel, kernelCheckLiveHostModuleCheckLinearTermSource,
  PARSE-LIVE-HOST-MODULE-CHECK-LINEAR-TERM.
  Module: SystemsLean.HostFrontLiveHostModuleCheckLinearTermSource
...
namespace SystemsLean.HostFrontLiveHostModuleCheckLinearTermSource
...
def liveRel : String := "HostModuleCheckLinearTerm.lean"

/-- Pinned live HostModuleCheckLinearTerm.lean bytes. -/
def liveHostModuleCheckLinearTermSource : String := r#"/-
...
def kernelCheckLiveHostModuleCheckLinearTermSource (src : String) : Bool :=
  match parseLiveLlvmComposeTextMainSource src with
  | FrontResult.accept m => HostKernel.kernelCheck m
  | FrontResult.reject _ => false

/-- Ready is parse plus kernelCheck of the pinned text. -/
def hostFrontLiveHostModuleCheckLinearTermSourceReady : Bool :=
  liveRel == "HostModuleCheckLinearTerm.lean"
    && kernelCheckLiveHostModuleCheckLinearTermSource liveHostModuleCheckLinearTermSource
...
def runLive (root : System.FilePath) : IO Unit := do
  ...
  if disk != liveHostModuleCheckLinearTermSource then
    throw (IO.userError "dual-pin mismatch HostModuleCheckLinearTerm.lean")
  let k := kernelCheckLiveHostModuleCheckLinearTermSource disk
  IO.println s!"kernelCheck={k}"
  unless k do
    throw (IO.userError "kernelCheck live HostModuleCheckLinearTerm parse false")
  unless hostFrontLiveHostModuleCheckLinearTermSourceReady do
...
end SystemsLean.HostFrontLiveHostModuleCheckLinearTermSource
