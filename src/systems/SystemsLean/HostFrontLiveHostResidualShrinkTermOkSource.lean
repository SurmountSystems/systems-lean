/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostResidualShrinkTermOk.lean bytes.
  Side: classic Lean elaborator under src/systems (not freestanding C).
  Short role: HostFrontLiveHostResidualShrinkTermOkSource. Not occupancy name 50. Not mill 70.
  ...
  HostFrontLiveHostResidualShrinkTermOkSource
  HostFrontLiveHostResidualShrinkTermOk
  PARSE-LIVE-HOST-RESIDUAL-SHRINK-TERM-OK
  HOST-FRONT-LIVE-HOST-RESIDUAL-SHRINK-TERM-OK
  Greppable: SYSTEMS_LEAN_HOST, liveHostResidualShrinkTermOkSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostResidualShrinkTermOkSource
...
/-- Dual-pinned live HostResidualShrinkTermOk.lean bytes (must match on-disk file).
    Greppable: liveHostResidualShrinkTermOkSource, PARSE-LIVE-HOST-RESIDUAL-SHRINK-TERM-OK. -/
def liveHostResidualShrinkTermOkSource : String := r#"/-
