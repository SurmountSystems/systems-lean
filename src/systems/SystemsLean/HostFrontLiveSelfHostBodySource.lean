/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live SelfHostBody.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveSelfHostBodySource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-SELFHOSTBODY,
  liveSelfHostBodySource, HOST-FRONT-LIVE-SELFHOSTBODY,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveSelfHostBodySource
...
/-- Dual-pinned live SelfHostBody.lean bytes (must match on-disk file).
    Greppable: liveSelfHostBodySource, PARSE-LIVE-SELFHOSTBODY. -/
def liveSelfHostBodySource : String := r#"/-
