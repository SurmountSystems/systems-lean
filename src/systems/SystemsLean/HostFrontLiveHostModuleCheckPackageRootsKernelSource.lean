/-
  ...
  HostModuleCheckPackageRootsKernel.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckPackageRootsKernelSource.
  ...
  HOST-FRONT-LIVE-HOSTMODULECHECKPACKAGEROOTSKERNEL, liveRel,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckPackageRootsKernelSource
...
/-- Dual-pinned live HostModuleCheckPackageRootsKernel.lean bytes
    (must match the on-disk file).
    Greppable: liveHostModuleCheckPackageRootsKernelSource,
    HOST-FRONT-LIVE-HOSTMODULECHECKPACKAGEROOTSKERNEL. -/
def liveHostModuleCheckPackageRootsKernelSource : String := r#"/-
