/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live JoinMap.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveJoinMapSource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-JOINMAP, liveJoinMapSource,
  HOST-FRONT-LIVE-JOINMAP, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveJoinMapSource
...
/-- Dual-pinned live JoinMap.lean bytes (must match on-disk file).
    Greppable: liveJoinMapSource, PARSE-LIVE-JOINMAP. -/
def liveJoinMapSource : String := r#"/-
