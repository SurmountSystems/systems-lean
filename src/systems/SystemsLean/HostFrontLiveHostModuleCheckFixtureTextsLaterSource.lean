/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckFixtureTextsLater.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckFixtureTextsLaterSource. Not occupancy name 50.
  Not mill remill. Mill stays 69 of 69.
  This wrap dual-pins HostModuleCheckFixtureTextsLater.lean only. One part.
  Do not steal a neighbor checker. Do not retarget HostModuleCheckFixtureTextsLater.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-HOSTMODULECHECKFIXTURETEXTSLATER,
  liveHostModuleCheckFixtureTextsLaterSource,
  HOST-FRONT-LIVE-HOSTMODULECHECKFIXTURETEXTSLATER,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckFixtureTextsLaterSource
...
/-- Dual-pinned live HostModuleCheckFixtureTextsLater.lean bytes.
    One part. Not split. 451 lines plus this header stay under about 780.
    Greppable: liveHostModuleCheckFixtureTextsLaterSource,
    PARSE-LIVE-HOSTMODULECHECKFIXTURETEXTSLATER. -/
def liveHostModuleCheckFixtureTextsLaterSource : String := r#"/-
