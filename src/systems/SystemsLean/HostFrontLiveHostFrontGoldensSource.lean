/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostFrontGoldens.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostFrontGoldensSource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-HOST-FRONT-GOLDENS, liveHostFrontGoldensSource,
  HOST-FRONT-LIVE-HOST-FRONT-GOLDENS, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostFrontGoldensSource
...
/-- Dual-pinned live HostFrontGoldens.lean bytes (must match on-disk file).
    Greppable: liveHostFrontGoldensSource, PARSE-LIVE-HOST-FRONT-GOLDENS. -/
def liveHostFrontGoldensSource : String := r##"/-
