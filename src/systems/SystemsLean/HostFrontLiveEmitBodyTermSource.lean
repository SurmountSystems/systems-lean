/-
  ...
  Short role: HostFrontLiveEmitBodyTermSource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-EMITBODYTERM, liveEmitBodyTermSource,
  HOST-FRONT-LIVE-EMITBODYTERM, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveEmitBodyTermSource
...
/-- Dual-pinned live HostModuleCheckEmitBodyTerm.lean bytes (must match on-disk file).
    Greppable: liveEmitBodyTermSource, PARSE-LIVE-EMITBODYTERM. -/
def liveEmitBodyTermSource : String := r#"/-
