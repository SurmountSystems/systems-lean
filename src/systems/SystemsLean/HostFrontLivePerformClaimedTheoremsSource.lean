/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live PerformClaimedTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLivePerformClaimedTheoremsSource. Not occupancy name 50. Not mill 70.
  ...
  HostFrontLivePerformClaimedTheoremsSource
  ...
  Greppable: SYSTEMS_LEAN_HOST, livePerformClaimedTheoremsSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLivePerformClaimedTheoremsSource
...
/-- Dual-pinned live PerformClaimedTheorems.lean bytes (must match on-disk file).
    Greppable: livePerformClaimedTheoremsSource, PARSE-LIVE-PERFORM-CLAIMED-THEOREMS. -/
def livePerformClaimedTheoremsSource : String := r#"/-
