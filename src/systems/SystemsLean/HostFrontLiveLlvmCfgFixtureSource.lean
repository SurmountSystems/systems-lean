/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live LlvmCfgFixture.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveLlvmCfgFixtureSource. Not occupancy name 50.
  Not mill 70. This wrap is LlvmCfgFixture.lean. It is not LlvmCfgHonesty.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveLlvmCfgFixtureSource,
  HOST-FRONT-LIVE-LLVM-CFG-FIXTURE, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveLlvmCfgFixtureSource
...
/-- Dual-pinned live LlvmCfgFixture.lean bytes (must match on-disk file).
    Greppable: liveLlvmCfgFixtureSource, HOST-FRONT-LIVE-LLVM-CFG-FIXTURE. -/
def liveLlvmCfgFixtureSource : String := r#"/-
