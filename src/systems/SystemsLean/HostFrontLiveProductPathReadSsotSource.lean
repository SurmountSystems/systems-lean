/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live ProductPathReadSsot.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveProductPathReadSsotSource. Not occupancy name 50. Not mill 70.
  This wrap is ProductPathReadSsot.lean. It is not ProductPathReadSsotTheorems.lean.
  It is not ProductPathReadSsotMain.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveProductPathReadSsotSource,
  HOST-FRONT-LIVE-PRODUCT-PATH-READ-SSOT, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveProductPathReadSsotSource
...
/-- Dual-pinned live ProductPathReadSsot.lean bytes (must match on-disk file).
    Greppable: liveProductPathReadSsotSource, HOST-FRONT-LIVE-PRODUCT-PATH-READ-SSOT. -/
def liveProductPathReadSsotSource : String := r#"/-
