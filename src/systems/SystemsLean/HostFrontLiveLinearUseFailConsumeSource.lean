/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live LinearUseFail/Consume.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveLinearUseFailConsumeSource. Not occupancy name 50. Not mill 70.
  Unique needles (trailing newline so LinearUseFail wrap is not a prefix):
  HostFrontLiveLinearUseFailConsumeSource
  PARSE-LIVE-LINEAR-USE-FAIL-CONSUME
  HOST-FRONT-LIVE-LINEAR-USE-FAIL-CONSUME
  Greppable: SYSTEMS_LEAN_HOST, liveLinearUseFailConsumeSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveLinearUseFailConsumeSource
...
/-- Dual-pinned live LinearUseFail/Consume.lean bytes (must match on-disk file).
    Greppable: liveLinearUseFailConsumeSource, PARSE-LIVE-LINEAR-USE-FAIL-CONSUME. -/
def liveLinearUseFailConsumeSource : String := r#"/-
