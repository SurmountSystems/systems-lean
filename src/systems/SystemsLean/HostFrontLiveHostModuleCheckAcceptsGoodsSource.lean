/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckAcceptsGoods.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckAcceptsGoodsSource. Not occupancy name 50.
  ...
  HostModuleCheckAccepts.lean only.
  Do not wrap HostModuleCheckAcceptsGoodsTerm or any later file.
  Do not edit the product HostModuleCheckAcceptsGoods.lean.
  Unique needles (trailing newline so HostFrontLiveHostModuleCheckAcceptsGoods
  is not a prefix of a longer checker name):
  HostFrontLiveHostModuleCheckAcceptsGoodsSource
  ...
  Greppable: SYSTEMS_LEAN_HOST, liveHostModuleCheckAcceptsGoodsSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckAcceptsGoodsSource
...
/-- Dual-pinned live HostModuleCheckAcceptsGoods.lean bytes (must match on-disk file).
    Greppable: liveHostModuleCheckAcceptsGoodsSource, PARSE-LIVE-HOST-MODULE-CHECK-ACCEPTS-GOODS. -/
def liveHostModuleCheckAcceptsGoodsSource : String := r#"/-
