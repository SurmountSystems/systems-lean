/-
  SYSTEMS_LEAN_HOST partial. Dual-check of RuntimeBenchStackTwin.lean bytes.
  liveRuntimeBenchStackTwinSource is the exact bytes of
  src/systems/SystemsLean/RuntimeBenchStackTwin.lean.
  Module: SystemsLean.HostFrontLiveRuntimeBenchStackTwinSource
  ...
  Greppable: SYSTEMS_LEAN_HOST, liveRuntimeBenchStackTwinSource.
  Module must stay ASCII.
-/

namespace SystemsLean.HostFrontLiveRuntimeBenchStackTwin

def liveRuntimeBenchStackTwinSource : String := r##"/-
