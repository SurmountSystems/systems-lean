/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live MultSubsetRebuild.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveMultSubsetRebuildSource. Not occupancy name 50. Not mill 70.
  This wrap is MultSubsetRebuild.lean. It is not MultSubsetRebuildMain.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveMultSubsetRebuildSource,
  HOST-FRONT-LIVE-MULT-SUBSET-REBUILD, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveMultSubsetRebuildSource
  Not FullHost. Not freestanding residual free. Not PROVABLY.
  Not a backend. The live def multSubsetRebuildLlvmUnlocked stays false.
  Module must stay ASCII.
-/

namespace SystemsLean.HostFrontLiveMultSubsetRebuild

/-- Dual-pinned live MultSubsetRebuild.lean bytes (must match on-disk file).
    Greppable: liveMultSubsetRebuildSource, HOST-FRONT-LIVE-MULT-SUBSET-REBUILD. -/
def liveMultSubsetRebuildSource : String := r#"/-
