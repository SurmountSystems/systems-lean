/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live JoinMapTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveJoinMapTheoremsSource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-JOIN-MAP-THEOREMS, liveJoinMapTheoremsSource,
  HOST-FRONT-LIVE-JOIN-MAP-THEOREMS, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveJoinMapTheoremsSource
...
/-- Dual-pinned live JoinMapTheorems.lean bytes (must match on-disk file).
    Greppable: liveJoinMapTheoremsSource, PARSE-LIVE-JOIN-MAP-THEOREMS. -/
def liveJoinMapTheoremsSource : String := r#"/-
