/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckFrontMultPackageTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckFrontMultPackageTermSource. Not occupancy name 50.
  Not mill remill. Mill stays 69 of 69.
  This wrap dual-pins HostModuleCheckFrontMultPackageTerm.lean only. One part.
  Do not steal a neighbor checker. Do not retarget HostModuleCheckFrontMultPackageTerm.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-HOSTMODULECHECKFRONTMULTPACKAGETERM,
  liveHostModuleCheckFrontMultPackageTermSource,
  HOST-FRONT-LIVE-HOSTMODULECHECKFRONTMULTPACKAGETERM,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckFrontMultPackageTermSource
...
/-- Dual-pinned live HostModuleCheckFrontMultPackageTerm.lean bytes.
    One part. Not split. 323 product lines plus this header stay under about 780.
    Greppable: liveHostModuleCheckFrontMultPackageTermSource,
    PARSE-LIVE-HOSTMODULECHECKFRONTMULTPACKAGETERM. -/
def liveHostModuleCheckFrontMultPackageTermSource : String := r#"/-
