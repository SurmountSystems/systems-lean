/-
  SYSTEMS_LEAN_HOST partial. Dual-pin live LinearTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveLinearTheoremsSource. Not occupancy name 50. Not mill 70.
  This wrap parses LinearTheorems.lean only. Not the Linear.lean library.
  Not FullHost. Not occupancy 50. Not mill 70. Not Lake-gone. Not PROVABLY.
  Not freestanding residual free.
  Unique needles (THEOREMS suffix plus trailing newline so a grep of a shorter
  Linear needle is not a prefix hit):
  HostFrontLiveLinearTheoremsSource
  PARSE-LIVE-LINEAR-THEOREMS
  HOST-FRONT-LIVE-LINEAR-THEOREMS
  SLAKE_HOST_FRONT_LIVE_LINEAR_THEOREMS_V0
  Greppable: SYSTEMS_LEAN_HOST, liveLinearTheoremsSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveLinearTheoremsSource
...
/-- Dual-pinned live LinearTheorems.lean bytes (must match on-disk file).
    Greppable: liveLinearTheoremsSource, PARSE-LIVE-LINEAR-THEOREMS. -/
def liveLinearTheoremsSource : String := r#"/-
