...
def liveRel : String :=
  SystemsLean.HostFrontLiveKernelProgramTheorems.liveRel
...
def main (args : List String) : IO UInt32 := do
  ...
  unless (liveRel == "KernelProgramTheorems.lean") do
    IO.eprintln "error: liveRel must be KernelProgramTheorems.lean"
    return 1
