/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live CapableRegenerateTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveCapableRegenerateTheoremsSource.
  Not occupancy name 50. Not mill 70.
  This wrap is CapableRegenerateTheorems.lean. It is not CapableRegenerate.lean.
  Greppable: SYSTEMS_LEAN_HOST, REGENERATE-THEOREM,
  liveCapableRegenerateTheoremsSource,
  HOST-FRONT-LIVE-CAPABLE-REGENERATE-THEOREMS, liveRel,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveCapableRegenerateTheoremsSource
...
/-- Dual-pinned live CapableRegenerateTheorems.lean bytes (must match on-disk file).
    Greppable: liveCapableRegenerateTheoremsSource, REGENERATE-THEOREM. -/
def liveCapableRegenerateTheoremsSource : String := r#"/-
