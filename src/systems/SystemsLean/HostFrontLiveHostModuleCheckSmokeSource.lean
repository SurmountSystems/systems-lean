/-
  ...
  HostModuleCheckSmoke.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckSmokeSource.
  ...
  liveHostModuleCheckSmokeSource,
  HOST-FRONT-LIVE-HOSTMODULECHECKSMOKE, liveRel,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckSmokeSource
...
/-- Dual-pinned live HostModuleCheckSmoke.lean bytes.
    One raw string. The product is 384 lines, so this file stays under 780.
    Greppable: liveHostModuleCheckSmokeSource,
    HOST-FRONT-LIVE-HOSTMODULECHECKSMOKE. -/
def liveHostModuleCheckSmokeSource : String := r#"/-
