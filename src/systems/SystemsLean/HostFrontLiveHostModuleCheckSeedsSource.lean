/-
  ...
  HostModuleCheckSeeds.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckSeedsSource.
  ...
  liveHostModuleCheckSeedsSource,
  HOST-FRONT-LIVE-HOSTMODULECHECKSEEDS, liveRel,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckSeedsSource
...
/-- Dual-pinned live HostModuleCheckSeeds.lean bytes.
    One raw string. The product is 740 lines, so this file stays under 780.
    Greppable: liveHostModuleCheckSeedsSource,
    HOST-FRONT-LIVE-HOSTMODULECHECKSEEDS. -/
def liveHostModuleCheckSeedsSource : String := r#"/-
