/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live EmitPlan.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveEmitPlanSource. Not occupancy name 50. Not mill 70.
  This wrap is EmitPlan.lean. It is not EmitApply.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveEmitPlanSource,
  HOST-FRONT-LIVE-EMIT-PLAN, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveEmitPlanSource
...
/-- Dual-pinned live EmitPlan.lean bytes (must match on-disk file).
    Greppable: liveEmitPlanSource, HOST-FRONT-LIVE-EMIT-PLAN. -/
def liveEmitPlanSource : String := r#"/-
