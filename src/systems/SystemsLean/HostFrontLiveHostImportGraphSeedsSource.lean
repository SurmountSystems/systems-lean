/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostImportGraphSeeds.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostImportGraphSeedsSource. Not occupancy name 50.
  ...
  prefix hit on mill wrap HostFrontLiveHostImportGraphMain.
  Occupancy leftover is not this wrap.
  Unique needles (trailing newline so HostFrontLiveHostImportGraphSeeds is not a prefix):
  HostFrontLiveHostImportGraphSeedsSource
  PARSE-LIVE-HOST-IMPORT-GRAPH-SEEDS
  HOST-FRONT-LIVE-HOST-IMPORT-GRAPH-SEEDS
  Greppable: SYSTEMS_LEAN_HOST, liveHostImportGraphSeedsSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostImportGraphSeedsSource
...
/-- Dual-pinned live HostImportGraphSeeds.lean bytes (must match on-disk file).
    Greppable: liveHostImportGraphSeedsSource, PARSE-LIVE-HOST-IMPORT-GRAPH-SEEDS. -/
def liveHostImportGraphSeedsSource : String := r#"/-
