/-
  ...
  HostModuleCheckSelfHostBodyTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckSelfHostBodyTermSource.
  ...
  liveHostModuleCheckSelfHostBodyTermSource,
  HOST-FRONT-LIVE-HOSTMODULECHECKSELFHOSTBODYTERM, liveRel,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckSelfHostBodyTermSource
...
/-- Dual-pinned live HostModuleCheckSelfHostBodyTerm.lean bytes.
    One raw string. The product is 205 lines, so this file stays under 780.
    Greppable: liveHostModuleCheckSelfHostBodyTermSource,
    HOST-FRONT-LIVE-HOSTMODULECHECKSELFHOSTBODYTERM. -/
def liveHostModuleCheckSelfHostBodyTermSource : String := r#"/-
