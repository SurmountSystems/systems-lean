/-
  SYSTEMS_LEAN_HOST partial -- dual-pin of ProductPathWriterSurface.lean bytes.
  liveProductPathWriterSurfaceSource is the exact bytes of
  src/systems/SystemsLean/ProductPathWriterSurface.lean.
  Module: SystemsLean.HostFrontLiveProductPathWriterSurfaceSource
  Not FullHost. Not Lake-gone. Occupancy stays 49. Mill stays 69 of 69.
  slakeOwnsPackageTypecheck stays false.
  Theorems stay in ProductPathWriterSurfaceTheorems (not this pin).
  Greppable: SYSTEMS_LEAN_HOST, liveProductPathWriterSurfaceSource.
  Module must stay ASCII.
-/

namespace SystemsLean.HostFrontLiveProductPathWriterSurface

def liveProductPathWriterSurfaceSource : String := r#"/-
