/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckFixtureTexts.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckFixtureTextsSource. Not occupancy name 50.
  Not mill remill. Mill stays 69 of 69.
  This wrap dual-pins HostModuleCheckFixtureTexts.lean only. One part.
  Do not steal a neighbor checker. Do not retarget HostModuleCheckFixtureTexts.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-HOSTMODULECHECKFIXTURETEXTS,
  liveHostModuleCheckFixtureTextsSource,
  HOST-FRONT-LIVE-HOSTMODULECHECKFIXTURETEXTS,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckFixtureTextsSource
...
/-- Dual-pinned live HostModuleCheckFixtureTexts.lean bytes.
    One part. Not split. 641 product lines plus this header stay under about 780.
    Greppable: liveHostModuleCheckFixtureTextsSource,
    PARSE-LIVE-HOSTMODULECHECKFIXTURETEXTS. -/
def liveHostModuleCheckFixtureTextsSource : String := r#"/-
