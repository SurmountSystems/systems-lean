/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live EmitProgramScaffold.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveEmitProgramScaffoldSource. Not occupancy name 50. Not mill 70.
  Unique needles (trailing newline so EmitProgram wrap is not a prefix):
  HostFrontLiveEmitProgramScaffoldSource
  PARSE-LIVE-EMIT-PROGRAM-SCAFFOLD
  HOST-FRONT-LIVE-EMIT-PROGRAM-SCAFFOLD
  Greppable: SYSTEMS_LEAN_HOST, liveEmitProgramScaffoldSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveEmitProgramScaffoldSource
...
/-- Dual-pinned live EmitProgramScaffold.lean bytes (must match on-disk file).
    Greppable: liveEmitProgramScaffoldSource, PARSE-LIVE-EMIT-PROGRAM-SCAFFOLD. -/
def liveEmitProgramScaffoldSource : String := r##"/-
