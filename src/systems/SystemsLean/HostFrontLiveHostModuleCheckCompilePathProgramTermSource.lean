/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckCompilePathProgramTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckCompilePathProgramTermSource. Not occupancy name 50.
  Not mill remill. Mill stays 69 of 69.
  This wrap dual-pins HostModuleCheckCompilePathProgramTerm.lean only. One part.
  Do not steal a neighbor checker. Do not retarget HostFrontLiveHostModuleCheckCheckersLater.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-HOSTMODULECHECKCOMPILEPATHPROGRAMTERM,
  liveHostModuleCheckCompilePathProgramTermSource,
  HOST-FRONT-LIVE-HOSTMODULECHECKCOMPILEPATHPROGRAMTERM,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckCompilePathProgramTermSource
...
/-- Dual-pinned live HostModuleCheckCompilePathProgramTerm.lean bytes.
    One part. Not split. 217 lines plus this header stay under about 780.
    Greppable: liveHostModuleCheckCompilePathProgramTermSource,
    PARSE-LIVE-HOSTMODULECHECKCOMPILEPATHPROGRAMTERM. -/
def liveHostModuleCheckCompilePathProgramTermSource : String := r#"/-
