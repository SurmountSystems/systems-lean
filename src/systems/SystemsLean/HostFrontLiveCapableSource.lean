/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live Capable.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveCapableSource. Not occupancy name 50. Not mill 70.
  This wrap is Capable.lean. It is not CapableTheorems.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveCapableSource,
  HOST-FRONT-LIVE-CAPABLE, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveCapableSource
...
/-- Dual-pinned live Capable.lean bytes (must match on-disk file).
    Greppable: liveCapableSource, HOST-FRONT-LIVE-CAPABLE. -/
def liveCapableSource : String := r#"/-
