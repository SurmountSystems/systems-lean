/-
  ...
  src/systems/SystemsLean/HostModuleCheckKernelEmitTermKernel.lean
  ...
  HOST-FRONT-LIVE-HOST-MODULE-CHECK-KERNEL-EMIT-TERM-KERNEL,
  SLAKE_HOST_FRONT_LIVE_HOST_MODULE_CHECK_KERNEL_EMIT_TERM_KERNEL_V0,
  PARSE-LIVE-HOST-MODULE-CHECK-KERNEL-EMIT-TERM-KERNEL, liveRel,
  kernelCheckLiveHostModuleCheckKernelEmitTermKernelSource,
  hostFrontLiveHostModuleCheckKernelEmitTermKernelReady.
  Module: SystemsLean.HostFrontLiveHostModuleCheckKernelEmitTermKernelSource
...
namespace SystemsLean.HostFrontLiveHostModuleCheckKernelEmitTermKernelSource
...
def liveRel : String := "HostModuleCheckKernelEmitTermKernel.lean"
...
def hostFrontLiveHostModuleCheckKernelEmitTermKernelFullHost : Bool := false

/-- Honesty: this wrap is not an LLVM backend. FullBackend stays false. -/
def hostFrontLiveHostModuleCheckKernelEmitTermKernelFullBackend : Bool := false

/-- Honesty: not product residual free. -/
def hostFrontLiveHostModuleCheckKernelEmitTermKernelResidualFreeClaimed : Bool :=
  false

/-- Honesty: this wrap is not PROVABLY. -/
def hostFrontLiveHostModuleCheckKernelEmitTermKernelProvablyUnlocked : Bool :=
  false
...
/-- On-disk HostModuleCheckKernelEmitTermKernel.lean bytes.
    Greppable: liveHostModuleCheckKernelEmitTermKernelSource. -/


def liveHostModuleCheckKernelEmitTermKernelSource : String := r#"/-
...
/-- Parse live HostModuleCheckKernelEmitTermKernel.lean text.
    Greppable: parseLiveHostModuleCheckKernelEmitTermKernelSource. -/
def parseLiveHostModuleCheckKernelEmitTermKernelSource (src : String) :
    FrontResult :=
  ...
  if toks.isEmpty then FrontResult.reject reasonEmptyModule
    ...
    | some cmds =>
      if cmds.isEmpty then FrontResult.reject reasonEmptyModule
        ...
        let m : Module :=
          { name := HostTerm.n "SystemsLean.HostModuleCheckKernelEmitTermKernel"
            commands := cmds }
        if isWellFormed m then FrontResult.accept m
        else FrontResult.reject reasonNotWellFormed

/-- Kernel-check the live parse. Not a fixture.
    Greppable: kernelCheckLiveHostModuleCheckKernelEmitTermKernelSource. -/
def kernelCheckLiveHostModuleCheckKernelEmitTermKernelSource (src : String) :
    Bool :=
  match parseLiveHostModuleCheckKernelEmitTermKernelSource src with
  | FrontResult.accept m => HostKernel.kernelCheck m
  | FrontResult.reject _ => false

/-- Accepted live module when parse succeeds. -/
def liveParsed? : Option Module :=
  match parseLiveHostModuleCheckKernelEmitTermKernelSource
      liveHostModuleCheckKernelEmitTermKernelSource with
  ...
  | some m =>
    let has (nm : String) : Bool :=
      m.commands.any fun c =>
        ...
        | _ => false
    has "checkDepthKernelEmitTermKernelBar"
      && has "checkDepthKernelEmitTermKernelScope"
      && has "hostModuleCheckKernelEmitTermKernelDualOk"
...
def liveParseHasModuleName : Bool :=
  ...
  | none => false
  | some m =>
    m.name.raw == "SystemsLean.HostModuleCheckKernelEmitTermKernel"
...
def liveParseKwCountsOk : Bool :=
  ...
  | some _ =>
    let toks := tokenizeHostTerm
      (stripComments liveHostModuleCheckKernelEmitTermKernelSource)
...
def liveNeedlesOk : Bool :=
  let src := liveHostModuleCheckKernelEmitTermKernelSource
...
/-- End-to-end ready: live text parse kernel-checks.
    Greppable: hostFrontLiveHostModuleCheckKernelEmitTermKernelReady.
    Real conjunction: parse plus kernelCheck plus this file's commands.
    Not a hardcoded true. -/
def hostFrontLiveHostModuleCheckKernelEmitTermKernelReady : Bool :=
  (stageId ==
    "SLAKE_HOST_FRONT_LIVE_HOST_MODULE_CHECK_KERNEL_EMIT_TERM_KERNEL_V0")
    && (hostId ==
      "HOST-FRONT-LIVE-HOST-MODULE-CHECK-KERNEL-EMIT-TERM-KERNEL")
    && (parseId ==
      "PARSE-LIVE-HOST-MODULE-CHECK-KERNEL-EMIT-TERM-KERNEL")
    && (liveRel == "HostModuleCheckKernelEmitTermKernel.lean")
    && (liveHostModuleCheckKernelEmitTermKernelRel ==
      "src/systems/SystemsLean/HostModuleCheckKernelEmitTermKernel.lean")
    && liveParseDoesNotUseMultFixture
    && !hostFrontLiveHostModuleCheckKernelEmitTermKernelFullHost
    && !hostFrontLiveHostModuleCheckKernelEmitTermKernelFullBackend
    && !hostFrontLiveHostModuleCheckKernelEmitTermKernelResidualFreeClaimed
    && !hostFrontLiveHostModuleCheckKernelEmitTermKernelProvablyUnlocked
    && kernelCheckLiveHostModuleCheckKernelEmitTermKernelSource
      liveHostModuleCheckKernelEmitTermKernelSource
...
def liveParseRejectsEmpty : Bool :=
  match parseLiveHostModuleCheckKernelEmitTermKernelSource "" with
...
def readyFailures : List String :=
  ...
  bad "stageId" (stageId ==
    ...
    ++ bad "parseId" (parseId ==
      "PARSE-LIVE-HOST-MODULE-CHECK-KERNEL-EMIT-TERM-KERNEL")
    ++ bad "liveRel" (liveRel == "HostModuleCheckKernelEmitTermKernel.lean")
    ++ bad "rel" (liveHostModuleCheckKernelEmitTermKernelRel ==
      "src/systems/SystemsLean/HostModuleCheckKernelEmitTermKernel.lean")
    ++ bad "notMult" liveParseDoesNotUseMultFixture
    ++ bad "fullHost" (!hostFrontLiveHostModuleCheckKernelEmitTermKernelFullHost)
    ++ bad "fullBackend"
      (!hostFrontLiveHostModuleCheckKernelEmitTermKernelFullBackend)
    ++ bad "residual"
      (!hostFrontLiveHostModuleCheckKernelEmitTermKernelResidualFreeClaimed)
    ++ bad "provably"
      (!hostFrontLiveHostModuleCheckKernelEmitTermKernelProvablyUnlocked)
    ++ bad "kernel" (kernelCheckLiveHostModuleCheckKernelEmitTermKernelSource
      liveHostModuleCheckKernelEmitTermKernelSource)
...
def runLive (root : System.FilePath) : IO Unit := do
  ...
  let path := root / liveHostModuleCheckKernelEmitTermKernelRel
  unless (<- path.pathExists) do
    IO.eprintln s!"error: missing {liveHostModuleCheckKernelEmitTermKernelRel}"
    throw (IO.userError s!"missing {liveHostModuleCheckKernelEmitTermKernelRel}")
  let disk <- IO.FS.readFile path
  if disk != liveHostModuleCheckKernelEmitTermKernelSource then
    IO.eprintln "error: dual-pin mismatch: on-disk HostModuleCheckKernelEmitTermKernel.lean != liveHostModuleCheckKernelEmitTermKernelSource"
    throw (IO.userError "dual-pin mismatch live HostModuleCheckKernelEmitTermKernel.lean")
  let r := parseLiveHostModuleCheckKernelEmitTermKernelSource disk
  match r with
  ...
  | FrontResult.accept m =>
    ...
    unless k do
      IO.eprintln "error: kernelCheck live HostModuleCheckKernelEmitTermKernel parse false"
      throw (IO.userError "kernelCheck live HostModuleCheckKernelEmitTermKernel parse false")
    unless hostFrontLiveHostModuleCheckKernelEmitTermKernelReady do
      ...
      throw (IO.userError "hostFrontLiveHostModuleCheckKernelEmitTermKernelReady false")
    unless liveParseRejectsEmpty do
      IO.eprintln "error: empty HostModuleCheckKernelEmitTermKernel source was accepted"
      throw (IO.userError "empty HostModuleCheckKernelEmitTermKernel source was accepted")
...
end SystemsLean.HostFrontLiveHostModuleCheckKernelEmitTermKernelSource
