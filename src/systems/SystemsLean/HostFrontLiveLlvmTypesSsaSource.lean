/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live LlvmTypesSsa.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveLlvmTypesSsaSource. Not occupancy name 50.
  ...
  LLVM-TYPES-SSA
  Greppable: SYSTEMS_LEAN_HOST, liveLlvmTypesSsaSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveLlvmTypesSsaSource
...
/-- Dual-pinned live LlvmTypesSsa.lean bytes (must match on-disk file).
    Greppable: liveLlvmTypesSsaSource, PARSE-LIVE-LLVM-TYPES-SSA. -/
def liveLlvmTypesSsaSource : String := r#"/-
