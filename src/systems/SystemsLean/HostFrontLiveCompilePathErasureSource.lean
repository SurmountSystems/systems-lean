/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live CompilePathErasure.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveCompilePathErasureSource. Not occupancy name 50. Not mill 70.
...
/-- Dual-pinned live CompilePathErasure.lean bytes (must match on-disk file).
    Greppable: liveCompilePathErasureSource, PARSE-LIVE-COMPILE-PATH-ERASURE. -/
def liveCompilePathErasureSource : String := r#"/-
