/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostImportGraphModsLater.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveImportModsLaterSource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-IMPORT-MODS-LATER, liveImportModsLaterSource,
  HOST-FRONT-LIVE-IMPORT-MODS-LATER, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveImportModsLaterSource
...
/-- Dual-pinned live HostImportGraphModsLater.lean bytes (must match on-disk file).
    Greppable: liveImportModsLaterSource, PARSE-LIVE-IMPORT-MODS-LATER. -/
def liveImportModsLaterSource : String := r#"/-
