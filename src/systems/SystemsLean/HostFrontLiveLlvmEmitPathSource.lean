/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live LlvmEmitPath.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveLlvmEmitPathSource. Not occupancy name 50. Not mill 70.
  This wrap is LlvmEmitPath.lean. Theorems and examples in that file are
  skipped by the parser. It is not a separate LlvmEmitPathTheorems file.
  Greppable: SYSTEMS_LEAN_HOST, liveLlvmEmitPathSource,
  HOST-FRONT-LIVE-LLVM-EMIT-PATH, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveLlvmEmitPathSource
...
/-- Dual-pinned live LlvmEmitPath.lean bytes (must match on-disk file).
    Greppable: liveLlvmEmitPathSource, HOST-FRONT-LIVE-LLVM-EMIT-PATH. -/
def liveLlvmEmitPathSource : String := r#"/-
...
/-- Live file basename. -/
def liveRel : String := "LlvmEmitPath.lean"
