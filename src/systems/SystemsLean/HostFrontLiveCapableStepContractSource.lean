/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live CapableStepContract.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveCapableStepContractSource. Not occupancy name 50. Not mill 70.
  This wrap is CapableStepContract.lean. It is not CapableStepContractTheorems.lean.
  It is not CapableStepContractMain.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveCapableStepContractSource,
  HOST-FRONT-LIVE-CAPABLE-STEP-CONTRACT, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveCapableStepContractSource
...
/-- Dual-pinned live CapableStepContract.lean bytes (must match on-disk file).
    Greppable: liveCapableStepContractSource, HOST-FRONT-LIVE-CAPABLE-STEP-CONTRACT. -/
def liveCapableStepContractSource : String := r#"/-
