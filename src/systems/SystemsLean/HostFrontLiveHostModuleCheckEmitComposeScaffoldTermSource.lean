/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckEmitComposeScaffoldTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckEmitComposeScaffoldTermSource. Not occupancy name 50.
  Not mill remill. Mill stays 69 of 69.
  This wrap dual-pins HostModuleCheckEmitComposeScaffoldTerm.lean only. One part.
  Do not steal a neighbor checker. Do not retarget HostModuleCheckEmitComposeScaffoldTerm.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-HOSTMODULECHECKEMITCOMPOSESCAFFOLDTERM,
  liveHostModuleCheckEmitComposeScaffoldTermSource,
  HOST-FRONT-LIVE-HOSTMODULECHECKEMITCOMPOSESCAFFOLDTERM,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckEmitComposeScaffoldTermSource
...
/-- Dual-pinned live HostModuleCheckEmitComposeScaffoldTerm.lean bytes.
    One part. Not split. 340 lines plus this header stay under about 780.
    Greppable: liveHostModuleCheckEmitComposeScaffoldTermSource,
    PARSE-LIVE-HOSTMODULECHECKEMITCOMPOSESCAFFOLDTERM. -/
def liveHostModuleCheckEmitComposeScaffoldTermSource : String := r#"/-
