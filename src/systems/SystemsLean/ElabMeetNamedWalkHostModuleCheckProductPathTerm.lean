/-
  SYSTEMS_LEAN_HOST partial -- HostModuleCheckProductPathTerm named-walk
  wrappers (CheckersLater-role walk; ProductPathBarsTerm walk is the prior
  ...
  GraphSubsetRebuildTerm walk, and ProductPathBarsTerm walk
  ...
  ElabMeetNamedWalk. Prior ProductPathBarsTerm wrappers stay in
  ElabMeetNamedWalkHostModuleCheckProductPathBarsTerm. Do not grow that walk.
  ...
  ProductPathBarsTermProbe.
  Do not grow ElabMeetCompile.
  Do not plant live HostModuleCheckProductPathTerm.lean.
  Do not skip to HostModuleCheckProbeWireTerm.
  Rec-depth 8192 keep on later ElabMeet fold; this extract does not fold.

  Spec (readable):
  - HostModuleCheckProductPathTerm wrappers live here:
    ...
    Named membership is the prior ProductPathBarsTerm closed set plus
    HostModuleCheckProductPathTerm last. Barrel order among that
    closed set; skip Linear, skip IrGraph, skip HostGraphMain,
    skip HostCompose. Compile order is the ProductPathBarsTerm compile
    order, then HostModuleCheckProductPathTerm last. EmitPlanTerm
    ...
    GraphSubsetRebuildTerm / ProductPathBarsTerm order), not a
    named plus-one.
    IrGraph and HostCompose are compile dependencies only. After-deps
    are the ProductPathBarsTerm compile order.
    HostModuleCheckProductPathTerm imports HostModuleCheckSurface and
    HostModuleCheckEmitPlanTerm (same dispatcher-split honesty as
    HostModuleCheckProductPathBarsTerm; EmitPlanTerm is compile-dep only).
  ...
  Module: SystemsLean.ElabMeetNamedWalkHostModuleCheckProductPathTerm
  Short role name (not ProductPathFreestanding*).
  Red/green: lake build SystemsLean.ElabMeetNamedWalkHostModuleCheckProductPathTerm;
  just systems-host.
...
/-- Resolve live SystemsLean/HostModuleCheckProductPathTerm.lean.
    Wrapper over findLiveModulePath.
    Greppable: findLiveHostModuleCheckProductPathTermPath. -/
def findLiveHostModuleCheckProductPathTermPath : IO (Option System.FilePath) :=
  findLiveModulePath "SystemsLean.HostModuleCheckProductPathTerm"

/-- Named HostModuleCheckProductPathTerm subset of the live SystemsLean library.
    Membership is the prior ProductPathBarsTerm closed set plus
    HostModuleCheckProductPathTerm last.
    ...
    Greppable: namedClosedHostModuleCheckProductPathTermSubsetNames.
    SystemsLean.HostModuleCheckProductPathTerm. -/
def namedClosedHostModuleCheckProductPathTermSubsetNames : List String :=
  namedClosedHostModuleCheckProductPathBarsTermSubsetNames ++
    ["SystemsLean.HostModuleCheckProductPathTerm"]

/-- Compile order honors imports: ProductPathBarsTerm compile order, then
    HostModuleCheckProductPathTerm last. IrGraph and HostCompose are
    ...
    Greppable: namedClosedHostModuleCheckProductPathTermCompileOrder. -/
def namedClosedHostModuleCheckProductPathTermCompileOrder : List String :=
  namedClosedHostModuleCheckProductPathBarsTermCompileOrder ++
    ["SystemsLean.HostModuleCheckProductPathTerm"]

/-- True when the barrel lists each HostModuleCheckProductPathTerm subset member.
    Wrapper over barrelListsNamedMembers.
    Greppable: barrelListsNamedHostModuleCheckProductPathTermSubset. -/
def barrelListsNamedHostModuleCheckProductPathTermSubset (text : String) : Bool :=
  barrelListsNamedMembers text namedClosedHostModuleCheckProductPathTermSubsetNames

/-- Compile the named HostModuleCheckProductPathTerm subset after reading
    the live lakefile. Wrapper over tryCompileNamedMemberListIO.
    Compile order honors imports: Mult first, then the ProductPathBarsTerm
    compile order, then HostModuleCheckProductPathTerm last.
    Greppable: tryCompileNamedHostModuleCheckProductPathTermSubset.
    tryCompileOnDiskModule. SystemsLean.HostModuleCheckProductPathTerm. -/
unsafe def tryCompileNamedHostModuleCheckProductPathTermSubsetIO
    (srcPath oleanDir : System.FilePath) : IO Bool := do
  tryCompileNamedMemberListIO srcPath oleanDir
    namedClosedHostModuleCheckProductPathTermSubsetNames
    namedClosedHostModuleCheckProductPathTermCompileOrder

@[implemented_by tryCompileNamedHostModuleCheckProductPathTermSubsetIO]
opaque tryCompileNamedHostModuleCheckProductPathTermSubsetIOSafe
    (srcPath oleanDir : System.FilePath) : IO Bool

/-- CommandElab wrapper: compile the HostModuleCheckProductPathTerm subset.
    Greppable: tryCompileNamedHostModuleCheckProductPathTermSubset. -/
def tryCompileNamedHostModuleCheckProductPathTermSubset
    (srcPath oleanDir : System.FilePath) : CommandElabM Bool := do
  try
    liftIO
      (tryCompileNamedHostModuleCheckProductPathTermSubsetIOSafe srcPath oleanDir)
  catch _ =>
    pure false

/-- Compile live Mult first, then the ProductPathBarsTerm compile order
    ...
    Greppable: tryCompileAfterHostModuleCheckProductPathTermDeps.
    tryCompileOnDiskModule. -/
unsafe def tryCompileAfterHostModuleCheckProductPathTermDepsIO
    (srcPath oleanDir : System.FilePath) (thmMod : Name) : IO Bool :=
  tryCompileAfterNamedDepsIO srcPath oleanDir thmMod
    namedClosedHostModuleCheckProductPathBarsTermCompileOrder

@[implemented_by tryCompileAfterHostModuleCheckProductPathTermDepsIO]
opaque tryCompileAfterHostModuleCheckProductPathTermDepsIOSafe
    (srcPath oleanDir : System.FilePath) (thmMod : Name) : IO Bool

/-- CommandElab wrapper: compile after HostModuleCheckProductPathTerm deps.
    Greppable: tryCompileAfterHostModuleCheckProductPathTermDeps. -/
def tryCompileAfterHostModuleCheckProductPathTermDeps
    (srcPath oleanDir : System.FilePath) (thmMod : Name) :
    CommandElabM Bool := do
  try
    liftIO
      (tryCompileAfterHostModuleCheckProductPathTermDepsIOSafe srcPath oleanDir thmMod)
  catch _ =>
    pure false
