/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live ProductPathComposePlan.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveProductPathComposePlanSource. Not occupancy name 50.
  ...
  prefix hit on mill wrap companions.
  ...
  HostFrontLiveProductPathComposePlanSource
  PARSE-LIVE-PRODUCT-PATH-COMPOSE-PLAN
  HOST-FRONT-LIVE-PRODUCT-PATH-COMPOSE-PLAN
  Greppable: SYSTEMS_LEAN_HOST, liveProductPathComposePlanSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveProductPathComposePlanSource
...
/-- Dual-pinned live ProductPathComposePlan.lean bytes (must match on-disk file).
    Greppable: liveProductPathComposePlanSource, PARSE-LIVE-PRODUCT-PATH-COMPOSE-PLAN. -/
def liveProductPathComposePlanSource : String := r#"/-
