/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckAcceptsProof.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckAcceptsProofSource. Not occupancy name 50.
  Not mill remill. Mill stays 69 of 69.
  Unique needles (trailing newline so a shorter HostModuleCheck prefix is not a hit):
  HostFrontLiveHostModuleCheckAcceptsProofSource
  PARSE-LIVE-HOSTMODULECHECKACCEPTSPROOF
  HOST-FRONT-LIVE-HOSTMODULECHECKACCEPTSPROOF
  Greppable: SYSTEMS_LEAN_HOST, liveHostModuleCheckAcceptsProofSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckAcceptsProofSource
...
/-- Dual-pinned live HostModuleCheckAcceptsProof.lean bytes (must match on-disk file).
    Greppable: liveHostModuleCheckAcceptsProofSource, PARSE-LIVE-HOSTMODULECHECKACCEPTSPROOF. -/
def liveHostModuleCheckAcceptsProofSource : String := r#"/-
