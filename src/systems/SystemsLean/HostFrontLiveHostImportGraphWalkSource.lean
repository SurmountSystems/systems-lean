/-
  ...
  Short role: HostFrontLiveHostImportGraphWalkSource. Not occupancy name 50.
  ...
  prefix hit on mill wrap HostFrontLiveHostImportGraphMain, extra wrap
  HostFrontLiveHostImportGraph, extra wrap HostFrontLiveHostImportGraphSeeds,
  or a future HostFrontLiveHostImportGraphWalkLater.
  Occupancy leftover is not this wrap.
  Unique needles (trailing newline so HostFrontLiveHostImportGraphWalk is not a prefix):
  HostFrontLiveHostImportGraphWalkSource
  ...
  Greppable: SYSTEMS_LEAN_HOST, liveHostImportGraphWalkSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostImportGraphWalkSource
...
/-- Dual-pinned live HostImportGraphWalk.lean bytes (must match on-disk file).
    Greppable: liveHostImportGraphWalkSource, PARSE-LIVE-HOST-IMPORT-GRAPH-WALK. -/
def liveHostImportGraphWalkSource : String := r#"/-
