/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live BootstrapHonestyTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveBootstrapHonestyTheoremsSource.
  Not occupancy name 50. Not mill 70.
  This wrap is BootstrapHonestyTheorems.lean. It is not BootstrapHonesty.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveBootstrapHonestyTheoremsSource,
  HOST-FRONT-LIVE-BOOTSTRAP-HONESTY-THEOREMS, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveBootstrapHonestyTheoremsSource
...
def liveRel : String := "BootstrapHonestyTheorems.lean"

/-- Dual-pinned live BootstrapHonestyTheorems.lean bytes (must match on-disk file).
    Greppable: liveBootstrapHonestyTheoremsSource,
    HOST-FRONT-LIVE-BOOTSTRAP-HONESTY-THEOREMS. -/
def liveBootstrapHonestyTheoremsSource : String := r#"/-
