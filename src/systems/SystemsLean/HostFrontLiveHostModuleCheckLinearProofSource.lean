/-
  SYSTEMS_LEAN_HOST partial -- live HostModuleCheckLinearProof.lean.
  ...
  liveRel is HostModuleCheckLinearProof.lean. Not a path.
  Greppable: liveRel, kernelCheckLiveHostModuleCheckLinearProofSource,
  PARSE-LIVE-HOST-MODULE-CHECK-LINEAR-PROOF.
  Module: SystemsLean.HostFrontLiveHostModuleCheckLinearProofSource
...
namespace SystemsLean.HostFrontLiveHostModuleCheckLinearProofSource
...
def liveRel : String := "HostModuleCheckLinearProof.lean"

/-- Pinned live HostModuleCheckLinearProof.lean bytes. -/
def liveHostModuleCheckLinearProofSource : String := r#"/-
...
def kernelCheckLiveHostModuleCheckLinearProofSource (src : String) : Bool :=
  match parseLiveLlvmComposeTextMainSource src with
  | FrontResult.accept m => HostKernel.kernelCheck m
  | FrontResult.reject _ => false

/-- Ready is parse plus kernelCheck of the pinned text. -/
def hostFrontLiveHostModuleCheckLinearProofSourceReady : Bool :=
  liveRel == "HostModuleCheckLinearProof.lean"
    && kernelCheckLiveHostModuleCheckLinearProofSource liveHostModuleCheckLinearProofSource
...
def runLive (root : System.FilePath) : IO Unit := do
  ...
  if disk != liveHostModuleCheckLinearProofSource then
    throw (IO.userError "dual-pin mismatch HostModuleCheckLinearProof.lean")
  let k := kernelCheckLiveHostModuleCheckLinearProofSource disk
  IO.println s!"kernelCheck={k}"
  unless k do
    throw (IO.userError "kernelCheck live HostModuleCheckLinearProof parse false")
  unless hostFrontLiveHostModuleCheckLinearProofSourceReady do
...
end SystemsLean.HostFrontLiveHostModuleCheckLinearProofSource
