/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live Linear.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveLinearSource. Not occupancy name 50. Not mill 70.
  This wrap is Linear.lean. It is not EmitLinearScaffold.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveLinearSource,
  HOST-FRONT-LIVE-LINEAR, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveLinearSource
...
/-- Dual-pinned live Linear.lean bytes (must match on-disk file).
    Greppable: liveLinearSource, HOST-FRONT-LIVE-LINEAR. -/
def liveLinearSource : String := r#"/-
