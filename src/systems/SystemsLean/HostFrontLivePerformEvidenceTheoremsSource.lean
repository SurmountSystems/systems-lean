/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live PerformEvidenceTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLivePerformEvidenceTheoremsSource. Not occupancy name 50.
  Not mill 70. This wrap is PerformEvidenceTheorems.lean.
  It is not PerformEvidence.lean.
  Greppable: SYSTEMS_LEAN_HOST, livePerformEvidenceTheoremsSource,
  HOST-FRONT-LIVE-PERFORM-EVIDENCE-THEOREMS, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLivePerformEvidenceTheoremsSource
...
/-- Dual-pinned live PerformEvidenceTheorems.lean bytes (must match on-disk file).
    Greppable: livePerformEvidenceTheoremsSource,
    HOST-FRONT-LIVE-PERFORM-EVIDENCE-THEOREMS. -/
def livePerformEvidenceTheoremsSource : String := r##"/-
