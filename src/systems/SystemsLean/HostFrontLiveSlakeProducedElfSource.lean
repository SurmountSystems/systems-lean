/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live SlakeProducedElf.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveSlakeProducedElfSource. Not occupancy name 50.
  Not mill. Mill stays 69 of 69.
  ...
  HostFrontLiveSlakeProducedElfSource
  PARSE-LIVE-SLAKE-PRODUCED-ELF
  HOST-FRONT-LIVE-SLAKE-PRODUCED-ELF
  SLAKE-PRODUCED-ELF
  Greppable: SYSTEMS_LEAN_HOST, liveSlakeProducedElfSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveSlakeProducedElfSource
...
/-- Dual-pinned live SlakeProducedElf.lean bytes (must match on-disk file).
    Greppable: liveSlakeProducedElfSource, PARSE-LIVE-SLAKE-PRODUCED-ELF. -/
def liveSlakeProducedElfSource : String := r#"/-
