/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live SubsetFront.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveSubsetFrontSource. Not occupancy name 50. Not mill 70.
  This wrap is SubsetFront.lean. It is not another module.
  Greppable: SYSTEMS_LEAN_HOST, liveSubsetFrontSource,
  HOST-FRONT-LIVE-SUBSET-FRONT, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveSubsetFrontSource
...
/-- Dual-pinned live SubsetFront.lean bytes (must match on-disk file).
    Greppable: liveSubsetFrontSource, HOST-FRONT-LIVE-SUBSET-FRONT. -/
def liveSubsetFrontSource : String := r###"/-
