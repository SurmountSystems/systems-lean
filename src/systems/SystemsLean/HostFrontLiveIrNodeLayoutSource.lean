/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live IrNodeLayout.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveIrNodeLayoutSource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-IR-NODE-LAYOUT, liveIrNodeLayoutSource,
  HOST-FRONT-LIVE-IR-NODE-LAYOUT, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveIrNodeLayoutSource
...
/-- Dual-pinned live IrNodeLayout.lean bytes (must match on-disk file).
    Greppable: liveIrNodeLayoutSource, PARSE-LIVE-IR-NODE-LAYOUT. -/
def liveIrNodeLayoutSource : String := r#"/-
