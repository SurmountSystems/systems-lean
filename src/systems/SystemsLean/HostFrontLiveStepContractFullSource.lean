/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live StepContractFull.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveStepContractFullSource. Not occupancy name 50. Not mill 70.
  This wrap is StepContractFull.lean. It is not StepContractFullMain.lean.
  It is not StepContractFullTheorems.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveStepContractFullSource,
  HOST-FRONT-LIVE-STEP-CONTRACT-FULL, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveStepContractFullSource
...
/-- Dual-pinned live StepContractFull.lean bytes (must match on-disk file).
    Greppable: liveStepContractFullSource, HOST-FRONT-LIVE-STEP-CONTRACT-FULL. -/
def liveStepContractFullSource : String := r#"/-
