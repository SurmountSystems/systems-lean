/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live UseCheck.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveUseCheckSource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-USECHECK, liveUseCheckSource,
  HOST-FRONT-LIVE-USECHECK, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveUseCheckSource
...
/-- Dual-pinned live UseCheck.lean bytes (must match on-disk file).
    Greppable: liveUseCheckSource, PARSE-LIVE-USECHECK. -/
def liveUseCheckSource : String := r#"/-
