/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live KernelEmitTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveKernelEmitTheoremsSource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-KERNEL-EMIT-THEOREMS, liveKernelEmitTheoremsSource,
  HOST-FRONT-LIVE-KERNEL-EMIT-THEOREMS, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveKernelEmitTheoremsSource
...
/-- Dual-pinned live KernelEmitTheorems.lean bytes (must match on-disk file).
    Greppable: liveKernelEmitTheoremsSource, PARSE-LIVE-KERNEL-EMIT-THEOREMS. -/
def liveKernelEmitTheoremsSource : String := r#"/-
