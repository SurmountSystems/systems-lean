/-
  SYSTEMS_LEAN_HOST partial -- HostModuleCheckErasureSubsetRebuildTerm named-walk
  wrappers (CheckersLater-role walk; ComposeSubsetRebuildTerm walk is the prior
  ...
  GraphSubsetRebuildTerm walk, and ComposeSubsetRebuildTerm walk
  ...
  ElabMeetNamedWalk. Prior ComposeSubsetRebuildTerm wrappers stay in
  ElabMeetNamedWalkHostModuleCheckComposeSubsetRebuildTerm. Do not grow that walk.
  ...
  ComposeSubsetRebuildTermProbe.
  Do not grow ElabMeetCompile.
  Do not plant live HostModuleCheckErasureSubsetRebuildTerm.lean.
  Do not skip to HostModuleCheckExtractSubsetRebuildTerm.
  Rec-depth 8192 keep on later ElabMeet fold; this extract does not fold.

  Spec (readable):
  - HostModuleCheckErasureSubsetRebuildTerm wrappers live here:
    ...
    Named membership is the prior ComposeSubsetRebuildTerm closed set plus
    HostModuleCheckErasureSubsetRebuildTerm last. Barrel order among that
    closed set; skip Linear, skip IrGraph, skip HostGraphMain,
    skip HostCompose. Compile order is the ComposeSubsetRebuildTerm compile
    order, then HostModuleCheckErasureSubsetRebuildTerm last. EmitPlanTerm
    ...
    GraphSubsetRebuildTerm / ComposeSubsetRebuildTerm order), not a
    named plus-one.
    IrGraph and HostCompose are compile dependencies only. After-deps
    are the ComposeSubsetRebuildTerm compile order.
    HostModuleCheckErasureSubsetRebuildTerm imports HostModuleCheckSurface and
    HostModuleCheckEmitPlanTerm (same dispatcher-split honesty as
    HostModuleCheckComposeSubsetRebuildTerm; EmitPlanTerm is compile-dep only).
  ...
  SystemsLean.ElabMeetNamedWalkHostModuleCheckErasureSubsetRebuildTerm,
  UNIT_SURFACE host surface, MULT-0, MULT-1, MULT-OMEGA.
  Module: SystemsLean.ElabMeetNamedWalkHostModuleCheckErasureSubsetRebuildTerm
  Short role name (not ProductPathFreestanding*).
  Red/green: lake build SystemsLean.ElabMeetNamedWalkHostModuleCheckErasureSubsetRebuildTerm;
  just systems-host.
...
/-- Resolve live SystemsLean/HostModuleCheckErasureSubsetRebuildTerm.lean.
    Wrapper over findLiveModulePath.
    Greppable: findLiveHostModuleCheckErasureSubsetRebuildTermPath. -/
def findLiveHostModuleCheckErasureSubsetRebuildTermPath : IO (Option System.FilePath) :=
  findLiveModulePath "SystemsLean.HostModuleCheckErasureSubsetRebuildTerm"

/-- Named HostModuleCheckErasureSubsetRebuildTerm subset of the live SystemsLean library.
    Membership is the prior ComposeSubsetRebuildTerm closed set plus
    HostModuleCheckErasureSubsetRebuildTerm last.
    ...
    Greppable: namedClosedHostModuleCheckErasureSubsetRebuildTermSubsetNames.
    SystemsLean.HostModuleCheckErasureSubsetRebuildTerm. -/
def namedClosedHostModuleCheckErasureSubsetRebuildTermSubsetNames : List String :=
  namedClosedHostModuleCheckComposeSubsetRebuildTermSubsetNames ++
    ["SystemsLean.HostModuleCheckErasureSubsetRebuildTerm"]

/-- Compile order honors imports: ComposeSubsetRebuildTerm compile order, then
    HostModuleCheckErasureSubsetRebuildTerm last. IrGraph and HostCompose are
    ...
    Greppable: namedClosedHostModuleCheckErasureSubsetRebuildTermCompileOrder. -/
def namedClosedHostModuleCheckErasureSubsetRebuildTermCompileOrder : List String :=
  namedClosedHostModuleCheckComposeSubsetRebuildTermCompileOrder ++
    ["SystemsLean.HostModuleCheckErasureSubsetRebuildTerm"]

/-- True when the barrel lists each HostModuleCheckErasureSubsetRebuildTerm subset member.
    Wrapper over barrelListsNamedMembers.
    Greppable: barrelListsNamedHostModuleCheckErasureSubsetRebuildTermSubset. -/
def barrelListsNamedHostModuleCheckErasureSubsetRebuildTermSubset (text : String) : Bool :=
  barrelListsNamedMembers text namedClosedHostModuleCheckErasureSubsetRebuildTermSubsetNames

/-- Compile the named HostModuleCheckErasureSubsetRebuildTerm subset after reading
    the live lakefile. Wrapper over tryCompileNamedMemberListIO.
    Compile order honors imports: Mult first, then the ComposeSubsetRebuildTerm
    compile order, then HostModuleCheckErasureSubsetRebuildTerm last.
    Greppable: tryCompileNamedHostModuleCheckErasureSubsetRebuildTermSubset.
    tryCompileOnDiskModule. SystemsLean.HostModuleCheckErasureSubsetRebuildTerm. -/
unsafe def tryCompileNamedHostModuleCheckErasureSubsetRebuildTermSubsetIO
    (srcPath oleanDir : System.FilePath) : IO Bool := do
  tryCompileNamedMemberListIO srcPath oleanDir
    namedClosedHostModuleCheckErasureSubsetRebuildTermSubsetNames
    namedClosedHostModuleCheckErasureSubsetRebuildTermCompileOrder

@[implemented_by tryCompileNamedHostModuleCheckErasureSubsetRebuildTermSubsetIO]
opaque tryCompileNamedHostModuleCheckErasureSubsetRebuildTermSubsetIOSafe
    (srcPath oleanDir : System.FilePath) : IO Bool

/-- CommandElab wrapper: compile the HostModuleCheckErasureSubsetRebuildTerm subset.
    Greppable: tryCompileNamedHostModuleCheckErasureSubsetRebuildTermSubset. -/
def tryCompileNamedHostModuleCheckErasureSubsetRebuildTermSubset
    (srcPath oleanDir : System.FilePath) : CommandElabM Bool := do
  try
    liftIO
      (tryCompileNamedHostModuleCheckErasureSubsetRebuildTermSubsetIOSafe srcPath oleanDir)
  catch _ =>
    pure false

/-- Compile live Mult first, then the ComposeSubsetRebuildTerm compile order
    ...
    Greppable: tryCompileAfterHostModuleCheckErasureSubsetRebuildTermDeps.
    tryCompileOnDiskModule. -/
unsafe def tryCompileAfterHostModuleCheckErasureSubsetRebuildTermDepsIO
    (srcPath oleanDir : System.FilePath) (thmMod : Name) : IO Bool :=
  tryCompileAfterNamedDepsIO srcPath oleanDir thmMod
    namedClosedHostModuleCheckComposeSubsetRebuildTermCompileOrder

@[implemented_by tryCompileAfterHostModuleCheckErasureSubsetRebuildTermDepsIO]
opaque tryCompileAfterHostModuleCheckErasureSubsetRebuildTermDepsIOSafe
    (srcPath oleanDir : System.FilePath) (thmMod : Name) : IO Bool

/-- CommandElab wrapper: compile after HostModuleCheckErasureSubsetRebuildTerm deps.
    Greppable: tryCompileAfterHostModuleCheckErasureSubsetRebuildTermDeps. -/
def tryCompileAfterHostModuleCheckErasureSubsetRebuildTermDeps
    (srcPath oleanDir : System.FilePath) (thmMod : Name) :
    CommandElabM Bool := do
  try
    liftIO
      (tryCompileAfterHostModuleCheckErasureSubsetRebuildTermDepsIOSafe srcPath oleanDir thmMod)
  catch _ =>
    pure false
