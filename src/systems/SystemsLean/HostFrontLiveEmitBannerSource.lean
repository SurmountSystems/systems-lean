/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live EmitBanner.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveEmitBannerSource. Not occupancy name 50.
  ...
  HostFrontLiveEmitBannerSource
  PARSE-LIVE-EMIT-BANNER
  HOST-FRONT-LIVE-EMIT-BANNER
  src/systems/SystemsLean/EmitBanner.lean
  Greppable: SYSTEMS_LEAN_HOST, liveEmitBannerSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveEmitBannerSource
...
/-- Dual-pinned live EmitBanner.lean bytes (must match on-disk file).
    Greppable: liveEmitBannerSource, PARSE-LIVE-EMIT-BANNER. -/
def liveEmitBannerSource : String := r#"/-
