/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckKernelLinearTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveKernelLinearTermSource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-KERNELLINEARTERM, liveKernelLinearTermSource,
  HOST-FRONT-LIVE-KERNELLINEARTERM, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveKernelLinearTermSource
...
/-- Dual-pinned live HostModuleCheckKernelLinearTerm.lean bytes (must match on-disk file).
    Greppable: liveKernelLinearTermSource, PARSE-LIVE-KERNELLINEARTERM. -/
def liveKernelLinearTermSource : String := r#"/-
