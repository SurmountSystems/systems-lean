/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live KernelTypesTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveKernelTypesTheoremsSource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-KERNEL-TYPES-THEOREMS, liveKernelTypesTheoremsSource,
  HOST-FRONT-LIVE-KERNEL-TYPES-THEOREMS, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveKernelTypesTheoremsSource
...
/-- Dual-pinned live KernelTypesTheorems.lean bytes (must match on-disk file).
    Greppable: liveKernelTypesTheoremsSource, PARSE-LIVE-KERNEL-TYPES-THEOREMS. -/
def liveKernelTypesTheoremsSource : String := r#"/-
