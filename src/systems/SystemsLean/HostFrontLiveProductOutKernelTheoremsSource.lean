/-
  SYSTEMS_LEAN_HOST partial. Dual-pin live ProductOutKernelTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveProductOutKernelTheoremsSource. Not occupancy name 50. Not mill 70.
  ...
  HostFrontLiveProductOutKernelTheoremsSource
  ...
  Greppable: SYSTEMS_LEAN_HOST, liveProductOutKernelTheoremsSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveProductOutKernelTheoremsSource
...
/-- Dual-pinned live ProductOutKernelTheorems.lean bytes (must match on-disk file).
    Greppable: liveProductOutKernelTheoremsSource, PARSE-LIVE-PRODUCT-OUT-KERNEL-THEOREMS. -/
def liveProductOutKernelTheoremsSource : String := r#"/-
