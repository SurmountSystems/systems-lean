/-
  SYSTEMS_LEAN_HOST partial -- embedded bytes of live
  src/systems/SystemsLean/HostModuleCheckRealModule.lean.
  Split out of HostFrontLiveHostModuleCheckRealModuleSource so each
  new file stays under 1000 lines. The checker parses this string.
  Not an LLVM backend. FullHost stays false. Occupancy stays 49.
  Mill stays 69 of 69. slakeOwnsPackageTypecheck stays false.
  Module: SystemsLean.HostFrontLiveHostModuleCheckRealModuleSourceText
...
namespace SystemsLean.HostFrontLiveHostModuleCheckRealModuleSourceText

/-- On-disk HostModuleCheckRealModule.lean bytes.
    Greppable: liveHostModuleCheckRealModuleSource. -/
def liveHostModuleCheckRealModuleSource : String := r#"/-
...
end SystemsLean.HostFrontLiveHostModuleCheckRealModuleSourceText
