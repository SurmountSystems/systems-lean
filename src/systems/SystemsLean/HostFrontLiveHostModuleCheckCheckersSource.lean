/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckCheckers.lean bytes, first half.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckCheckersSource. Not occupancy name 50.
  Not mill remill. Mill stays 69 of 69.
  This wrap dual-pins HostModuleCheckCheckers.lean only, first half.
  ...
  liveHostModuleCheckCheckersSource0, HOST-FRONT-LIVE-HOSTMODULECHECKCHECKERS,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckCheckersSource
...
/-- Dual-pinned live HostModuleCheckCheckers.lean bytes, first half.
    Concatenate liveHostModuleCheckCheckersSource0 then
    liveHostModuleCheckCheckersSource1 before parse.
    Greppable: liveHostModuleCheckCheckersSource0,
    PARSE-LIVE-HOSTMODULECHECKCHECKERS. -/
def liveHostModuleCheckCheckersSource0 : String := r#"/-
