/-
  ...
  Short role: HostFrontLiveHostFrontTheoremsSource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-HOST-FRONT-THEOREMS, liveHostFrontTheoremsSource,
  HOST-FRONT-LIVE-HOST-FRONT-THEOREMS, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostFrontTheoremsSource
...
/-- Dual-pinned live HostFrontTheorems.lean bytes (must match on-disk file).
    Greppable: liveHostFrontTheoremsSource, PARSE-LIVE-HOST-FRONT-THEOREMS. -/
def liveHostFrontTheoremsSource : String := r#"/-
