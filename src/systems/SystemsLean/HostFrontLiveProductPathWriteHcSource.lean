/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live ProductPathWriteHc.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveProductPathWriteHcSource. Not occupancy name 50. Not mill 66 remill.
  ...
  HostFrontLiveProductPathWriteHcSource
  PARSE-LIVE-PRODUCT-PATH-WRITE-HC
  HOST-FRONT-LIVE-PRODUCT-PATH-WRITE-HC
  PRODUCT-PATH-WRITE-HC
  Greppable: SYSTEMS_LEAN_HOST, liveProductPathWriteHcSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveProductPathWriteHcSource
...
/-- Dual-pinned live ProductPathWriteHc.lean bytes (must match on-disk file).
    Greppable: liveProductPathWriteHcSource, PARSE-LIVE-PRODUCT-PATH-WRITE-HC. -/
def liveProductPathWriteHcSource : String := r#"/-
