/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostFront.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveFrontSource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-FRONT, liveFrontSource,
  HOST-FRONT-LIVE-FRONT, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveFrontSource
...
/-- Dual-pinned live HostFront.lean bytes (must match on-disk file).
    Greppable: liveFrontSource, PARSE-LIVE-FRONT. -/
def liveFrontSource : String := r#"/-
