/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live KernelTypes.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveKernelTypesSource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-KERNEL-TYPES, liveKernelTypesSource,
  HOST-FRONT-LIVE-KERNEL-TYPES, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveKernelTypesSource
...
/-- Dual-pinned live KernelTypes.lean bytes (must match on-disk file).
    Greppable: liveKernelTypesSource, PARSE-LIVE-KERNEL-TYPES. -/
def liveKernelTypesSource : String := r#"/-
