/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckKernelEmitTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveKernelEmitTermSource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-KERNELEMITTERM, liveKernelEmitTermSource,
  HOST-FRONT-LIVE-KERNELEMITTERM, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveKernelEmitTermSource
...
/-- Dual-pinned live HostModuleCheckKernelEmitTerm.lean bytes (must match on-disk file).
    Greppable: liveKernelEmitTermSource, PARSE-LIVE-KERNELEMITTERM. -/
def liveKernelEmitTermSource : String := r#"/-
