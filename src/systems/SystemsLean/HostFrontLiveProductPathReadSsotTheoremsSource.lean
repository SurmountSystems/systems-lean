/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live ProductPathReadSsotTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveProductPathReadSsotTheoremsSource. Not occupancy name 50. Not mill 70.
  ...
  HostFrontLiveProductPathReadSsotTheoremsSource
  ...
  Greppable: SYSTEMS_LEAN_HOST, liveProductPathReadSsotTheoremsSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveProductPathReadSsotTheoremsSource
...
/-- Dual-pinned live ProductPathReadSsotTheorems.lean bytes (must match on-disk file).
    Greppable: liveProductPathReadSsotTheoremsSource, PARSE-LIVE-PRODUCT-PATH-READ-SSOT-THEOREMS. -/
def liveProductPathReadSsotTheoremsSource : String := r#"/-
