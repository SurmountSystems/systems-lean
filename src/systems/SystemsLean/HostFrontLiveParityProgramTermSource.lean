/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckParityProgramTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveParityProgramTermSource. Not occupancy name 50. Not mill 70.
  Greppable: SYSTEMS_LEAN_HOST, PARSE-LIVE-PARITY-PROGRAM-TERM, liveParityProgramTermSource,
  HOST-FRONT-LIVE-PARITY-PROGRAM-TERM, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveParityProgramTermSource
...
/-- Dual-pinned live HostModuleCheckParityProgramTerm.lean bytes (must match on-disk file).
    Greppable: liveParityProgramTermSource, PARSE-LIVE-PARITY-PROGRAM-TERM. -/
def liveParityProgramTermSource : String := r#"/-
