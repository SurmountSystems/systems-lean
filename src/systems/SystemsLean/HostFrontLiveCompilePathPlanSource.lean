/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live CompilePathPlan.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveCompilePathPlanSource. Not occupancy name 50. Not mill 70.
  This wrap parses CompilePathPlan.lean only.
  Unique needles use trailing newline so HostFrontLiveCompilePathPlan is not a
  prefix hit on HostFrontLiveCompilePathPlanSource.
  Occupancy leftover is not this wrap.
  Unique needles (trailing newline so HostFrontLiveCompilePathPlan is not a prefix):
  HostFrontLiveCompilePathPlanSource
  PARSE-LIVE-COMPILE-PATH-PLAN
  HOST-FRONT-LIVE-COMPILE-PATH-PLAN
  COMPILE-PATH-PLAN
  Greppable: SYSTEMS_LEAN_HOST, liveCompilePathPlanSource,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveCompilePathPlanSource
...
/-- Dual-pinned live CompilePathPlan.lean bytes (must match on-disk file).
    Greppable: liveCompilePathPlanSource, PARSE-LIVE-COMPILE-PATH-PLAN. -/
def liveCompilePathPlanSource : String := r#"/-
