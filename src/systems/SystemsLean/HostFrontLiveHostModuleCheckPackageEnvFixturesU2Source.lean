/-
  SYSTEMS_LEAN_HOST partial -- live HostModuleCheckPackageEnvFixturesU2.lean.
  ...
  liveRel is HostModuleCheckPackageEnvFixturesU2.lean. Not a path.
  Greppable: liveRel, kernelCheckLiveHostModuleCheckPackageEnvFixturesU2Source,
  PARSE-LIVE-HOST-MODULE-CHECK-PACKAGE-ENV-FIXTURES-U2.
  Module: SystemsLean.HostFrontLiveHostModuleCheckPackageEnvFixturesU2Source
...
namespace SystemsLean.HostFrontLiveHostModuleCheckPackageEnvFixturesU2Source
...
def liveRel : String := "HostModuleCheckPackageEnvFixturesU2.lean"

/-- Pinned live HostModuleCheckPackageEnvFixturesU2.lean bytes. -/
def liveHostModuleCheckPackageEnvFixturesU2Source : String := r#"/-
...
def kernelCheckLiveHostModuleCheckPackageEnvFixturesU2Source (src : String) : Bool :=
  match parseLiveLlvmComposeTextMainSource src with
  | FrontResult.accept m => HostKernel.kernelCheck m
  | FrontResult.reject _ => false

/-- Ready is parse plus kernelCheck of the pinned text. -/
def hostFrontLiveHostModuleCheckPackageEnvFixturesU2SourceReady : Bool :=
  liveRel == "HostModuleCheckPackageEnvFixturesU2.lean"
    && kernelCheckLiveHostModuleCheckPackageEnvFixturesU2Source liveHostModuleCheckPackageEnvFixturesU2Source
...
def runLive (root : System.FilePath) : IO Unit := do
  ...
  if disk != liveHostModuleCheckPackageEnvFixturesU2Source then
    throw (IO.userError "dual-pin mismatch HostModuleCheckPackageEnvFixturesU2.lean")
  let k := kernelCheckLiveHostModuleCheckPackageEnvFixturesU2Source disk
  IO.println s!"kernelCheck={k}"
  unless k do
    throw (IO.userError "kernelCheck live HostModuleCheckPackageEnvFixturesU2 parse false")
  unless hostFrontLiveHostModuleCheckPackageEnvFixturesU2SourceReady do
...
end SystemsLean.HostFrontLiveHostModuleCheckPackageEnvFixturesU2Source
