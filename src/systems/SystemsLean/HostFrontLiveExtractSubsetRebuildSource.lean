/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live ExtractSubsetRebuild.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveExtractSubsetRebuildSource. Not occupancy name 50. Not mill 70.
  This wrap is ExtractSubsetRebuild.lean. It is not ExtractSubsetRebuildMain.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveExtractSubsetRebuildSource,
  HOST-FRONT-LIVE-EXTRACT-SUBSET-REBUILD, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveExtractSubsetRebuildSource
...
/-- Dual-pinned live ExtractSubsetRebuild.lean bytes (must match on-disk file).
    Greppable: liveExtractSubsetRebuildSource, HOST-FRONT-LIVE-EXTRACT-SUBSET-REBUILD. -/
def liveExtractSubsetRebuildSource : String := r#"/-
