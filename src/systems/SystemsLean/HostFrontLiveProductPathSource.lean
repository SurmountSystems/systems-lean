/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live ProductPath.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveProductPathSource. Not occupancy name 50. Not mill 70.
  This wrap is ProductPath.lean. It is not ProductPathBars.lean.
  It is not ProductPathTheorems.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveProductPathSource,
  HOST-FRONT-LIVE-PRODUCT-PATH, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveProductPathSource
...
/-- Dual-pinned live ProductPath.lean bytes (must match on-disk file).
    Greppable: liveProductPathSource, HOST-FRONT-LIVE-PRODUCT-PATH. -/
def liveProductPathSource : String := r#"/-
