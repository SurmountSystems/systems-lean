/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live ProductPathBars.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveProductPathBarsSource. Not occupancy name 50. Not mill 70.
  This wrap is ProductPathBars.lean. It is not ProductPath.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveProductPathBarsSource,
  HOST-FRONT-LIVE-PRODUCT-PATH-BARS, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveProductPathBarsSource
...
/-- Dual-pinned live ProductPathBars.lean bytes (must match on-disk file).
    Greppable: liveProductPathBarsSource, HOST-FRONT-LIVE-PRODUCT-PATH-BARS. -/
def liveProductPathBarsSource : String := r#"/-
