/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live HostModuleCheckMultProof.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckMultProofSource.
  Not occupancy name 50. Not mill 70.
  This wrap is HostModuleCheckMultProof.lean.
  It is not HostModuleCheck and not HostFront.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveHostModuleCheckMultProofSource,
  HOST-FRONT-LIVE-HOSTMODULECHECKMULTPROOF, liveRel,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckMultProofSource
...
/-- Dual-pinned live HostModuleCheckMultProof.lean bytes
    (must match the on-disk file).
    Greppable: liveHostModuleCheckMultProofSource,
    HOST-FRONT-LIVE-HOSTMODULECHECKMULTPROOF. -/
def liveHostModuleCheckMultProofSource : String := r#"/-
