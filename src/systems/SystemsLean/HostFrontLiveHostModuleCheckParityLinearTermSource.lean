/-
  ...
  HostModuleCheckParityLinearTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckParityLinearTermSource.
  ...
  HOST-FRONT-LIVE-HOSTMODULECHECKPARITYLINEARTERM, liveRel,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckParityLinearTermSource
...
/-- Dual-pinned live HostModuleCheckParityLinearTerm.lean bytes
    (must match the on-disk file).
    Greppable: liveHostModuleCheckParityLinearTermSource,
    HOST-FRONT-LIVE-HOSTMODULECHECKPARITYLINEARTERM. -/
def liveHostModuleCheckParityLinearTermSource : String := r#"/-
