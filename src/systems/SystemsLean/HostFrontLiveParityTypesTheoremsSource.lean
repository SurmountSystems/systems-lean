/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live ParityTypesTheorems.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveParityTypesTheoremsSource. Not occupancy name 50. Not mill 70.
  This wrap is ParityTypesTheorems.lean. It is not ParityTypes.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveParityTypesTheoremsSource,
  HOST-FRONT-LIVE-PARITY-TYPES-THEOREMS, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveParityTypesTheoremsSource
...
/-- Dual-pinned live ParityTypesTheorems.lean bytes (must match on-disk file).
    Greppable: liveParityTypesTheoremsSource, HOST-FRONT-LIVE-PARITY-TYPES-THEOREMS. -/
def liveParityTypesTheoremsSource : String := r#"/-
