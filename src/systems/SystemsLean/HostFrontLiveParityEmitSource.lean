/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live ParityEmit.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveParityEmitSource. Not occupancy name 50. Not mill 70.
  This wrap is ParityEmit.lean. It is not ParityEmitTheorems.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveParityEmitSource,
  HOST-FRONT-LIVE-PARITY-EMIT, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveParityEmitSource
...
/-- Dual-pinned live ParityEmit.lean bytes (must match on-disk file).
    Greppable: liveParityEmitSource, HOST-FRONT-LIVE-PARITY-EMIT. -/
def liveParityEmitSource : String := r#"/-
  ...
  - Live in SystemsLean.ParityEmitTheorems (same namespace; long-file peel).
  ...
  - PARITY-EMIT-SMOKE behavioral examples live with theorems
  ...
  productEmitBodyApi_eq, productEmitBodyIdApi_eq,
  productEmitBodyFromComposeApi_eq, productEmitBodyIsValidApi_eq,
  productApiSurfaceOk_true, ParityEmitTheorems
  UNIT_SURFACE host surface. Module: SystemsLean.ParityEmit
  Long-file peel: PARITY-EMIT-THEOREM + PARITY-EMIT-SMOKE in
  SystemsLean.ParityEmitTheorems (same namespace).
