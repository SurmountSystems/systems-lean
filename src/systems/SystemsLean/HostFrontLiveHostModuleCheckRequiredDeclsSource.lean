/-
  ...
  HostModuleCheckRequiredDecls.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckRequiredDeclsSource.
  ...
  HOST-FRONT-LIVE-HOSTMODULECHECKREQUIREDDECLS, liveRel,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckRequiredDeclsSource
...
/-- Dual-pinned live HostModuleCheckRequiredDecls.lean bytes.
    One raw string. The product is 667 lines, so this file stays under 780.
    Greppable: liveHostModuleCheckRequiredDeclsSource,
    HOST-FRONT-LIVE-HOSTMODULECHECKREQUIREDDECLS. -/
def liveHostModuleCheckRequiredDeclsSource : String := r#"/-
