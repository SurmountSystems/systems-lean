/-
  ...
  HostModuleCheckParityMultTerm.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveHostModuleCheckParityMultTermSource.
  ...
  HOST-FRONT-LIVE-HOSTMODULECHECKPARITYMULTTERM, liveRel,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveHostModuleCheckParityMultTermSource
...
/-- Dual-pinned live HostModuleCheckParityMultTerm.lean bytes
    (must match the on-disk file).
    Greppable: liveHostModuleCheckParityMultTermSource,
    HOST-FRONT-LIVE-HOSTMODULECHECKPARITYMULTTERM. -/
def liveHostModuleCheckParityMultTermSource : String := r#"/-
