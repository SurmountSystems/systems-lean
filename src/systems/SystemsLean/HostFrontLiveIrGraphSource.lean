/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live IrGraph.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveIrGraphSource. Not occupancy name 50. Not mill 70.
  This wrap is IrGraph.lean. It is not IrGraphTheorems.lean.
  Greppable: SYSTEMS_LEAN_HOST, liveIrGraphSource,
  HOST-FRONT-LIVE-IRGRAPH, liveRel, UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveIrGraphSource
...
/-- Dual-pinned live IrGraph.lean bytes (must match on-disk file).
    Greppable: liveIrGraphSource, HOST-FRONT-LIVE-IRGRAPH. -/
def liveIrGraphSource : String := r#"/-
