/-
  SYSTEMS_LEAN_HOST partial -- dual-pin live SlakeHostToolElfMeasureFieldsX86.lean bytes.
  Side: classic Lean elaborator under src/systems/ (not freestanding C).
  Short role: HostFrontLiveSlakeHostToolElfMeasureFieldsX86Source.
  ...
  Greppable: SYSTEMS_LEAN_HOST, liveSlakeHostToolElfMeasureFieldsX86Source,
  HOST-FRONT-LIVE-SLAKE-HOST-TOOL-ELF-MEASURE-FIELDS-X86,
  HOST-HOST-TOOL-MEASURE-FIELDS-X86, liveRel,
  UNIT_SURFACE host surface.
  Module: SystemsLean.HostFrontLiveSlakeHostToolElfMeasureFieldsX86Source
  Not FullHost. Not freestanding residual free. Not PROVABLY.
  Not a backend. FullBackend stays false in the wrap.
  Module must stay ASCII.
-/

namespace SystemsLean.HostFrontLiveSlakeHostToolElfMeasureFieldsX86Source

/-- Dual-pinned live SlakeHostToolElfMeasureFieldsX86.lean bytes (must match on-disk file).
    Greppable: liveSlakeHostToolElfMeasureFieldsX86Source,
    HOST-FRONT-LIVE-SLAKE-HOST-TOOL-ELF-MEASURE-FIELDS-X86. -/
def liveSlakeHostToolElfMeasureFieldsX86Source : String := r#"/-
...
end SystemsLean.HostFrontLiveSlakeHostToolElfMeasureFieldsX86Source

namespace SystemsLean.HostFrontLiveSlakeHostToolElfMeasureFieldsX86

/-- Same bytes, visible in the parser namespace. -/
def liveSlakeHostToolElfMeasureFieldsX86Source : String :=
  SystemsLean.HostFrontLiveSlakeHostToolElfMeasureFieldsX86Source.liveSlakeHostToolElfMeasureFieldsX86Source
