...
**Intent:** freestanding emit of LLVM IR that can link with the Rust ecosystem in a seamless, native way (layout/ABI (application binary interface) compatible), without classic FFI (foreign function interface) glue as the happy path. The LLVM IR in this directory **is** the compatibility artifact: a Rust consumer is meant to use the same memory shape from that IR. It is not a disclaimer that IR cannot be Rust-compatible. rustc_abi in `ref/rust` is how we **check** the layout.
...
| Trait-object vtable (named fixture) | Host Lean `TraitObjectVtable` plus `trait-object-vtable.ll`: rustc `dyn Trait` fat pointer data+vtable size 16 align 8 on `x86_64-unknown-linux-gnu`; printer walks host `TraitObjectFat` plus ordered slots (`HOST-TRAIT-OBJECT-FAT`); vtable header drop_in_place, size, align (first pin); slot 3 Method plus rustc_abi pointer (second pin; method0 offset 24); slot 4 Method plus rustc_abi pointer (fifth pin; method1 offset 32); slot 5 Method plus rustc_abi pointer (sixth pin; method2 offset 40); slot 6 Method plus rustc_abi pointer (seventh pin; method3 offset 48); slot 7 Method plus rustc_abi pointer (eighth pin; method4 offset 56); slot 8 Method plus rustc_abi pointer (ninth pin; method5 offset 64); slot 9 Method plus rustc_abi pointer (tenth pin; method6 offset 72); slot 10 Method plus rustc_abi pointer (eleventh pin; method7 offset 80); slot 11 Method plus rustc_abi pointer (method8 offset 88); slot 12 Method plus rustc_abi pointer (method9 offset 96; @slake_trait_object_method9); slot 13 Method plus rustc_abi pointer (method10 offset 104); slot 14 Method plus rustc_abi pointer (method11 offset 112); slot 15 Method plus rustc_abi pointer (method12 offset 120); slot 16 Method plus rustc_abi pointer (method13 offset 128); slot 17 Method plus rustc_abi pointer (method14 offset 136); slot 18 Method plus rustc_abi pointer (method15 offset 144); slot 19 Method plus rustc_abi pointer (method16 offset 152); slot 20 Method plus rustc_abi pointer (method17 offset 160); slot 21 Method plus rustc_abi pointer (method18 offset 168); slot 22 Method plus rustc_abi pointer (method19 offset 176); slot 23 Method plus rustc_abi pointer (method20 offset 184); slot 24 Method plus rustc_abi pointer (method21 offset 192); slot 25 Method plus rustc_abi pointer (method22 offset 200); slot 26 Method plus rustc_abi pointer (method23 offset 208); slot 27 Vacant plus rustc_abi pointer (offset 216; reserved ptr null); slot 28 TraitVPtr plus rustc_abi pointer to a header-only supertrait vtable (offset 224). Living DualPinOk fixture is method127 slot 130 offset 1040; Vacant slot 131 offset 1048; TraitVPtr slot 132 offset 1056; 133 slots / 1064 bytes / 128 Methods, align 8. Fourth-pin Vacant-at-slot-4 is history only. Checkable writer: `just llvm-trait-object-vtable` (lean --run; no mill row). Not FullBackend. Production emit claimed stays false. |
...
| Host trait-object vtable | `SystemsLean/TraitObjectVtable.lean` (named fixture printer plus `just llvm-trait-object-vtable` writer; not FullBackend; not occupancy 50) |
...
| Trait-object vtable fixture | `trait-object-vtable.ll` (Lean SSOT `SystemsLean.TraitObjectVtable`; regenerate with `just llvm-trait-object-vtable`; one named two-pointer fat record; second pin slot 3 Method plus rustc_abi pointer (method0 offset 24); fifth pin slot 4 Method plus rustc_abi pointer (method1 offset 32); sixth pin slot 5 Method plus rustc_abi pointer (method2 offset 40); seventh pin slot 6 Method plus rustc_abi pointer (method3 offset 48); eighth pin slot 7 Method plus rustc_abi pointer (method4 offset 56); ninth pin slot 8 Method plus rustc_abi pointer (method5 offset 64); slot 9 Method plus rustc_abi pointer (method6 offset 72); slot 10 Method plus rustc_abi pointer (method7 offset 80); slot 11 Method plus rustc_abi pointer (method8 offset 88); slot 12 Method plus rustc_abi pointer (method9 offset 96); slot 13 Method plus rustc_abi pointer (method10 offset 104); slot 14 Method plus rustc_abi pointer (method11 offset 112); slot 15 Method plus rustc_abi pointer (method12 offset 120); slot 16 Method plus rustc_abi pointer (method13 offset 128); slot 17 Method plus rustc_abi pointer (method14 offset 136); slot 18 Method plus rustc_abi pointer (method15 offset 144); slot 19 Method plus rustc_abi pointer (method16 offset 152); slot 20 Method plus rustc_abi pointer (method17 offset 160); slot 21 Method plus rustc_abi pointer (method18 offset 168); slot 22 Method plus rustc_abi pointer (method19 offset 176); slot 23 Method plus rustc_abi pointer (method20 offset 184); slot 24 Method plus rustc_abi pointer (method21 offset 192); slot 25 Method plus rustc_abi pointer (method22 offset 200); slot 26 Method plus rustc_abi pointer (method23 offset 208); slot 27 Vacant plus rustc_abi pointer (offset 216); slot 28 TraitVPtr plus rustc_abi pointer (offset 224); living DualPinOk fixture method127 slot 130 offset 1040; Vacant 131/1048; TraitVPtr 132/1056; 133 slots / 1064 bytes / 128 Methods; fourth-pin Vacant-at-slot-4 is history only; not FullBackend) |
| Gates (trait-object vtable writer) | `just llvm-trait-object-vtable` regenerates dest from Lean; `just llvm-trait-object-vtable-check` fails if dest bytes differ; no mill row; production emit claimed false |
...
| Gates (richer layout / link smoke) | `just richer-record-layout` (`IrNodeRecord` rustc_abi dual-pin); `just llvm-link-smoke` (out-of-tree link of generator SSA `.ll`; skip-honest); `just llvm-trait-object-vtable` (lean --run regenerates `trait-object-vtable.ll` and fails if dest bytes differ; no mill row) |
...
- Trait-object vtable named fixture: Lean `SystemsLean.TraitObjectVtable` (`traitObjectVtableIrPackage`; first pin fat ScalarPair plus header; second pin slot 3 Method plus rustc_abi pointer (method0 offset 24); fifth pin slot 4 Method plus rustc_abi pointer (method1 offset 32); sixth pin slot 5 Method plus rustc_abi pointer (method2 offset 40); seventh pin slot 6 Method plus rustc_abi pointer (method3 offset 48); eighth pin slot 7 Method plus rustc_abi pointer (method4 offset 56); ninth pin slot 8 Method plus rustc_abi pointer (method5 offset 64); slot 9 Method plus rustc_abi pointer (method6 offset 72); slot 10 Method plus rustc_abi pointer (method7 offset 80); slot 11 Method plus rustc_abi pointer (method8 offset 88); slot 12 Method plus rustc_abi pointer (method9 offset 96); slot 13 Method plus rustc_abi pointer (method10 offset 104); slot 14 Method plus rustc_abi pointer (method11 offset 112); slot 15 Method plus rustc_abi pointer (method12 offset 120); slot 16 Method plus rustc_abi pointer (method13 offset 128); slot 17 Method plus rustc_abi pointer (method14 offset 136); slot 18 Method plus rustc_abi pointer (method15 offset 144); slot 19 Method plus rustc_abi pointer (method16 offset 152); slot 20 Method plus rustc_abi pointer (method17 offset 160); slot 21 Method plus rustc_abi pointer (method18 offset 168); slot 22 Method plus rustc_abi pointer (method19 offset 176); slot 23 Method plus rustc_abi pointer (method20 offset 184); slot 24 Method plus rustc_abi pointer (method21 offset 192); slot 25 Method plus rustc_abi pointer (method22 offset 200); slot 26 Method plus rustc_abi pointer (method23 offset 208); slot 27 Vacant plus rustc_abi pointer (offset 216); slot 28 TraitVPtr plus rustc_abi pointer (offset 224); living DualPinOk fixture method127 slot 130 offset 1040; Vacant 131/1048; TraitVPtr 132/1056; 133 slots / 1064 bytes / 128 Methods; fourth-pin Vacant-at-slot-4 is history only; `just llvm-trait-object-vtable` regenerates dest and fails if bytes differ; not FullBackend)
